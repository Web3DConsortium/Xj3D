...
public class HashSetTest extends TestCase {
    ...
    public void testToArrayTooSmall()
    {
        ...
        java.util.Arrays.sort(arr);
        assertEquals(arr,new Integer[]{353, 2_701});
    }
    ...
    public void testNull()
    {
        ...
        try { hs.addAll((HashSet<Object>)null); fail(); } catch(NullPointerException e){}
        try { hs.removeAll((HashSet<Object>)null); fail(); } catch(NullPointerException e){}
        try { hs.addAll((java.util.Collection<Object>)null); fail(); } catch(NullPointerException e){}
        try { hs.removeAll((java.util.Collection<Object>)null); fail(); } catch(NullPointerException e){}
    }
