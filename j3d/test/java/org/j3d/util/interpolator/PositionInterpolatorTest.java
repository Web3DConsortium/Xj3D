...
public class PositionInterpolatorTest
{
    ...
    public void testCreateFloat()
    {
        ...
        for(i = 0; i < num_keys; i++)
        {
            ...
            assertEquals(values[i][0], vals[0], 0.001d, i + " X coord not same");
            assertEquals(values[i][1], vals[1], 0.001d, i + " Y coord not same");
            assertEquals(values[i][2], vals[2], 0.001d, i + " Z coord not same");
        }
    }
    ...
    public void testCreatePoint()
    {
        ...
        for(i = 0; i < num_keys; i++)
        {
            ...
            assertEquals(vals.x, values[i][0], 0.001d, i + " X coord not same");
            assertEquals(vals.y, values[i][1], 0.001d, i + " Y coord not same");
            assertEquals(vals.z, values[i][2], 0.001d, i + " Z coord not same");
        }
    }
    ...
    public void testValueInsertFloat()
    {
        ...
        for(i = 0; i < num_keys; i++)
        {
            ...
            assertEquals(vals[0], values[i][0], 0.001d, i + " X coord not same");
            assertEquals(vals[1], values[i][1], 0.001d, i + " Y coord not same");
            assertEquals(vals[2], values[i][2], 0.001d, i + " Z coord not same");
        }
    }
    ...
    public void testKeyGenFloat()
    {
        ...
        assertEquals(x_val, vals[0], 0.001d, "1st X coord not same");
        assertEquals(y_val, vals[1], 0.001d, "1st Y coord not same");
        assertEquals(z_val, vals[2], 0.001d, "1st Z coord not same");
        ...
        assertEquals(x_val, vals[0], 0.001d, "2nd X coord not same");
        assertEquals(y_val, vals[1], 0.001d, "2nd Y coord not same");
        assertEquals(z_val, vals[2], 0.001d, "2nd Z coord not same");
    }
    ...
    public void testKeyGenPoint()
    {
        ...
        assertEquals(vals.x, x_val, 0.001d, "1st X coord not same");
        assertEquals(vals.y, y_val, 0.001d, "1st Y coord not same");
        assertEquals(vals.z, z_val, 0.001d, "1st Z coord not same");
        ...
        assertEquals(vals.x, x_val, 0.001d, "2nd X coord not same");
        assertEquals(vals.y, y_val, 0.001d, "2nd Y coord not same");
        assertEquals(vals.z, z_val, 0.001d, "2nd Z coord not same");
    }
    ...
    public void testClamping()
    {
        ...
        assertEquals(vals[0], values[0][0], 0.001d, "Min X coord not same");
        assertEquals(vals[1], values[0][1], 0.001d, "Min Y coord not same");
        assertEquals(vals[2], values[0][2], 0.001d, "Min Z coord not same");
        ...
        assertEquals(vals[0], values[num_keys][0], 0.001d, "Max X coord not same");
        assertEquals(vals[1], values[num_keys][1], 0.001d, "Max Y coord not same");
        assertEquals(vals[2], values[num_keys][2], 0.001d, "Max Z coord not same");
    }
}
