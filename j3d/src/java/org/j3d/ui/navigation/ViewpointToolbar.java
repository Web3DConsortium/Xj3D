    ...
    implements ActionListener, ItemListener
{
    ...
    private JComboBox<ViewpointData> viewpoints;

    /** The model used by the combo box to handle viewpoint data */
    private DefaultComboBoxModel<ViewpointData> viewpointModel;
    ...
    public ViewpointToolbar(ViewpointData[] vps)
    {
        ...
        viewpoints.addItemListener(ViewpointToolbar.this);
        ...
        nextViewpoint.addActionListener(ViewpointToolbar.this);
    ...
    public void setViewpoints(ViewpointData[] vp)
    {
        ...
        if(vp != null)
        {
            for (ViewpointData vp1 : vp) {
                viewpointModel.addElement(vp1);
            }
