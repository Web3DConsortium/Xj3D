 ...
 */
public class ViewpointCellRenderer extends JLabel implements ListCellRenderer<ViewpointData>
{
     ...
     * @param cellHasFocus true if the cell is currently focused
     * @return The Renderer for the values given
     */
    @Override
    public Component getListCellRendererComponent(JList<? extends ViewpointData> list,
                                           ViewpointData value,
                                           int index,
                                           boolean isSelected,
