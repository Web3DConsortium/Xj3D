 ...
 */
public class C3DFloatParameter extends C3DParameter
{
    /**
     ...
     */
    public C3DFloatParameter(String name, boolean locked, int id)
    {
     ...
     *
     * @param d The float value to use as the value
     ...
     *
     * @param d The float values to use as the value
     * @param dim The dimensions of each value length
     * @throws IllegalStateException The object is locked and cannot be
     *    changed
     */
    public void setValue(float[] d, int[] dim)
        throws IllegalStateException
    {
        if(locked)
            throw new IllegalStateException(LOCKED_PARAM_MSG);
