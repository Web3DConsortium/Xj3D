...
public class C3DParser
{
    ...
    private boolean parseHeader() throws IOException
    {
        ...
        header.hasRangeData = (reader.readShort(294) == 12_345);
        ...
        boolean old_labels = (reader.readShort(298) != 12_345);
        ...
        if(observer != null)
        {
            ...
            {
                errorReporter.errorReport(USER_HEADER_ERR, (Throwable) e);
            }
        }
    ...
    private boolean parseParams(boolean retainData) throws IOException
    {
        ...
        IntHashMap<C3DParameterGroup> param_groups = new IntHashMap<>();
        ...
        while(have_params)
        {
            ...
            if(id < 0)
            {
                ...
                C3DParameterGroup grp = param_groups.get(id);
            ...
            else
            {
                ...
                {
                    errorReporter.errorReport(PARAM_BLOCK_SIZE_MSG, (Throwable) null);
                    have_params = false;
                }
        ...
        if(retainData || (observer != null))
        {
            ...
            for(int i = 0; i < ids.length; i++)
                parameters[i] = param_groups.get(ids[i]);
        }
        ...
        if(observer != null)
        {
            ...
            {
                errorReporter.errorReport(USER_PARAM_ERR, (Throwable) e);
            }
        ...
        if(header.numTrajectories != 0)
        {
            ...
            C3DParameterGroup grp = param_groups.get(point_group_id);
            ...
            if(label_param == null)
                errorReporter.errorReport(LABEL_PARAM_MISSING_ERR, (Throwable) null);
            else
            {
            ...
            if(desc_param == null)
                errorReporter.errorReport(DESC_PARAM_MISSING_ERR, (Throwable) null);
            else
            {
        ...
        if(header.numAnalogChannels != 0)
        {
            ...
            C3DParameterGroup grp = param_groups.get(analog_group_id);
    ...
    private void parseFloatTrajectories(boolean retainData) throws IOException
    {
        ...
        for(int i = 0; i < header.numTrajectorySamples; i++)
        {
            for(int j = 0; j < header.numTrajectories; j++)
            {
                ...
                trajectories[j].residuals[i] = (mask & 0xFF00) * header.scaleFactor;
