...
public class Ac3dParser
{
    ...
    public void parse(boolean retainData) throws IOException
    {
        ...
        while((buffer = reader.readLine()) != null && !forced_end)
        {
            ...
            catch(NullPointerException npe)
            {
                ...
                errorReporter.errorReport(msg, (Throwable) npe);
            }
            catch(IOException e)
            {
                I18nManager intl_mgr = I18nManager.getManager();
                ...
                errorReporter.errorReport(msg, (Throwable) e);
            }
        }
    }
    ...
    private boolean parseMaterial(String[] tokens, boolean retainData)
    {
        ...
        if(observer != null)
        {
            ...
            {
                errorReporter.errorReport(USER_MATERIAL_PROP, (Throwable) e);
            }
        }
     ...
     *
     * @param object The AC3D object that we put the surface into
     * @return true if the parsing has been requested to end now
     */
     ...
     * @param numArgsRequired The number of arguments for the token
     *                        command.
     */
