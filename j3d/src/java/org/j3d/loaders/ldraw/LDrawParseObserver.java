...
public interface LDrawParseObserver
{
     ...
     */
    boolean header(LDrawHeader hdr);
     ...
     * @return true if to keep reading
     */
    boolean bfcStatement(boolean ccw, boolean cull);
     ...
     * @return true if to keep reading
     */
    boolean fileReference(LDrawFileReference ref);
     ...
     * @return true if to keep reading
     */
    boolean renderable(LDrawRenderable rend);
}
