...
public abstract class LDrawColor
{
                         ...
                         int a)
    {
        index = idx;
        type = ct;
        colour = new Color((hexColour & 0xFF_0000) >> 16,
                           (hexColour & 0x00_FF00) >> 8,
                           (hexColour & 0x00_00FF) >> 0);

        complement = new Color((hexComplement & 0xFF_0000) >> 16,
                               (hexComplement & 0x00_FF00) >> 8,
                               (hexComplement & 0x00_00FF) >> 0);
