...
public class LDrawSpeckleColor extends LDrawColor
{
    public static final LDrawSpeckleColor SPECKLE_75 =
        new LDrawSpeckleColor(75, ColorType.SPECKLE, 0x00_0000, 0x59_5959, 0, 0x59_5959, 0.4f, 1, 3);
    public static final LDrawSpeckleColor SPECKLE_76 =
        new LDrawSpeckleColor(76, ColorType.SPECKLE, 0x63_5F61, 0x59_5959, 0, 0xAE_7A59, 0.4f, 1, 3);
    public static final LDrawSpeckleColor SPECKLE_132 =
        new LDrawSpeckleColor(132, ColorType.SPECKLE, 0x00_0000, 0x59_5959, 0, 0xAE_7A59, 0.4f, 1, 3);
    public static final LDrawSpeckleColor SPECKLE_133 =
        new LDrawSpeckleColor(133, ColorType.SPECKLE, 0x00_0000, 0xDB_AC34, 0, 0x59_5959, 0.4f, 1, 3);
                              ...
                              int max)
    {
        ...
        speckleColor = new Color((hexSpeckle & 0xFF_0000) >> 16,
                                 (hexSpeckle & 0x00_FF00) >> 8,
                                 (hexSpeckle & 0x00_00FF) >> 0);
