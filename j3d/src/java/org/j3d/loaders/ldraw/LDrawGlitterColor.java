...
public class LDrawGlitterColor extends LDrawColor
{
    public static final LDrawGlitterColor GLITTER_114 =
        new LDrawGlitterColor(114, ColorType.GLITTER, 0xDF_6695, 0x9A_2A66, 128, 0x92_3978, 0.17f, 0.2f, 1);
    public static final LDrawGlitterColor GLITTER_117 =
        new LDrawGlitterColor(117, ColorType.GLITTER, 0xFF_FFFF, 0xC3_C3C3, 128, 0xFF_FFFF, 0.08f, 0.1f, 1);
    public static final LDrawGlitterColor GLITTER_129 =
        new LDrawGlitterColor(129, ColorType.GLITTER, 0x64_0061, 0x28_0025, 128, 0x92_3978, 0.3f, 0.4f, 1);
                              ...
                              int size)
    {
        ...
        glitterColor = new Color((hexGlitter & 0xFF_0000) >> 16,
                                 (hexGlitter & 0x00_FF00) >> 8,
                                 (hexGlitter & 0x00_00FF) >> 0);
