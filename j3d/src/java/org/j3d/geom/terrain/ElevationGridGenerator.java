 ...
 * setting is controlled as one of the auxiliary flags in the
...
{
    /** Auxiliary flag to say to generate points as relative values */
    public static final int RELATIVE_HEIGHTS = 0x01;

    /** Auxiliary flag to say to generate points as absolute values */
        ...
        throws UnsupportedTypeException
    {
        ...
        switch(data.geometryType)
        {
            ...
            case GeometryData.TRIANGLE_FANS:
                ...
                // NOTE: Going out on a limb here, I think there should be a
                // break statement (TDN) 28 AUG 15
                break;
