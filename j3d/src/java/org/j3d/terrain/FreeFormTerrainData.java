 ...
 * amount of some form of memory-managed data. The management routines do
 ...
 * and expect near neighbors to be probably accessed very shortly.
 * <p>
 *
 ...
 * from the various <code>getCoordinateX()</code> methods are all correct
...
public interface FreeFormTerrainData extends TerrainData
{
     ...
     */
    BufferedImage getTexture(Rectangle bounds);
