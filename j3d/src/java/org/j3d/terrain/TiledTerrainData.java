...
/**
 * Representation of data source that holds its data in tiles.
 * <p>
 *
...
public interface TiledTerrainData extends TerrainData
{
     ...
     */
    BufferedImage getTexture(int tileX, int tileY);
     ...
     */
    void getTilesAvailableBounds(Rectangle bounds);
     ...
     * implementation is free to load more than this tree into memory if it
     * feels like it.
     * <p>
     *
     ...
     *    accessed
     */
    void setActiveBounds(Rectangle bounds);
}
