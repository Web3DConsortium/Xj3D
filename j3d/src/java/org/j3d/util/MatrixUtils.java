...
public class MatrixUtils
{
    ...
    /**
     * Find the 3x3 submatrix for the 4x4 matrix given the initial start and
    ...
    /**
     * Find the 3x3 submatrix for the 4x4 matrix given the initial start and end
     * positions. This uses the class-level double temp matrices for input.
     */
