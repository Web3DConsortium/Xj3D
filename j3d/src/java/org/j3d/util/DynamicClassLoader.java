...
public class DynamicClassLoader
{
     ...
     * the loading and instantiation process is that the class must have a
     * public default constructor.As this method does not take any arguments,
    ...
    public static Object loadBasicClass(String name)
        throws ClassNotFoundException, InvalidClassException, NoSuchMethodException, IllegalArgumentException, InvocationTargetException
    {
        ...
        try
        {
            ...
            ret_val = new_class.getDeclaredConstructor().newInstance();
        }
    ...
    {
        boolean ret_val = source.isAssignableFrom(current);
