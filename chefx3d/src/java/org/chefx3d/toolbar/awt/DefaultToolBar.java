...
public class DefaultToolBar
    ...
    private Map<String, JPopupMenu> toolsMap;

    /** A map of MenuItems to ToolInstances */
    private Map<JMenuItem, Tool> miMap;
    ...
    public DefaultToolBar(WorldModel model, int direction, boolean collapseSingletons) {
        ...
        catalogManager.addCatalogManagerListener(DefaultToolBar.this);
                ...
                if (o instanceof Tool) {
                    ...
                    for (Object sub_children1 : sub_children) {
                        if (sub_children1 instanceof Tool) {
                            ...
                            tool = ((ToolGroup) sub_children1).getTool();
                        }
                        if (tool != null) {
                            if (level == 0)
                                menuItem = new JMenuItem(tool.getName());
