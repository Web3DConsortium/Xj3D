...
class EntityDRHolder {
    ...
    public void getVelocityAverages(float[] avgLinearVelocity,
        ...
        for (float[] linearVelocityHistory1 : linearVelocityHistory) {
            lx += linearVelocityHistory1[0];
            ly += linearVelocityHistory1[1];
            lz += linearVelocityHistory1[2];
        }
        ...
        for (float[] angularVelocityHistory1 : angularVelocityHistory) {
            ax += angularVelocityHistory1[0];
            ay += angularVelocityHistory1[1];
            az += angularVelocityHistory1[2];
            aa += angularVelocityHistory1[3];
        }
