...
public class SMALImporter {
     ...
     * @param wmodel
     * @param rdr
     * @throws org.chefx3d.model.LoadToolException
     */
    public void importModel(WorldModel wmodel, Reader rdr) throws LoadToolException {
        ...
        entityList = entityList.item(0).getChildNodes();
...
//System.out.println("***Loading entity: " + entity);
            ...
            if (tool == null) {
                System.err.println("Cannot find tool: " + toolName);
...
//System.out.println("Other sheet: " + other_sheets[k]);
                    Node node = ps_doc.importNode(other_sheet, true);
                    e.appendChild(node);
                    String sheet_name = other_sheet.getAttribute("name");
...
//            toolValues[entityCount++] = newEntity;
                ...
                if (segmentList.getLength() > 0) {
                    ...
                    for (int j = 0; j < segmentList.getLength(); j++) {
                        ...
                        if (j == 0) {
                            ...
                            ((SegmentableEntity)newEntity).addSegmentVertex(startVertexID, pos);
                        }
                        ...
                        ((SegmentableEntity)newEntity).addSegmentVertex(endVertexID, pos);

                        ((SegmentableEntity)newEntity).addSegment(j, startVertexID, endVertexID);
                    }
                }
            }
        ...
        // This seems redundant after all the AddEntityCommand calls (TDN)
//        model.setModelData(toolValues);
    ...
    /**
     * Parses a String of float data separated by spaces. Put the results in the
    ...
    /**
     * Parses a String of double data separated by spaces. Put the results in
