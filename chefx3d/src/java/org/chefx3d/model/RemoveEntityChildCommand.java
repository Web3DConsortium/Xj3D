 ...
 */
public class RemoveEntityChildCommand implements Command {
     ...
     */
    public RemoveEntityChildCommand(Entity parent, Entity child) {

        this.parent = parent;
        this.child = child;

        description = "RemoveEntityChild -> " + parent.getName();
