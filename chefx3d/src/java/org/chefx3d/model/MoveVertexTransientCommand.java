 ...
 */
public class MoveVertexTransientCommand implements Command, DeadReckonedCommand {
    /** The model */
     ...
     * @param velocity
     */
    public MoveVertexTransientCommand(WorldModel model, int transID, int entityID, int vertexID,
            double[] position, float[] velocity) {
