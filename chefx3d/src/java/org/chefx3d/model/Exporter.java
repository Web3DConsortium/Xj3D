...
System.out.println("***Exporting " + len + " model entities");
    ...
    protected String removeXMLHeader(String input) {
        StringBuilder modString = new StringBuilder(input.length());
        int spos;
    ...
    private void addParams(Entity entity) {
        ...
        // TODO: Add params to the first stylesheet only
        //       This might stand but not sure
        Document props = (entity.getProperties().entrySet()
        ...
        if (list.getLength() <= 0) {
            ...
            e2.setAttribute("url", entity.getURL());
        ...
        while(itr.hasNext()) {
            ...
            if (first) {
                ...
                if (len == 0) {
                    ...
                    System.err.println("*** More than one sheet in a Sheet?");
                } else {
                    n = l.item(0);
