...
public class DefaultModelValidator implements ModelValidator {
    private Set<String> categoriesChecked;
    ...
    public boolean validate(WorldModel model, ValidationErrorListener listener) {
        categoriesChecked = new HashSet<>();

        List<Tool> tools = CatalogManager.getCatalogManager().getAllToolsFlattened();
        int len = tools.size();
        ...
        for (int i = 0; i < len; i++) {
            ...
            MultiplicityConstraint constraint = tool.getMultiplicityConstraint();
