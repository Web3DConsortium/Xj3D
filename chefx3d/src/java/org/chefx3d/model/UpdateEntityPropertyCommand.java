...
/**
 * A command for updating a property of an entity.
 *
 * @author Russell Dodds
 * @version $Revision: 1.2 $
 */
public class UpdateEntityPropertyCommand implements Command {
     ...
     */
    public UpdateEntityPropertyCommand(Entity entity, String propertySheet,
        ...
        description = "UpdateEntityProperty -> " + entity.getName();
    ...
    @Override
    public void undo() {
        entity.setProperty(propertySheet, propertyName, originalValue);
    }
