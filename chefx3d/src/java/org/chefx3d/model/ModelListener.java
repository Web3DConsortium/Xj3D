...
public interface ModelListener {
     ...
     */
    void entityAdded(boolean local, Entity entity);
     ...
     */
    void entityRemoved(boolean local, Entity entity);
     ...
     *        latest.
     */
    void selectionChanged(List<Selection> selection);
     ...
     */
    void viewChanged(boolean local, double[] pos, float[] rot, float fov);
     ...
     */
    void masterChanged(boolean local, long viewID);
