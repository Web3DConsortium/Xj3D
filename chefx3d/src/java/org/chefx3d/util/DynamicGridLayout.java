...
public class DynamicGridLayout implements LayoutManager, java.io.Serializable {
     ...
     * <li>DYNAMIC - After the percentages and minimum components are removed
     ...
     * any available space but never go smaller than it's minimum size.
     * </ul>
     * @param row
     * @param value
     */
