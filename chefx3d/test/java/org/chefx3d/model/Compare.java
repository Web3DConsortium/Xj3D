...
public class Compare {
    ...
    /**
     * Check to make sure the Entity provided are exactly the same
     *
     * @param message
     * @param entity1
     * @param entity2
    ...
    public static void Entity(String message, Entity entity1, Entity entity2) {
        ...
        assertEquals(message + " - segment entity.", entity1.isSegmentedEntity() , entity2.isSegmentedEntity() );
        if (entity1.isSegmentedEntity() && entity2.isSegmentedEntity()) {
    ...
    /**
     * Check to make sure the SegmentSequence provided are exactly the same
     *
     * @param message
     * @param sequence1
     * @param sequence2
    ...
    public static void SegmentSequence(String message, SegmentSequence sequence1, SegmentSequence sequence2) {
        ...
        List<SegmentVertex> vertices1 = sequence1.getVertices();
        List<SegmentVertex> vertices2 = sequence2.getVertices();
        ...
        List<Segment> segments1 = sequence1.getSegments();
        List<Segment> segments2 = sequence2.getSegments();
    ...
    /**
     * Check to make sure the Segment provided are exactly the same
     *
     * @param message
     * @param segment1
     * @param segment2
    ...
    public static void Properties(String message, Map<String, Document> properties1, Map<String, Document> properties2) {
        ...
        while (itr.hasNext()) {
            ...
            String sheetName1 = entry.getKey();
    ...
    /**
     * Check to make sure the Documents provided are exactly the same
     *
     * @param message
     * @param document1
     * @param document2
