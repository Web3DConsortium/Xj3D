...
public class TestImportExport extends TestCase {
    ...
    public void setUp() {
        ...
        List<ToolGroupChild> chapters = new ArrayList<>();
    ...
    public void testExportImport() {
        ...
        model.addEntity(local, controller, null);
...
System.out.println("Exported: \n: " + export);
    ...
    public static void main(String[] args) {
        ...
        Result result = JUnitCore.runClasses(TestImportExport.class);
