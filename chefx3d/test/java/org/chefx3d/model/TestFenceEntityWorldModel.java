...
public class TestFenceEntityWorldModel extends TestCase {
    ...
    public void setUp() {
        ...
        // Had to change this to MultiSegmentTool
        fenceToolFree = new MultiSegmentTool("New Fence", "images/segment_point.png",
                null, false,
                Tool.TYPE_MULTI_SEGMENT, new String[] { cpath
                        + "Barrier/Fence/Fence.x3dv" }, 0, "Fence", propertyPanels,
                segmentPanels, vertexPanels, styles, "SMAL", "0.3",
    ...
    public void testAddFence() {
        ...
        assertTrue("Should be a segmented entity.", model.getEntity(0).isSegmentedEntity());
    ...
    public void testRemoveInternalVertexFree() {
        ...
        // add the fence and vertex to the model
        testAddMultipleVertexFree();

        // remove the middle vertex TODO: Nope, this removes them all *** BUG!!
    ...
    public static void main(String[] args) {
        ...
        Result result = JUnitCore.runClasses(TestFenceEntityWorldModel.class);
