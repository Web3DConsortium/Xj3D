 ...
 */
public class OGLLightweightBrowser extends DemoFrame
    implements WindowListener,
               SensorStatusListener,
               Runnable {

    /** App name to register preferences under */
    private static final String APP_NAME = "xj3d.OGLLightweightBrowserDemo";
     ...
     */
    public OGLLightweightBrowser() {
        super("OpenGL/Aviatrix Lightweight Canvas Browser");

        I18nManager intl_mgr = I18nManager.getManager();
        intl_mgr.setApplication(APP_NAME, "config.i18n.xj3dResources");

        addWindowListener(OGLLightweightBrowser.this);
        setSize(800, 600);
        setLocation(40, 40);
    ...
    public void linkActivated(String[] url_list, String[] params, String desc) {
        ...
        for (String url_list1 : url_list) {
            if (url_list1.charAt(0) == '#') {
                ...
                // load the world.
                try {
                    InputSource is = new InputSource(url_list1);
                    if(success = load(is))
                        break;
