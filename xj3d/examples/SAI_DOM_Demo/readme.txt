...
wise on the SAI, we should revisit this when the dust settles.
     ...
     Examples of SAI and DOM scene graph interaction
     
The examples in this directory show how you can modify a X3D scene graph using
either the SAI or DOM interfaces. We can operate this on one of two levels
