...
/**
 * Demonstration of SAI and DOM being used to create a scene graph from scratch.
 * <p>
 *
 * The demo uses the custom parser built by our code. The only way to start
 * a scene graph using the SAI APIs is to allow us to create a new root element
