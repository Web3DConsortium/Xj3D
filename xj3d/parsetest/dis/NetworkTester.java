...
public class NetworkTester {
    ...
    public void test() {
        ...
        int sleepTime = 2500 / numEntities;
        float offset = -10;
    ...
    private void launchEntity(String path, int siteID, int appID, int entityID,
        ...
        Runner r = new Runner(writer, path, siteID, appID, entityID, pauseTime);
...
class Runner implements Runnable {
    ...
    public Runner(DisThreadedNetworkInterface writer, String data, int siteID, int appID, int entityID, int pauseTime) {
        this.writer = writer;
        this.data = data;
        ...
        espdu.getMarking().setCharacterSet(EntityMarkingCharacterSet.ASCII);
        ...
        entTyp.setEntityKind(EntityKind.PLATFORM);
        entTyp.setDomain(Domain.inst(PlatformDomain.SUBSURFACE));
        entTyp.setCountry(Country.UNITED_STATES_OF_AMERICA_USA);
