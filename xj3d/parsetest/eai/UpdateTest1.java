...
public class UpdateTest1 implements vrml.eai.event.BrowserListener {
  ...
  public void performStep2() {
    ...
    browser.beginUpdate();
    nodes[0].getEventOut("children_changed").addVrmlEventListener(new GenericFieldListener());
    ((EventInMFNode)nodes[0].getEventIn("set_children")).setValue(levelOne);
    levelOne[1].getEventOut("children_changed").addVrmlEventListener(new GenericFieldListener());
    ((EventInMFNode)levelOne[1].getEventIn("set_children")).setValue(levelTwo);
    browser.endUpdate();
    levelTwo[0].getEventOut("translation").addVrmlEventListener(new GenericFieldListener());
