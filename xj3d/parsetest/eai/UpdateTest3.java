 ...
 *   working.  Like so many other tests, this one has an awkward structure
...
public class UpdateTest3 implements vrml.eai.event.BrowserListener {
  ...
  public void performTest() {
    ...
    browser.loadURL(new String[]{"root.wrl"},new String[0]);
  }
  ...
  public void performStep2() {
    ...
    try {
      ...
      System.err.println("FAIL:  Incorrectly threw invalid node exception.");
    }
    ...
    shapeA[0].getEventOut("translation").addVrmlEventListener(new GenericFieldListener("Transform A"));
    shapeB[0].getEventOut("translation").addVrmlEventListener(new GenericFieldListener("Transform B"));
    int x;
    for (x=0; x<10; x++)
