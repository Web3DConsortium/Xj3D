 ...
 * test code between the test cases when all I wanted was a Frame with a Browser
 * instance in it, and wanted the Frame set up in a standard manner.
 */
public class TestFactory {
    ...
    /**
     * Produce a vrml.eai.Browser instance.
     * @return
     */
    ...
    public static Browser getBrowser(boolean shouldQuit) {
        final VrmlComponent comp = BrowserFactory.createVrmlComponent(
            new String[]{
    ...
    public static Node[] getTestNodes(vrml.eai.Browser aBrowser, int number) {
        switch (number) {
            case 1:
                return aBrowser.createVrmlFromString(geometryA);
            case 2:
                return aBrowser.createVrmlFromString(geometryB);
            case 3:
                return aBrowser.createVrmlFromString(geometryC);
            case 4:
                return aBrowser.createVrmlFromString(geometryD);
            case 5:
                return aBrowser.createVrmlFromString(geometryE);
            case 6:
                return aBrowser.createVrmlFromString(geometryF);
            default:
                return null;
        }
    }
    ...
    /**
     * Example D.2 above stripped of comments and ROUTE statements and newlines.
     */
