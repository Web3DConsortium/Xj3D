...
/**
 * Action listener to create a new scene from a string and then set that scene
 * as the current one.
 */
class CreateSAIStringAction implements ActionListener {
    ...
    /**
     * Replace the targeted browser instance.
     */
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        } catch (InvalidBrowserException | InvalidX3DException er) {
