...
/**
 * Test that the addRootNode method works. Variation of the original test which
 * uses a button to trigger the addition of the root node.
 */
...
class ModifySceneAction implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        } catch (InvalidFieldException | InvalidNodeException exception) {
