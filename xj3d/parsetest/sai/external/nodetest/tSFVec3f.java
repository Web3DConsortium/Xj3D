...
/**
 * Test wrapper for the SFVec3f X3DField type
 */
public class tSFVec3f implements tX3DField {
     ...
     * @param control
     */
    public tSFVec3f(final X3DNode node, final X3DFieldDefinition def, final tController control) {
        this.nodeName = node.getNodeName();
        this.fieldName = def.getName();
        this.field = (SFVec3f) node.getField(fieldName);
