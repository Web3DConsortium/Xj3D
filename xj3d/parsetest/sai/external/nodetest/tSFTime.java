...
/**
 * Test wrapper for the SFTime X3DField type
 */
public class tSFTime implements tX3DField {
     ...
     * @param control
     */
    public tSFTime(final X3DNode node, final X3DFieldDefinition def, final tController control) {
        this.nodeName = node.getNodeName();
        this.fieldName = def.getName();
        this.field = (SFTime) node.getField(fieldName);
