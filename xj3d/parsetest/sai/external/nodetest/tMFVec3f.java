...
/**
 * Test wrapper for the MFVec3f X3DField type
 */
public class tMFVec3f implements tX3DField {
     ...
     * @param control
     */
    public tMFVec3f(final X3DNode node, final X3DFieldDefinition def, final tController control) {
        this.nodeName = node.getNodeName();
        this.fieldName = def.getName();
        this.field = (MFVec3f) node.getField(fieldName);
    ...
    public boolean smoke() {
        ...
        switch (access) {
            ...
            case X3DFieldTypes.OUTPUT_ONLY:
                r_value = new float[field.getSize() * 3];
