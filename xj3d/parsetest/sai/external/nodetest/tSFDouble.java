...
/**
 * Test wrapper for the SFDouble X3DField type
 */
public class tSFDouble implements tX3DField {

    /**
     * Default smoke test write value
     */
    public final static double smoke_value = 0.1;

    /**
     * The field
     */
    final SFDouble field;
     ...
     * @param control
     */
    public tSFDouble(final X3DNode node, final X3DFieldDefinition def, final tController control) {
        this.nodeName = node.getNodeName();
        this.fieldName = def.getName();
        this.field = (SFDouble) node.getField(fieldName);
