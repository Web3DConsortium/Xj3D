...
/**
 * Test wrapper for the SFRotation X3DField type
 */
public class tSFRotation implements tX3DField {

    /**
     * Default smoke test write value
     */
    public final static float[] smoke_value = new float[]{0.707f, 0.707f, 0.0f, (float) Math.PI};

    /**
     * The field
     */
    final SFRotation field;
     ...
     * @param control
     */
    public tSFRotation(final X3DNode node, final X3DFieldDefinition def, final tController control) {
        this.nodeName = node.getNodeName();
        this.fieldName = def.getName();
        this.field = (SFRotation) node.getField(fieldName);
