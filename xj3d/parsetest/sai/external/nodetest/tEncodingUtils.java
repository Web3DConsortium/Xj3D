...
/**
 * Utilities for encoding nodes, fields and arrays of primitive types into X3D
 * compatible strings
 */
public abstract class tEncodingUtils {
     ...
     */
    public static final String X3D_XML_IMMERSIVE_HEADER = "<X3D version=\"3.2\" profile=\"Immersive\">";
    ...
    /**
     * Return an XML encoding <code>String</code> representation of a
    ...
    /**
     * Return a Classic encoding <code>String</code> representation of a
     * <code>boolean</code> array.
     *
     * @param array
     * @return a Classic encoding <code>String</code> representation of a
     ...
     *
     * @param array
     * @return a <code>String</code> representation of an <code>int</code>
     * array.
     */
    ...
    /**
     * Return a <code>String</code> representation of a <code>float</code>
     * array.
     *
     * @param array
     * @return a <code>String</code> representation of a <code>float</code>
    ...
    /**
     * Return a <code>String</code> representation of a <code>double</code>
     * array.
     *
     * @param array
     * @return a <code>String</code> representation of a <code>double</code>
    ...
    /**
     * Return an XML encoding <code>String</code> representation of a
     * <code>String</code> array. The returned <code>String</code> will have any
     * XML special characters substituted with their respective equivalent
     * character entities. The returned <code>String</code> DOES include
     * delimiters (double quotation marks) for the individual
     * <code>String</code>s. Each <code>String</code> of the array is delimited
     * with double quotation marks and separated by white space. This
     * representation does NOT include the delimiters for the complete array of
     * <code>String</code>s (single quotation marks). For XML encoding, the
     * complete <code>String</code> array is delimited by the markup.
     *
     * @param array
     * @return an XML encoding <code>String</code> representation of a
    ...
    /**
     * Return an XML encoding <code>String</code> representation of a
     * <code>String</code>. The representation will have any XML special
     * characters substituted with their respective equivalent character
     * entities. The representation does NOT include delimiters (i.e. quotation
     * marks). For XML encoding, a single <code>String</code> value is delimited
     * by the markup.
     *
     * @param value
     * @return an XML encoding <code>String</code> representation of a
    ...
    public static String toXMLString(final String value) {
        ...
        for (String[] CHAR_ENT1 : CHAR_ENT) {
            for (int j = sb.indexOf(CHAR_ENT1[0]); j != -1; j = sb.indexOf(CHAR_ENT1[0], j + CHAR_ENT1[1].length())) {
                sb.replace(j, j + CHAR_ENT1[0].length(), CHAR_ENT1[1]);
            }
        }
        return sb.toString();
    }
    ...
    /**
     * Return a Classic encoding <code>String</code> representation of a
     * <code>String</code> array. Each <code>String</code> of the array is
     * delimited with double quotation marks and separated by white space.
     *
     * @param array
     * @return a Classic encoding <code>String</code> representation of a
     * <code>String</code> array.
    ...
    /**
     * Return a Classic encoding <code>String</code> representation of a
     * <code>String</code>. This representation DOES include delimiters (i.e.
     * double quotation marks) for the individual <code>String</code>.
     *
     * @param value
     * @return a Classic encoding <code>String</code> representation of a
     * <code>String</code>.
    ...
    public static String encodeClassic(final String fieldName, final boolean[] data) {
        final StringBuffer sb = new StringBuffer(SIZE);
        sb.append(fieldName);
        sb.append(SPACE + OPEN_BRACKET + SPACE);
        sb.append(toClassicString(data));
