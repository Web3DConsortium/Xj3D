...
/**
 * Test wrapper for the SFInt32 X3DField type
 */
public class tSFInt32 implements tX3DField {

    /**
     * Default smoke test write value
     */
    public final static int smoke_value = 1;
     ...
     * @param control
     */
    public tSFInt32(final X3DNode node, final X3DFieldDefinition def, final tController control) {
        this.nodeName = node.getNodeName();
        this.fieldName = def.getName();
        this.field = (SFInt32) node.getField(fieldName);
