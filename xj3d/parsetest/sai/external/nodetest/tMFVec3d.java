...
/**
 * Test wrapper for the MFVec3d X3DField type
 */
public class tMFVec3d implements tX3DField {

    /**
     * Default smoke test write value
     */
    public final static double[] smoke_value = new double[]{0.1f, 0.1f, 0.1f, 0.9f, 0.9f, 0.9f};
     ...
     * @param control
     */
    public tMFVec3d(final X3DNode node, final X3DFieldDefinition def, final tController control) {
        this.nodeName = node.getNodeName();
        this.fieldName = def.getName();
        this.field = (MFVec3d) node.getField(fieldName);
    ...
    public boolean smoke() {
        ...
        switch (access) {
            ...
            case X3DFieldTypes.OUTPUT_ONLY:
                r_value = new double[field.getSize() * 3];
