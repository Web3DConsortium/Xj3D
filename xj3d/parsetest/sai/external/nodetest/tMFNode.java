...
/**
 * Test wrapper for the MFNode X3DField type
 */
public class tMFNode implements tX3DField {
     ...
     * @param control
     */
    public tMFNode(final X3DNode node, final X3DFieldDefinition def, final tController control) {
        this.nodeName = node.getNodeName();
        this.fieldName = def.getName();
        this.field = (MFNode) node.getField(fieldName);
