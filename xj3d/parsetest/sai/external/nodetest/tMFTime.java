...
/**
 * Test wrapper for the MFTime X3DField type
 */
public class tMFTime implements tX3DField {
     ...
     * @param control
     */
    public tMFTime(final X3DNode node, final X3DFieldDefinition def, final tController control) {
        this.nodeName = node.getNodeName();
        this.fieldName = def.getName();
        this.field = (MFTime) node.getField(fieldName);
