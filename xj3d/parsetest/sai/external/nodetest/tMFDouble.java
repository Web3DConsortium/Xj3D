...
/**
 * Test wrapper for the MFDouble X3DField type
 */
public class tMFDouble implements tX3DField {
     ...
     * @param control
     */
    public tMFDouble(final X3DNode node, final X3DFieldDefinition def, final tController control) {
        this.nodeName = node.getNodeName();
        this.fieldName = def.getName();
        this.field = (MFDouble) node.getField(fieldName);
    ...
    public boolean smoke() {
        ...
        switch (access) {
            ...
            case X3DFieldTypes.OUTPUT_ONLY:
                r_value = new double[field.getSize()];
