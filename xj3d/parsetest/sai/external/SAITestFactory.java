...
public class SAITestFactory {
    ...
    /**
     * Make a new testing browser. Closing this browser window will cause
     * System.exit to be called
     *
     ...
     * @return
     */
    public static ExternalBrowser getBrowser(Map<String, Object> suppliedParams, boolean shouldQuit) {
        final X3DComponent comp = BrowserFactory.createX3DComponent(suppliedParams);
    ...
    /**
     * Produce an ExternalBrowser instance.
     *
     * @param shouldQuit Should closing the frame holding the browser call
     * System.exit?
     * @return
     */
...
//    BrowserFactory.setBrowserFactoryImpl(new org.web3d.j3d.browser.X3DJ3DBrowserFactoryImpl());
        ...
        requestedParameters.put("Xj3D_InterfaceType", "newt");
