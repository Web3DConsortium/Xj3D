...
/**
 * ***************************************************************************
 * Yumetech, Inc Copyright (c) 2006 Java Source
 *
...
/**
 * A testcase for starting/shutting down/restarting an SAI'ed browser instance
 * using the AWT UI toolkit.
 *
 * @author Rex Melton
...
public class BrowserRestartAWT extends JFrame implements BrowserListener, ActionListener {
    ...
    public BrowserRestartAWT() {
        ...
        button.addActionListener(BrowserRestartAWT.this);
