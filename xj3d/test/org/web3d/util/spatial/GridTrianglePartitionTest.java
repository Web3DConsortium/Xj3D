...
public class GridTrianglePartitionTest extends BaseTestCase {
    ...
    public void testAAAWorldCoords() {
        int gridSize = 10;
        int half = gridSize / 2;
        GridTrianglePartition grid = new GridTrianglePartition(0.25f, gridSize, 1);
    ...
    public void testTunnelOnGrid2() {
        GridTrianglePartition grid = new GridTrianglePartition(0.5f, 8, 2);
...
System.out.println(rayY + " sloc1: " + sloc1 + " sloc2: " + sloc2);
        ...
        int[] list = grid.getObjects(region);
...
System.out.println("list: " + list);
    ...
    public void testCalcBoundsForTriangle() {
        GridTrianglePartition grid = new GridTrianglePartition(10, 16, 1);
    ...
    public void testFindGridCoordsFromWorldCoords1() {
        int gridSize = 4;
        int half = gridSize / 2;
        GridTrianglePartition grid = new GridTrianglePartition(1f, gridSize, 1);
    ...
    public void testFindGridCoordsFromWorldCoords() {
        int gridSize = 16;
        int half = gridSize / 2;
        GridTrianglePartition grid = new GridTrianglePartition(1.5f, gridSize, 1);
        ...
        assertArrayEquals("Negative", new int[] {5,5,5}, coords);
    ...
    public void testGetObjectsCellRegion1() {
        GridTrianglePartition grid = new GridTrianglePartition(1, 20, 1);
    ...
    public void testGetObjectsSliceRegionY() {
        GridTrianglePartition grid = new GridTrianglePartition(1, 10, 1);
