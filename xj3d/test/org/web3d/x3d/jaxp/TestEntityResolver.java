...
//	"http://www.web3d.org/Specifications/X3D/x3d-compact-3.0.dtd"
    ...
    private static final String[] INVALID_URIS = {
	"test-3.0.dtd",
	"test-x3d-3.0.dtd",
	...
	return new TestSuite(TestEntityResolver.class);
    }
	...
	EntityResolver resolver = new X3DEntityResolver();
        ...
        for (String VALID_URI1 : VALID_URIS) {
            try {
	...
	EntityResolver resolver = new X3DEntityResolver();
        ...
        for (String INVALID_URI1 : INVALID_URIS) {
            try {
