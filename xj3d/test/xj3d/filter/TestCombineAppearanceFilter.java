...
/**
 * Test CombineAppearance Filter
 *
 * @author Rex Melton
 * @version $Revision: 1.0 $
 */
public class TestCombineAppearanceFilter extends BaseTestFilter {

	   /**
     * The filter argument name
     */
    public static final String FILTER_NAME = "CombineAppearances";

    /**
     * The directory containing the files to pass through the filter
     */
    public static final String PARSETEST = "parsetest/filter/CombineAppearance/";
    ...
    public static Test suite() {
        return new TestSuite(TestCombineAppearanceFilter.class);
    }

    /**
     * CombineAppearances Test Case.
     * <p>
     ...
     * not determined.
     */
    public void testCombineAppearance() {
