...
/**
 * Test RemoveNode Filter
 *
 * @author Rex Melton
 * @version $Revision: 1.0 $
 */
public class TestRemoveNodeFilter extends BaseTestFilter {

	   /**
     * The filter argument name
     */
    public static final String FILTER_NAME = "RemoveNode";

    /**
     * The directory containing the files to pass through the filter
     */
    public static final String PARSETEST = "parsetest/filter/RemoveNode/";
    ...
    public static Test suite() {
        return new TestSuite(TestRemoveNodeFilter.class);
    }

    /**
     * RemoveNode Test Case.
     * <p>
