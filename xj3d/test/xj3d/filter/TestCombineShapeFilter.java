...
/**
 * Test CombineShape Filter
 *
 * @author Rex Melton
 * @version $Revision: 1.0 $
 */
public class TestCombineShapeFilter extends BaseTestFilter {

    /** The filter argument name */
    public static final String FILTER_NAME = "CombineShapes";

    /** The directory containing the files to pass through the filter */
    public static final String PARSETEST = "parsetest/filter/CombineShapes/";
    ...
    public static Test suite() {
        return new TestSuite(TestCombineShapeFilter.class);
    }

    /**
     * CombineShapes Test Case.
     * <p>
    ...
    public void testCombineShape() {
        ...
        validArgs.add("Shape LTE 1");
        validArgs.add("-countNode2");
        validArgs.add("Transform LTE 1");
