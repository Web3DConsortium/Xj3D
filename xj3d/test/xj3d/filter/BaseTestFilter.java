...
public abstract class BaseTestFilter extends TestCase {
    ...
    public int executeFilter(List<String> filterList, List<String> argList,
        ...
        args[idx++] = URLChecker.prependFileScheme(src.getAbsolutePath());
...
//                filters = new String[] {};
            ...
            idx = 0;
            args[idx++] = validator;
            args[idx++] = URLChecker.prependFileScheme(dest.getAbsolutePath());
        ...
        /*
            String url_st = dest.toURL().toString();

            URL url = new URL(url_st);

            ByteArrayInputStream is = new ByteArrayInputStream(os.toByteArray());
            load(new InputSource(baseURL, is));
         */
    }
}
