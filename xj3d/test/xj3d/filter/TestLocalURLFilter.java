...
/**
 * Test LocalURL Filter
 *
 * @author Rex Melton
 * @version $Revision: 1.0 $
 */
public class TestLocalURLFilter extends BaseTestFilter {

    /**
     * The filter argument name
     */
    public static final String FILTER_NAME = "LocalURL";

    /**
     * The directory containing the files to pass through the filter
     */
    public static final String PARSETEST = "parsetest/filter/LocalURLFilter/";
    ...
    public static Test suite() {
        return new TestSuite(TestLocalURLFilter.class);
    }
