 ...
 */
public class TestIndexFilter extends BaseTestFilter {

	   /**
     * The filter argument name
     */
    public static final String FILTER_NAME = "Index";

    /**
     * The directory containing the files to pass through the filter
     */
    public static final String PARSETEST = "parsetest/filter/Index/";
    ...
    public static Test suite() {
        return new TestSuite(TestIndexFilter.class);
    }
