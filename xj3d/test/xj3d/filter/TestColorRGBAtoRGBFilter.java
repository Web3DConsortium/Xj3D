...
/**
 * Test ColorRGBAtoRGB Filter
 *
 * @author Rex Melton
 * @version $Revision: 1.0 $
 */
public class TestColorRGBAtoRGBFilter extends BaseTestFilter {

    /**
     * The filter argument name
     */
    public static final String FILTER_NAME = "ColorRGBAtoRGB";

    /**
     * The directory containing the files to pass through the filter
     */
    public static final String PARSETEST = "parsetest/filter/ColorRGBAtoRGB/";
    ...
    public static Test suite() {
        return new TestSuite(TestColorRGBAtoRGBFilter.class);
    }

    /**
     * ColorRGBAtoRGB Test Case.
     * <p>
     ...
     * not determined.
     */
    public void testColorRGBAtoRGB() {
