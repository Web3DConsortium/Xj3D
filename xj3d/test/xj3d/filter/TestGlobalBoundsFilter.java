...
/**
 * Test GlobalBounds Filter
 *
 * @author Rex Melton
 * @version $Revision: 1.0 $
 */
public class TestGlobalBoundsFilter extends BaseTestFilter {

    /**
     * The filter argument name
     */
    public static final String FILTER_NAME = "GlobalBounds";

    /**
     * The directory containing the files to pass through the filter
     */
    public static final String PARSETEST = "parsetest/filter/GlobalBoundsFilter/";
    ...
    public static Test suite() {
        return new TestSuite(TestGlobalBoundsFilter.class);
    }

    /**
     * GlobalBounds Test Case.
     * <p>
