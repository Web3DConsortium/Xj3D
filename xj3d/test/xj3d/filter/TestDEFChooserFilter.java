...
/**
 * Test DEFChooser Filter
 *
 * @author Rex Melton
 * @version $Revision: 1.0 $
 */
public class TestDEFChooserFilter extends BaseTestFilter {

    /**
     * The filter argument name
     */
    public static final String FILTER_NAME = "DEFChooser";

    /**
     * The directory containing the files to pass through the filter
     */
    public static final String PARSETEST = "parsetest/filter/DEFChooser/";
    ...
    public static Test suite() {
        return new TestSuite(TestDEFChooserFilter.class);
    }

    /**
     * DEFChooser Test Case.
     * <p>
