 ...
 */
public class TestCenterFilter extends BaseTestFilter {

	   /**
     * The filter argument name
     */
    public static final String FILTER_NAME = "Center";

    /**
     * The directory containing the files to pass through the filter
     */
    public static final String PARSETEST = "parsetest/filter/CenterFilter/";
    ...
    public static Test suite() {
        return new TestSuite(TestCenterFilter.class);
    }
