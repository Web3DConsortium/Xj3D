...
public class Model implements ThreeMFElement {
    ...
    private Map<Integer,ModelResource> resourceMap;
    ...
    public Integer generateResourceID() {
    ...
    public ModelResource getResource(Integer id) {
    ...
    public void addElement(ThreeMFElement el) {
        ...
        if (el instanceof ModelResource) {
            ModelResource mr = (ModelResource) el;

            resources.add(mr);
            resourceMap.put(mr.getID(),mr);
        }
    }
