...
public abstract class AbstractFilter
    ...
    /** The error handler for this output */
    protected ErrorReporter errorHandler;

    /** The document documentLocator to find error information */
    protected DocumentLocator documentLocator;

    /** The ScriptHandler to issue results to */
    ...
    /** Reader of fields in case we get text values */
    protected VRMLFieldReader fieldReader;

    /** The output handler for fields */
    ...
    /** If we exited abnormally, this is the error code.  Equal to
     * zero (0), which should be equal to FilterExitCodes.SUCCESS, if
    ...
    public void useDecl(String defName) throws SAVException, VRMLException {
        ...
        // TODO: In the case that we get an MFNode with two USES
        // in it, calling the pop here will mess up the stack
        //
        fieldStack.pop();
