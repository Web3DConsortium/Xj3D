 ...
 * <p>
 *
 * To label a debug stream pass in a filter argument -label1 for the first instance.
 * -label2 for the second, etc.
 *
 * @author Justin Couch
...
public class DebugFilter extends BaseFilter {
    ...
    /** Argument for selecting to print field values */
    private static final String PRINT_FIELD_VALUES = "-printFields";

    /** Argument for labeling the stream */
    private static final String LABEL = "-label";

    /** Should we print out the field values */
    private static boolean printFieldValues;

    /** What to label to debug output */
    private String label;

    /** The debug count instance */
    private static int debugCount;

    public DebugFilter() {
        super(DEBUG);

        printFieldValues = false;
        label = "";
        debugCount++;
    }
    ...
    public void setDocumentLocator(DocumentLocator loc) {
        System.out.println(label + "setDocumentLocator(" + loc + ")");
    ...
    public void startDocument(String uri,
        ...
        System.out.println(label +"startDocument(" + uri + ", " + url + ", "  +
    ...
    public void profileDecl(String profileName)
        ...
        System.out.println(label +"profileDecl(" + profileName + ")");
    ...
    public void componentDecl(String componentInfo)
        ...
        System.out.println(label +"componentDecl(" + componentInfo + ")");
    ...
    public void metaDecl(String key, String value)
        ...
        System.out.println(label +"metaDecl(" + key + ", " + value + ")");
    ...
    public void importDecl(String inline, String exported, String imported)
        ...
        System.out.println(label +"importDecl(" + inline + ", " + exported +
                           ", " + imported + ")");
    ...
    public void exportDecl(String defName, String exported)
        ...
        System.out.println(label + "exportDecl(" + defName + ", " + exported + ")");
    ...
    public void endDocument() throws SAVException, VRMLException {
       ...
       System.out.println(label + "endDocument()");
    ...
    public void startNode(String name, String defName)
        ...
        System.out.println(label + "startNode(" + name + ", " + defName + ")");
    ...
    public void endNode() throws SAVException, VRMLException {
		...
		String node_name = marker.nodeName;

        System.out.println(label + "endNode(" + node_name + ")");
    ...
    public void startField(String name) throws SAVException, VRMLException {
        System.out.println(label + "startField(" + name + ")");
    ...
    public void useDecl(String defName) throws SAVException, VRMLException {
        ...
        System.out.println(label + "useDecl(" + defName + ")");
    ...
    public void endField() throws SAVException, VRMLException {
		...
		NodeMarker marker = (NodeMarker)nodeStack.peek();
		String field_name = marker.fieldName;

        System.out.println(label + "endField(" + field_name + ")");
    ...
    public void fieldValue(String value) throws SAVException, VRMLException {
        ...
        if (printFieldValues) {
            System.out.print(label + "fieldValue(String:");
            System.out.print(value);
            System.out.println(")");
        } else {
            System.out.println(label + "fieldValue(String)");
        }
    ...
    public void fieldValue(int value)
        ...
        if (printFieldValues) {
            System.out.print(label + "fieldValue(int:");
            System.out.print(value);
            System.out.println(")");
        } else {
            System.out.println(label + "fieldValue(int)");
        }
    ...
    public void fieldValue(int[] value, int len)
        ...
        if (printFieldValues) {
            System.out.print(label + "fieldValue(int[]: ");
            System.out.print("Array size: " + value.length);
            ...
            System.out.println(label + "fieldValue(int[], int)");
        }
    ...
    public void fieldValue(boolean value)
        ...
        if (printFieldValues) {
            System.out.print(label + "fieldValue(boolean:");
            System.out.print(value);
            System.out.println(")");
        } else {
            System.out.println(label + "fieldValue(boolean)");
        }
    ...
    public void fieldValue(boolean[] value, int len)
        ...
        if (printFieldValues) {
            ...
            System.out.println(label + "fieldValue(boolean[], int)");
        }
    ...
    public void fieldValue(float value)
        ...
        if (printFieldValues) {
            System.out.print(label + "fieldValue(float:");
            System.out.print(value);
            System.out.println(")");
        } else {
            System.out.println(label + "fieldValue(float)");
        }
    ...
    public void fieldValue(float[] value, int len)
        ...
        if (printFieldValues) {
            ...
            System.out.println(label + "fieldValue(float[], int)");
        }
    ...
    public void fieldValue(long value)
        ...
        if (printFieldValues) {
            System.out.print(label + "fieldValue(long:");
            System.out.print(value);
            System.out.println(")");
        } else {
            System.out.println(label + "fieldValue(long)");
        }
    ...
    public void fieldValue(long[] value, int len)
        ...
        if (printFieldValues) {
            ...
            System.out.println(label + "fieldValue(long[], int)");
        }
    ...
    public void fieldValue(double value)
        ...
        if (printFieldValues) {
            System.out.print(label + "fieldValue(double:");
            System.out.print(value);
            System.out.println(")");
        } else {
            System.out.println(label + "fieldValue(double)");
        }
    ...
    public void fieldValue(double[] value, int len)
        ...
        if (printFieldValues) {
            ...
            System.out.println(label + "fieldValue(double[], int)");
        }
    ...
    public void fieldValue(String[] value, int len)
        ...
        System.out.println(label + "fieldValue(String[], int)");
    ...
    public void startProtoDecl(String name) throws SAVException, VRMLException {
        ...
        System.out.println(label + "startProtoDecl(" + name + ")");
    ...
    public void endProtoDecl() throws SAVException, VRMLException {
        System.out.println(label + "endProtoDecl()");
    ...
    public void protoFieldDecl(int access,
        ...
        System.out.println(label + "protoFieldDecl(" + access + ", " + type + ", " +
                           name + ", " + value + ")");
    ...
    public void protoIsDecl(String fieldName) throws SAVException, VRMLException {
        System.out.println(label + "protoIsDecl(" + fieldName + ")");
    ...
    public void startProtoBody() throws SAVException, VRMLException {
        System.out.println(label + "startProtoBody()");
    ...
    public void endProtoBody() throws SAVException, VRMLException {
        System.out.println(label + "endProtoBody()");
        super.endProtoBody();
    }
    ...
    public void startExternProtoDecl(String name) throws SAVException, VRMLException {
        System.out.println(label + "startExternProtoDecl(" + name + ")");
    ...
    public void endExternProtoDecl() throws SAVException, VRMLException {
        System.out.println(label + "endExternProtoDecl()");
    ...
    public void externProtoURI(String[] values) throws SAVException, VRMLException {
        System.out.println(label + "externProtoURI()");
    ...
    public void startScriptDecl() throws SAVException, VRMLException {
        System.out.println(label + "startScriptDecl()");
    ...
    public void endScriptDecl() throws SAVException, VRMLException {
        System.out.println(label + "endScriptDecl()");
        super.endScriptDecl();
    }
    ...
    public void scriptFieldDecl(int access,
        ...
        System.out.println(label + "scriptFieldDecl( " + access + ", " + type + ", " +
                           name + ", " + value + ")");
    ...
    public void routeDecl(String srcNodeName,
        ...
        System.out.println(label + "routeDecl(" + srcNodeName + ", " + srcFieldName +
    ...
    public void setArguments(String[] args) {
        ...
        for (int i = 0; i< args.length; i++) {
            if (args[i].equals(PRINT_FIELD_VALUES)) {
                printFieldValues = true;
            } else if (args[i].equals(LABEL + debugCount)) {
                if (i + 1 >= args.length){

                    throw new IllegalArgumentException(
                        "Not enough args for DebugFilter.  " +
                        "Expecting one more for label.");
                }
