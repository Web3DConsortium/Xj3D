 ...
 */
public class EncodedBaseFilter extends BaseFilter {
     ...
     */
    protected EncodedBaseFilter(boolean debug) {
        super(debug);
...
/*
if (encodeNodes != val) {
System.out.println("Encode change state to: " + val + " for: " + this);
}
*/
        encodeNodes = val;
    }
