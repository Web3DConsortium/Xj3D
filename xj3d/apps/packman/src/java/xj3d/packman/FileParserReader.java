...
class FileParserReader extends BaseReader {
    ...
    private void parseX3D(final InputSource input, String contentType)
        ...
        if(contentType != null && contentType.equals("model/x3d+binary")) {
            ...
            try {
                Reader is = AccessController.doPrivileged(input.getCharacterStream());
...
/*
                DocumentLocator documentLocator = savContentHandler.getDocumentLocator();

                if (documentLocator != null)
                    adapter.setDocumentLocator(documentLocator);
*/
            ...
            } catch(ParserConfigurationException | VRMLException | SAXException e) {
    ...
    private NonWeb3DFileParser loadParserClass(final String classname) {
        ...
        try {
            ret_val = (NonWeb3DFileParser)AccessController.doPrivileged((PrivilegedExceptionAction) () -> {
