 ...
 * <tr><td>Xj3D_InterfaceType</td><td>Whether to use NEWT, Swing or AWT</td><td>String</td><td>Swing</td><td>swing,awt,swing-lightweight,newt</td></tr>
...
public class BrowserFactory
{
  ...
  private static final Properties vrml_properties;
   ...
   */
  @SuppressWarnings("deprecation")
  public static Browser getBrowser(java.applet.Applet applet, String frameName, int index)
    throws NotSupportedException, NoSuchBrowserException, ConnectionException
  {
    if(factory == null)
      loadFactoryImpl();
  ...
  private static void loadFactoryImpl()
  {
    try
    {
      ...
      String factory_class_name =
        vrml_properties.getProperty(FACTORY_CLASS,
    ...
    {
      System.err.println("Unable to find vrml browser factory implementation\n" + cnfe);
    }
    catch(InstantiationException ie)
    {
      System.err.println("Error instantiating the vrml browser factory " + ie);
    }
    ...
    {
      System.err.println("The nominated browser factory is not an instance of " +
