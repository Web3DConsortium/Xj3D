...
public class MFRotation extends MField {
    ...
    public MFRotation(float rots[]) {
        ...
        if(rots.length < 4)
            throw new IllegalArgumentException("MFRotation array length less than 4");
    ...
    public void get1Value(int index, float rots[]) {
        if(index >= numElements)
            throw new IllegalArgumentException("MFRotation index > numElements");
    ...
    public void get1Value(int index, SFRotation rot) {
        if(index >= numElements)
            throw new IllegalArgumentException("MFRotation get1Value index > numElements");
     ...
     * @param rots Rotation 4-tuples flattened.
     */
    ...
    public void set1Value(int index, ConstSFRotation rot) {
        if(index >= numElements)
            throw new IllegalArgumentException("MFRotation set1Value index > numElements");
    ...
    public void insertValue(int index, ConstSFRotation rot) {
        if(index >= numElements)
            throw new IllegalArgumentException("MFRotation insertValue index > numElements");
    ...
    public void delete(int index) {
        if((index < 0) || (index >= numElements))
            throw new ArrayIndexOutOfBoundsException("MFRotation delete invalid index");
