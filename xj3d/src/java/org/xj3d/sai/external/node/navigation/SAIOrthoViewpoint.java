...
public class SAIOrthoViewpoint extends SAINode implements OrthoViewpoint {
...
private SFBool retainUserOffsets;
    ...
    /**
     * The viewAll inputOutput field
     */
    private SFBool viewAll;
 ...
 * @param val The boolean to set.  */
  ...
  retainUserOffsets.setValue( val );
    ...
    /**
     * Return the viewAll boolean value.
     *
     * @return The viewAll boolean value.
     */
    @Override
    public boolean getViewAll() {
        if (viewAll == null) {
            viewAll = (SFBool) getField("viewAll");
        }
        return (viewAll.getValue());
    }

    /**
     * Set the viewAll field.
     *
     * @param val The boolean to set.
     */
    @Override
    public void setViewAll(boolean val) {
        if (viewAll == null) {
            viewAll = (SFBool) getField("viewAll");
        }
        viewAll.setValue(val);
    }
