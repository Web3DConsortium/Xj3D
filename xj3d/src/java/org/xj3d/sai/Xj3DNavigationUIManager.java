...
public interface Xj3DNavigationUIManager  {
     ...
     * identically to {@link org.web3d.x3d.sai.Browser#nextViewpoint()} call.
     */
    void nextViewpoint();
     ...
     * work identically to {@link org.web3d.x3d.sai.Browser#previousViewpoint()}
     * call.
     */
     ...
     * this layer due to there being none defined (i.e. just the default
     ...
     *
     * @param vp The viewpoint instance to use
     */
     ...
     */
    void addNavigationUIListener(Xj3DNavigationUIListener l);
     ...
     */
    void removeNavigationUIListener(Xj3DNavigationUIListener l);
}
