...
public interface UndefinedX3DFieldTypes {
    ...
    int SFMATRIX3D = "SFMATRIX3D".hashCode( );
    int MFMATRIX3D = "MFMATRIX3D".hashCode( );
    int SFMATRIX3F = "SFMATRIX3F".hashCode( );
    int MFMATRIX3F = "MFMATRIX3F".hashCode( );
    int SFMATRIX4D = "SFMATRIX4D".hashCode( );
    int MFMATRIX4D = "MFMATRIX4D".hashCode( );
    int SFMATRIX4F = "SFMATRIX4F".hashCode( );
    int MFMATRIX4F = "MFMATRIX4F".hashCode( );
    int SFVEC4D = "SFVEC4D".hashCode( );
    int MFVEC4D = "MFVEC4D".hashCode( );
    int SFVEC4F = "SFVEC4F".hashCode( );
    int MFVEC4F = "MFVEC4F".hashCode( );
}
