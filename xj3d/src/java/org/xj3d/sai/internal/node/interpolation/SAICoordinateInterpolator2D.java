...
import org.web3d.x3d.sai.interpolation.CoordinateInterpolator2D;
 ...
 */
public class SAICoordinateInterpolator2D extends BaseNode implements CoordinateInterpolator2D {
     ...
     */
    private MFVec2f value_changed;

    /**
     * Constructor
     * @param bnf
     */
    public SAICoordinateInterpolator2D(
            VRMLNodeType node,
    ...
    /**
     * Return the number of MFVec2f items in the value_changed field.
     *
     * @return the number of MFVec2f items in the value_changed field.
     */
    @Override
    public int getNumValue() {
        if (value_changed == null) {
            value_changed = (MFVec2f) getField("value_changed");
        }
        return (value_changed.getSize());
    }
