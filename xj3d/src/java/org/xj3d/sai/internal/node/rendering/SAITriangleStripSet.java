...
import org.web3d.x3d.sai.rendering.TriangleStripSet;
 ...
 */
public class SAITriangleStripSet extends BaseNode implements TriangleStripSet {
    ...
    /**
     * The stripCount inputOutput field
     */
    private MFInt32 stripCount;

    /**
     * Constructor
     * @param bnf
     */
    public SAITriangleStripSet(
            VRMLNodeType node,
    ...
    public int getNumStripCount() {
        if (stripCount == null) {
            stripCount = (MFInt32) getField("stripCount");
        }
        return (stripCount.getSize());
    }
     ...
     */
    @Override
    public void getStripCount(int[] val) {
        if (stripCount == null) {
            stripCount = (MFInt32) getField("stripCount");
        }
        stripCount.getValue(val);
    }
     ...
     */
    @Override
    public void setStripCount(int[] val) {
        if (stripCount == null) {
            stripCount = (MFInt32) getField("stripCount");
        }
        stripCount.setValue(val.length, val);
    }
}
