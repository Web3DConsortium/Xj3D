...
import org.web3d.x3d.sai.interpolation.CoordinateInterpolator;
 ...
 */
public class SAICoordinateInterpolator extends BaseNode implements CoordinateInterpolator {
     ...
     */
    private MFVec3f value_changed;

    /**
     * Constructor
     * @param bnf
     */
    public SAICoordinateInterpolator(
            VRMLNodeType node,
    ...
    /**
     * Return the number of MFVec3f items in the value_changed field.
     *
     * @return the number of MFVec3f items in the value_changed field.
     */
    @Override
    public int getNumValue() {
        if (value_changed == null) {
            value_changed = (MFVec3f) getField("value_changed");
        }
