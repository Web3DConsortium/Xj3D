...
import org.web3d.x3d.sai.rendering.TriangleFanSet;
 ...
 */
public class SAITriangleFanSet extends BaseNode implements TriangleFanSet {
    ...
    /**
     * The fanCount inputOutput field
     */
    private MFInt32 fanCount;

    /**
     * Constructor
     * @param bnf
     */
    public SAITriangleFanSet(
            VRMLNodeType node,
    ...
    public int getNumFanCount() {
        if (fanCount == null) {
            fanCount = (MFInt32) getField("fanCount");
        }
        return (fanCount.getSize());
    }
    ...
    public void setFanCount(int[] val) {
        ...
        fanCount.setValue(val.length, val);
    }
}
