...
public interface Xj3DNavigationUIListener {
     ...
     *
     * @param viewpoints An array of exactly the number of viewpoints in the
     *     list
     */
     ...
     */
    void availableNavigationStatesChanged(String[] states);
     ...
     */
    void selectedNavigationStateChanged(String state);
}
