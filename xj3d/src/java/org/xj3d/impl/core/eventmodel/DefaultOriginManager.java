...
//System.out.println( ">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>TRIGGER_ELEVATION>"+ java.util.Arrays.toString(wgs84) );
    ...
    private void checkProperties() {
        String[] prop = AccessController.doPrivileged((PrivilegedAction<String[]>) () -> {
            String[] prop1 = new String[3];
            prop1[0] = System.getProperty(ORIGIN_MANAGER_ENABLED_PROP);
            prop1[1] = System.getProperty(DEFAULT_ORIGIN_MANAGER_ELEVATION_THRESHOLD_PROP);
            prop1[2] = System.getProperty(DEFAULT_ORIGIN_MANAGER_DISTANCE_THRESHOLD_PROP);
            return prop1;
        });
...
} // end class file DefaultOriginManager
