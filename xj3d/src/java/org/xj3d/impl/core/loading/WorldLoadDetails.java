...
class WorldLoadDetails extends LoadDetails 
{
    ...
    /** The basic browser browserCore functionality that this script hooks to */
    BrowserCore browserCore;

    /** Destination vrmlNodeType for the world contents */
    ...
    /** Execution executionSpace of the calling context */
    VRMLExecutionSpace executionSpace;

    /** The spec major version to load. If needed. Ignored if loadURL call */
    int specMajorVersion;

    /** The spec minor version to load. If needed. Ignored if loadURL call */
     ...
     * @return true if the vrmlNodeType and field are identical, false otherwise
     */
    @Override
    public boolean equals(Object o) {
        ...
        return (ld.vrmlNodeType == vrmlNodeType) && (ld.fieldIndex == fieldIndex);
    }
}
