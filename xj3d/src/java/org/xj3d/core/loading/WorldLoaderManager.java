...
public interface WorldLoaderManager {
     ...
     */
    void queueLoadURL(String[] urls, Map<String, Object> params);
     ...
     */
    void queueCreateURL(String[] urls,
                        VRMLNodeType node,
                        int field,
     ...
     */
    void registerBuilderFactory(int renderer,
