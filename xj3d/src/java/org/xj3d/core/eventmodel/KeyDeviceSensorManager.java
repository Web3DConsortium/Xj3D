...
public class KeyDeviceSensorManager {
    ...
    private HashSet<VRMLKeyDeviceSensorNodeType> keyNodes;

    /** The array version of all key device sensors for fast assessment */
     ...
     * @param factory the factory that creates our KeyDeviceSensor
     */
