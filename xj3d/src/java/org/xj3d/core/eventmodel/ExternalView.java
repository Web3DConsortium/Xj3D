...
public interface ExternalView {
    ...
    /**
     * Notification that the external view should now process and propagate to
     * the underlying nodes.
     */
    void processEvents();

    /**
     * Notification that the external view should clear it's state in preparation
     * for either loading a new world or shutting down completely.
     */
    void clear();
}
