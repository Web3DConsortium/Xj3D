...
public interface ViewpointStatusListener {
     ...
     */
    void availableViewpointsChanged(VRMLViewpointNodeType[] viewpoints);
     ...
     */
    void selectedViewpointChanged(VRMLViewpointNodeType vp);
     ...
     */
    void viewpointAdded(VRMLViewpointNodeType vp);
     ...
     * @param vp The viewpoint instance that was added
     */
    void viewpointRemoved(VRMLViewpointNodeType vp);
}
