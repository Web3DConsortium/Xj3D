...
public interface NavigationStatusListener {
     ...
     */
    void navigationListChanged(List<String> modes);
     ...
     */
    void availableNavigationInfoChanged(VRMLNavigationInfoNodeType[] states);
     ...
     */
    void selectedNavigationInfoChanged(VRMLNavigationInfoNodeType state);
}
