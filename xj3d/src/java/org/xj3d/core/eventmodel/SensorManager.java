...
public interface SensorManager {
     ...
     */
    void setKeyDeviceSensorManager(KeyDeviceSensorManager manager);
     ...
     */
    void addLayerSensorManager(LayerSensorManager mgr);
     ...
     */
    void removeLayerSensorManager(LayerSensorManager mgr);
     ...
     */
    void setRenderOrder(int[] order, int numValid);
     ...
     */
    void processUserInput(int layerId, long time);
