...
public class X3DBrowserJPanel extends BrowserJPanel implements X3DComponent {
    ...
    public X3DBrowserJPanel( BrowserConfig parameters ) {
        ...
        ContentLoadManager load_manager = mainCanvas.getContentLoadManager();
        ...
        if (locToolbar != null) {
            ...
            frameThrottle.setLoadManager(load_manager);
    ...
    public void shutdown() {
        ...
        try {
            saiBrowser.dispose( );
        } catch ( InvalidBrowserException e ) { /* ignore */ }

        // shutdown JOGL and JOAL resources
        if ( universe != null ) {
            destroy();
        }
    }
