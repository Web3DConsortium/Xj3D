...
public abstract class BrowserJPanel extends JPanel
    ...
    protected BrowserJPanel(BrowserConfig parameters) {
        ...
        if (parameters.interfaceType == BrowserInterfaceTypes.NEWT || surface instanceof SimpleNEWTSurface)
            glCanvas = new NewtCanvasAWT((com.jogamp.newt.Window) surface.getSurfaceObject());
        else
        ...
        setupProperties(parameters.textureQuality, parameters.forceLighting);
     ...
     */
    private void setupProperties(final String textureQuality, final boolean forceLighting) {
        try {
            AccessController.doPrivileged((PrivilegedExceptionAction<Object>) () -> {
                ...
                if (forceLighting) {
                    System.setProperty("org.web3d.vrml.renderer.common.nodes.shape.forceLighting", "true");
                }
