...
public class OpenAction extends AbstractAction {
    ...
    public OpenAction(Component parent,
        ...
        X3DFileFilter x3DFileFilter = new X3DFileFilter();
        fc.addChoosableFileFilter(x3DFileFilter);
        fc.addChoosableFileFilter(new VRMLFileFilter());
        fc.addChoosableFileFilter(new Web3DFileFilter());
        fc.setFileFilter(x3DFileFilter);
    }
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        try {
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
                ...
                if (file.exists())
                    fileHandler.loadURL(file.toURI().toURL().toString());
            }
