...
public class SwingLocationToolbar extends JPanel
    ...
    public SwingLocationToolbar(BrowserCore core,
        ...
        userDir = AccessController.doPrivileged((PrivilegedAction<String>) () -> System.getProperty("user.dir"));
        ...
        browserCore.addCoreListener(SwingLocationToolbar.this);
        ...
        urlComboBox.addActionListener(SwingLocationToolbar.this);
        urlComboBox.requestFocus();
        urlComboBox.setEditable(!urlReadOnly);

        if(!urlReadOnly) {
            locationGoButton.addActionListener(SwingLocationToolbar.this);
        }
        ...
        if(showOpenButton || showReloadButton) {
            ...
            if(showOpenButton) {
                ...
                openAction = new OpenAction(this, this, userDir);
    ...
    public void browserInitialized(VRMLScene scene) {
        ...
        // Possibly a bit streamed xml based scene was parsed
        if (uri == null || uri.isEmpty())
            uri = "Unknown URL source. Base URL is " + scene.getWorldRootURL();

        errorReporter.messageReport("Main scene is loaded:\n  " + uri);
    }
     ...
     * @param throttle the frame rate throttle
     */
