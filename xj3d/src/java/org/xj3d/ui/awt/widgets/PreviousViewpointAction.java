 ...
 */
public class PreviousViewpointAction extends AbstractAction {
     ...
     */
    public PreviousViewpointAction(boolean standAlone, Icon icon, ViewpointManager manager) {
        ...
        KeyStroke acc_key = KeyStroke.getKeyStroke(KeyEvent.VK_PAGE_UP, 0);

        putValue(ACCELERATOR_KEY, acc_key);
        putValue(SHORT_DESCRIPTION, "Goto the Previous viewpoint");
    }
