 ...
 */
public class NextViewpointAction extends AbstractAction {
     ...
     */
    public NextViewpointAction(boolean standAlone, Icon icon, ViewpointManager manager) {
        ...
        KeyStroke acc_key = KeyStroke.getKeyStroke(KeyEvent.VK_PAGE_DOWN, 0);

        putValue(ACCELERATOR_KEY, acc_key);
        //putValue(MNEMONIC_KEY, new Integer(KeyEvent.VK_N));
        putValue(SHORT_DESCRIPTION, "Goto the next viewpoint");
    }
