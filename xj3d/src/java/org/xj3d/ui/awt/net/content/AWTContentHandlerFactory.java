 ...
 * AWT UI toolkit dependent content handlers.
 *
 * @author  Rex Melton
 * @version $Revision: 1.2 $
 */
public class AWTContentHandlerFactory extends VRMLContentHandlerFactory {
     ...
     */
    public AWTContentHandlerFactory( BrowserCore browser,
	...
	if ( contentType.startsWith( IMAGE_TYPE_PREFIX ) ) {
            return( new AWTImageContentHandler( ) );
        }
	else {
