...
public class X3DSAVAdapter
    ...
    protected static final String NO_CONTAINER_PROPS_MSG =
        "Couldn't find container properties file";

    /** Message when we couldn't read the container properties file */
    protected static final String CONTAINER_PROPS_READ_ERR =
     ...
     */
    protected static final String UNKNOWN_ELEMENT_MSG =
    ...
    protected static final String PROFILE_ATTR = "profile";
    ...
    protected static final Map<String, Float> specVersionMap;

    /** Map the spec version to version string */
    protected static final Map<Float, String> specStringMap;

    /** Set of permitted public IDs */
    protected static final HashSet<String> allowedPublicIDs;

    /** Set of permitted system IDs */
    protected static final HashSet<String> allowedSystemIDs;

    /** Set of permitted schema IDs */
    protected static final HashSet<String> systemSchemaIDs;

    /** Mapping of field access type strings to constant integers */
    protected static final Map<String, Integer> fieldAccessMap;

    /** Mapping of element names strings to constants */
    protected static final Map<String, Integer> elementMap;

    /** Mapping of reserved attribute names strings to constants */
    protected static final Map<String, Integer> attributeMap;
    ...
    protected org.web3d.vrml.sav.DocumentLocator savLocator;
     ...
     */
    protected HashSet<String> namespacePrefixes;
    ...
    static {
        ...
        allowedSystemIDs.add(X3DConstants.GENERAL_SYSTEM_ID_3_0.replaceAll("http:", "https:"));
        ...
        allowedSystemIDs.add(X3DConstants.GENERAL_SYSTEM_ID_3_1.replaceAll("http:", "https:"));
        ...
        allowedSystemIDs.add(X3DConstants.GENERAL_SYSTEM_ID_3_2.replaceAll("http:", "https:"));

        // V3.3 definitions.
        spec_ver = 3.3f;
        specStringMap.put(spec_ver, "V3.3");

        specVersionMap.put(X3DConstants.GENERAL_PUBLIC_ID_3_3, spec_ver);
        specVersionMap.put(X3DConstants.INTERCHANGE_PUBLIC_ID_3_3, spec_ver);
        specVersionMap.put(X3DConstants.CAD_INTERCHANGE_PUBLIC_ID_3_3, spec_ver);
        specVersionMap.put(X3DConstants.INTERACTIVE_PUBLIC_ID_3_3, spec_ver);
        specVersionMap.put(X3DConstants.IMMERSIVE_PUBLIC_ID_3_3, spec_ver);
        specVersionMap.put(X3DConstants.FULL_PUBLIC_ID_3_3, spec_ver);

        allowedPublicIDs.add(X3DConstants.GENERAL_PUBLIC_ID_3_3);
        allowedPublicIDs.add(X3DConstants.INTERCHANGE_PUBLIC_ID_3_3);
        allowedPublicIDs.add(X3DConstants.CAD_INTERCHANGE_PUBLIC_ID_3_3);
        allowedPublicIDs.add(X3DConstants.INTERACTIVE_PUBLIC_ID_3_3);
        allowedPublicIDs.add(X3DConstants.IMMERSIVE_PUBLIC_ID_3_3);
        allowedPublicIDs.add(X3DConstants.FULL_PUBLIC_ID_3_3);

        allowedSystemIDs.add(X3DConstants.GENERAL_SYSTEM_ID_3_3);
        allowedSystemIDs.add(X3DConstants.GENERAL_SYSTEM_ID_3_3.replaceAll("http:", "https:"));

        // V4.0 definitions.
        spec_ver = 4.0f;
        specStringMap.put(spec_ver, "V4.0");

        specVersionMap.put(X3DConstants.GENERAL_PUBLIC_ID_4_0, spec_ver);
        specVersionMap.put(X3DConstants.INTERCHANGE_PUBLIC_ID_4_0, spec_ver);
        specVersionMap.put(X3DConstants.CAD_INTERCHANGE_PUBLIC_ID_4_0, spec_ver);
        specVersionMap.put(X3DConstants.INTERACTIVE_PUBLIC_ID_4_0, spec_ver);
        specVersionMap.put(X3DConstants.IMMERSIVE_PUBLIC_ID_4_0, spec_ver);
        specVersionMap.put(X3DConstants.FULL_PUBLIC_ID_4_0, spec_ver);

        allowedPublicIDs.add(X3DConstants.GENERAL_PUBLIC_ID_4_0);
        allowedPublicIDs.add(X3DConstants.INTERCHANGE_PUBLIC_ID_4_0);
        allowedPublicIDs.add(X3DConstants.CAD_INTERCHANGE_PUBLIC_ID_4_0);
        allowedPublicIDs.add(X3DConstants.INTERACTIVE_PUBLIC_ID_4_0);
        allowedPublicIDs.add(X3DConstants.IMMERSIVE_PUBLIC_ID_4_0);
        allowedPublicIDs.add(X3DConstants.FULL_PUBLIC_ID_4_0);
        ...
        systemSchemaIDs.add(X3DConstants.SCHEMA_ID_3_0.replaceAll("http:", "https:"));
        systemSchemaIDs.add(X3DConstants.SCHEMA_ID_3_1);
        systemSchemaIDs.add(X3DConstants.SCHEMA_ID_3_1.replaceAll("http:", "https:"));
        systemSchemaIDs.add(X3DConstants.SCHEMA_ID_3_2);
        systemSchemaIDs.add(X3DConstants.SCHEMA_ID_3_2.replaceAll("http:", "https:"));
        systemSchemaIDs.add(X3DConstants.SCHEMA_ID_3_3);
        ...
        fieldAccessMap.put("outputOnly", FieldConstants.EVENTOUT);
        fieldAccessMap.put("inputOutput", FieldConstants.EXPOSEDFIELD);
        fieldAccessMap.put("initializeOnly", FieldConstants.FIELD);

        elementMap = new HashMap<>();
        elementMap.put("X3D", X3D_TAG);
        elementMap.put("head", HEAD_TAG);
        elementMap.put("component", COMPONENT_TAG);
        elementMap.put("Scene", SCENE_TAG);
        elementMap.put("ProtoDeclare", PROTO_DECL_TAG);
        elementMap.put("ProtoInterface", PROTO_INTERFACE_TAG);
        elementMap.put("ProtoBody", PROTO_BODY_TAG);
        elementMap.put("ExternProtoDeclare", EXTERNPROTO_DECL_TAG);
        elementMap.put("IS", IS_TAG);
        elementMap.put("field", FIELD_TAG);
        elementMap.put("meta", META_TAG);
        elementMap.put("ProtoInstance", PROTO_INSTANCE_TAG);
        elementMap.put("IMPORT", IMPORT_TAG);
        elementMap.put("EXPORT", EXPORT_TAG);
        elementMap.put("ROUTE", ROUTE_TAG);
        elementMap.put("fieldValue", FIELD_VALUE_TAG);
        elementMap.put("Script", SCRIPT_TAG);
        elementMap.put("connect", CONNECT_TAG);

        attributeMap = new HashMap<>();
//        attributeMap.put(NAME_ATTR, NAME_ATTR_ID);
        attributeMap.put(DEF_ATTR, DEF_ATTR_ID);
        attributeMap.put(USE_ATTR, USE_ATTR_ID);
        attributeMap.put(CLASS_ATTR, CLASS_ATTR_ID);
        attributeMap.put(CONTAINER_ATTR, CONTAINER_ATTR_ID);
    }
     ...
     * the lexicalHandler.  Seems XSLT transformation is keeping the lex
     * handler to itself.
     *
...
//System.out.println("SE: " + localName + " qName: " + qName + " this: " + this);
/*
...
*/
        ...
        if(el_type == null) {
            ...
            // DEF/USE processing of nodes: 1st check if there is a USE. If not,
            // then check for a DEF, then handle either accordingly
            ...
            for(int i = 0; !useIsCurrent && i < num_attr; i++) {
                ...
                if(contentHandler instanceof StringContentHandler) {
                    ...
                    id_int = attributeMap.get(name);
                    if (id_int == null && contentHandler != null) {
                        field_value = attribs.getValue(i);
            ...
            case X3D_TAG:
                ...
                if(contentHandler != null) {
                    contentHandler.startDocument(fullURL,
                                                 ...
                                                 XML_ENCODING,
                                                 "#X3D",
                                                 versionString.substring(1), // <- correct string (tdn) 10/04/24
                                                 null);
                }

                value = attribs.getValue(PROFILE_ATTR);
                ...
                String attrib, space, ns_uri, ns_val;
                for(int i = 0; i < num_attribs; i++) {
                    attrib = attribs.getQName(i);
                    if(attrib.startsWith("xmlns:")) {
                        space = attrib.substring(6);
                        // Ignore the Schema definition
                        if(!space.equals("xsd")) {
                            namespacePrefixes.add(space);

                            ns_uri = attribs.getValue(i);
        ...
        switch(el_type) {
            ...
            case EXTERNPROTO_DECL_TAG:
                if(protoHandler != null) {
                    ...
                    // This needs to be parsed.  Do we already have a MFString
...
//                        contentHandler.endField();
    ...
    protected int processFieldAccess(String type, String fieldName)
        ...
        Integer field_int = fieldAccessMap.get(type);
        ...
        AccessController.doPrivileged((PrivilegedAction<Object>) () -> {
            try {
                ...
                if(is != null)
                    ...
                    errorReporter.warningReport(NO_CONTAINER_PROPS_MSG, null);

            } catch(IOException ioe) {
                errorReporter.errorReport(CONTAINER_PROPS_READ_ERR, ioe);
            }
            return null;
        });
    }
