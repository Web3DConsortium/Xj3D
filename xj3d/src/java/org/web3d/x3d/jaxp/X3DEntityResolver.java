...
public class X3DEntityResolver implements EntityResolver {
    ...
    private static final Map<String, String> allowedPublicIDs;
    ...
    static {
        ...
        allowedPublicIDs.put(X3DConstants.GENERAL_PUBLIC_ID_3_3,
                             "xml/DTD/x3d-3.3.dtd");
        allowedPublicIDs.put(X3DConstants.INTERCHANGE_PUBLIC_ID_3_3,
                             "xml/DTD/x3d-3.3.dtd");
        allowedPublicIDs.put(X3DConstants.INTERACTIVE_PUBLIC_ID_3_3,
                             "xml/DTD/x3d-3.3.dtd");
        allowedPublicIDs.put(X3DConstants.IMMERSIVE_PUBLIC_ID_3_3,
                             "xml/DTD/x3d-3.3.dtd");
        allowedPublicIDs.put(X3DConstants.FULL_PUBLIC_ID_3_3,
                             "xml/DTD/x3d-3.3.dtd");

        allowedPublicIDs.put(X3DConstants.GENERAL_PUBLIC_ID_4_0,
                             "xml/DTD/x3d-4.0.dtd");
        allowedPublicIDs.put(X3DConstants.INTERCHANGE_PUBLIC_ID_4_0,
                             "xml/DTD/x3d-4.0.dtd");
        allowedPublicIDs.put(X3DConstants.INTERACTIVE_PUBLIC_ID_4_0,
                             "xml/DTD/x3d-4.0.dtd");
        allowedPublicIDs.put(X3DConstants.IMMERSIVE_PUBLIC_ID_4_0,
                             "xml/DTD/x3d-4.0.dtd");
        allowedPublicIDs.put(X3DConstants.FULL_PUBLIC_ID_4_0,
                             "xml/DTD/x3d-4.0.dtd");

        allowedPublicIDs.put(X3DConstants.GENERAL_PUBLIC_ID_4_1,
                             "xml/DTD/x3d-4.1.dtd");
        allowedPublicIDs.put(X3DConstants.INTERCHANGE_PUBLIC_ID_4_1,
                             "xml/DTD/x3d-4.1.dtd");
        allowedPublicIDs.put(X3DConstants.INTERACTIVE_PUBLIC_ID_4_1,
                             "xml/DTD/x3d-4.1.dtd");
    ...
    public InputStream resolveDTDFromPublic(String id) throws IOException {
        String filename = allowedPublicIDs.get(id);
        if(filename == null)
            return null;
