...
public interface MFString extends MField {
     ...
     * Individual elements in the string array may be null depending on the
     * implementation of the browser and whether it maintains null references.
     *
     ...
     *
     * @exception ArrayIndexOutOfBoundsException The index value was out of
     * bounds of the current array.
     */
     ...
     * reference this will not cause an exception to be generated. However, the
     * resulting event that the eventIn receives will be implementation specific
     * as this is not dealt with in the VRML specification.
     *
     * @param numStrings The number of items to be copied from this array
     * @param value The array of strings.
     */
    void setValue(int numStrings, String[] value);
     ...
     * bounds of the current array.
     */
    void set1Value(int index, String value);
}
