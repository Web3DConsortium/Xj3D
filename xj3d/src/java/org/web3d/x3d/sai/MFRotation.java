...
public interface MFRotation extends MField {
     ...
     * length accordingly.
     *
     * @param value The value to append value[0] = X component [0-1]  <br>
     ...
     *
     * @param vec The array to be filled in where the value[i + 0] = X component
     * [0-1]  <br>
     * value[i + 1] = Y component [0-1]  <br>
     * value[i + 2] = Z component [0-1]  <br>
     * value[i + 3] = Angle of rotation [-PI - PI] (nominally).
     ...
     * @param vec The array to place the value in where. vec[0] = X component
     * [0-1]  <br>
     ...
     * @param value The new element to insert value[0] = X component [0-1]  <br>
     * value[1] = Y component [0-1]  <br>
     * value[2] = Z component [0-1]  <br>
     * value[3] = Angle of rotation [-PI - PI] (nominally).
     *
     ...
     * generated. If value[i] contains more than four items only the first four
     * values will be used and the rest ignored.
     *
     ...
     * least four values for the rotation
     */
    ...
    /**
     * Set a particular rotation in the given eventIn array. To the VRML world
     * this will generate a full MFRotation event with the nominated index value
     * changed.
