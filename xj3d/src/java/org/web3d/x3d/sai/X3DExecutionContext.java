...
public interface X3DExecutionContext {
    ...
    int SCRIPTED_ENCODING = 1;

    /** VRML 1.0 ASCII encoding */
    int ASCII_ENCODING = 2;
     ...
     * @return an X3DRoute between two points
     ...
     * @return an X3DProtoDeclaration
     */
    X3DProtoDeclaration getProtoDeclaration(String name);
     ...
     */
    void updateProtoDeclaration(String name, X3DProtoDeclaration proto);
     ...
     * @param name The name of the proto to fetch
     */
    void removeProtoDeclaration(String name);
     ...
     * @return and X3DExternProtoDeclaration
     */
    X3DExternProtoDeclaration getExternProtoDeclaration(String name);
     ...
     */
    void updateExternProtoDeclaration(String name,
     ...
     * @param name The name of the externproto to fetch
     */
    void removeExternProtoDeclaration(String name);
     ...
     */
    X3DNode getNamedNode(String name);
     ...
     * @return A node wrapper representing the node
     */
    X3DNode getImportedNode(String name);
     ...
     */
    void removeImportedNode(String importName);
     ...
     */
    void updateImportedNode(String exportedName, String importedName, X3DNode inline);
     ...
     */
    void updateNamedNode(String nodeName, X3DNode node);
     ...
     */
    X3DNode createNode(String name);
     ...
     */
    X3DProtoInstance createProto(String name);
}
