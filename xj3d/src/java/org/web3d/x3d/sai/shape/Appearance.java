...
public interface Appearance extends X3DAppearanceNode {
     ...
     */
    void setMaterial(X3DMaterialNode val);
     ...
     */
    void setMaterial(X3DProtoInstance val);
     ...
     */
    void setTexture(X3DTextureNode val);
     ...
     * @param val The X3DProtoInstance to set.
     */
    void setTexture(X3DProtoInstance val);
     ...
     */
    void setTextureTransform(X3DTextureTransformNode val);
     ...
     * @param val The X3DProtoInstance to set.
     */
    void setTextureTransform(X3DProtoInstance val);
     ...
     */
    void setLineProperties(X3DNode val);
     ...
     * @param val The X3DNode to set.
     */
    void setFillProperties(X3DNode val);
