...
public interface MFTime extends MField {
     ...
     *
     * @exception ArrayIndexOutOfBoundsException The index was outside of the
    ...
    /**
     * Set the value of the array of times based on Java time values. Time
     * values are not required to conform to any range checks.
     *
     * @param size The number of items to be copied from the array
     * @param value The array of time values
     */
    void setValue(int size, long[] value);

    /**
     * Set a particular time value in the given eventIn array. To the VRML world
     * this will generate a full MFTime event with the nominated index value
     * changed.
