...
public interface MFImage extends MField {
     ...
     *
     * This method modifies the integer array rather than the conceptual image
     * array.
     *
     ...
     * reduced by one. This method modifies the integer array rather than the
     ...
     * first three values of the array will be width, height, depth and then the
     * appropriate number of pixels, more width height depth etc.
     *
     ...
     * by the caller is not enough for the width * height.
     */
    void setValue(int numValues, int[] value);
