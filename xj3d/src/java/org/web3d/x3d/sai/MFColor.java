...
public interface MFColor extends MField {
     ...
     * to be in the range 0-1. Colour values outside of this range will generate
     * an IllegalArgumentException. If the array does not contain at least
     * numColors * 3 values it will generate an ArrayIndexOutOfBoundsException.
     *
     ...
     * in RGB order. All colour values are required to be in the range 0-1.
