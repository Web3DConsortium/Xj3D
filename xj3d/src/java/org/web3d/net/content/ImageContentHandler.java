...
public abstract class ImageContentHandler extends ContentHandler {
    ...
    /** The -preferred- image content Class */
    ...
    private static final Map<String, Integer> rescaleMap;
    ...
    static {
        ...
        rescaleMap.put("BILINEAR", AffineTransformOp.TYPE_BILINEAR);
        rescaleMap.put("NEAREST_NEIGBOR", AffineTransformOp.TYPE_NEAREST_NEIGHBOR);
        ...
        // Unnecessary calls as this is done in the BrowserJPanel.setupProperties
        /////////////////////////////////////////////////////////////////////////
//        try {
...
//        }
    ...
    protected static NIOBufferImage convert( Class<?> image_class, Object content ) {
        ...
        try {
            ...
            image = new NIOBufferImage(
                widthI, heightI,
                NIOBufferImageType.getType(typeI),
                buffer );
        }
        catch ( NoSuchMethodException | SecurityException | IllegalAccessException | InvocationTargetException ite ) {
    ...
    /**
     * Check for the existence of our preferred image class. If found,
     * return it's Class object. Otherwise, return null.
     *
     * @return The preferred Class object, or null if it does not exist.
     */
