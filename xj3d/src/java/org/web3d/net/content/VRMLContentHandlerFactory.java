...
public class VRMLContentHandlerFactory implements ContentHandlerFactory {
    ...
    private static final HashSet<String> UTF8_TYPES;

    /** The set of accepted types for XML content */
    private static final HashSet<String> XML_TYPES;

    /** The set of accepted mime types for binary content */
    private static final HashSet<String> BINARY_TYPES;

    private static final HashSet<String> ECMASCRIPT_TYPES;

    /** The set of accepted types for audio content */
    private static final HashSet<String> AUDIO_TYPES;

    /** The set of accepted types for movie content */
    private static final HashSet<String> MOVIE_TYPES;
