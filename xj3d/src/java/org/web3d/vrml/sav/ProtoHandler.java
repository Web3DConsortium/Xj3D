...
public interface ProtoHandler {
     ...
     *   structure of the document.
     */
    void startProtoDecl(String name) throws SAVException, VRMLException;
     ...
     *   structure of the document.
     */
    void protoIsDecl(String fieldName) throws SAVException, VRMLException;
     ...
     *   structure of the document.
     */
    void startExternProtoDecl(String name) throws SAVException, VRMLException;
     ...
     *   structure of the document.
     */
    void externProtoURI(String[] values) throws SAVException, VRMLException;
}
