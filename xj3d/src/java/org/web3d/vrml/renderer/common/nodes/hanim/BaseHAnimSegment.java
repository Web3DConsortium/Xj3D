...
public abstract class BaseHAnimSegment extends BaseGroupingNode
    ...
    public void setupFinished() {
        ...
        for(int i = 0; i < size; i++) {
            VRMLNodeType n = vfDisplacers.get(i);
            n.setupFinished();
        }
    }
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            ...
            case FIELD_MOMENTS_OF_INERTIA:
                ...
                fieldData.floatArrayValues = vfMomentsOfInertia;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                break;
     ...
     * @throws InvalidFieldValueException A value was less than zero
     */
