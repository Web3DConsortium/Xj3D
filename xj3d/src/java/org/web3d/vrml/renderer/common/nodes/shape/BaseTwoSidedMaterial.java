...
public abstract class BaseTwoSidedMaterial extends AbstractNode
    ...
    static {
        ...
        idx = FIELD_BACK_AMBIENT_INTENSITY;
    ...
    protected BaseTwoSidedMaterial(VRMLNodeType node) {
        ...
        try {
            ...
            field = node.getFieldValue(index);
            vfBackDiffuseColor[0] = field.floatArrayValues[0];
            vfBackDiffuseColor[1] = field.floatArrayValues[1];
            vfBackDiffuseColor[2] = field.floatArrayValues[2];
            ...
            field = node.getFieldValue(index);
            vfBackEmissiveColor[0] = field.floatArrayValues[0];
            vfBackEmissiveColor[1] = field.floatArrayValues[1];
            vfBackEmissiveColor[2] = field.floatArrayValues[2];
            ...
            field = node.getFieldValue(index);
            vfBackSpecularColor[0] = field.floatArrayValues[0];
            vfBackSpecularColor[1] = field.floatArrayValues[1];
            vfBackSpecularColor[2] = field.floatArrayValues[2];
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            ...
            case FIELD_BACK_DIFFUSE_COLOR:
                fieldData.clear();
                fieldData.floatArrayValues = vfBackDiffuseColor;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 1;
                break;
            ...
            case FIELD_BACK_EMISSIVE_COLOR:
                fieldData.clear();
                fieldData.floatArrayValues = vfBackEmissiveColor;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 1;
                break;
            ...
            case FIELD_BACK_SPECULAR_COLOR:
                fieldData.clear();
                fieldData.floatArrayValues = vfBackSpecularColor;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 1;
                break;
