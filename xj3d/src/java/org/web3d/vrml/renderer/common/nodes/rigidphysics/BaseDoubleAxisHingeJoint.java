...
public abstract class BaseDoubleAxisHingeJoint extends BaseJointNode {
    ...
    static {
        ...
        fieldMap.put("body1AnchorPoint", FIELD_BODY1_ANCHOR_POINT);
        fieldMap.put("body2AnchorPoint", FIELD_BODY2_ANCHOR_POINT);
        fieldMap.put("body1Axis", FIELD_BODY1_AXIS);
        fieldMap.put("body2Axis", FIELD_BODY2_AXIS);
        fieldMap.put("hinge1Angle", FIELD_HINGE1_ANGLE);
        fieldMap.put("hinge2Angle", FIELD_HINGE2_ANGLE);
        fieldMap.put("hinge1AngleRate", FIELD_HINGE1_ANGLE_RATE);
        fieldMap.put("hinge2AngleRate", FIELD_HINGE2_ANGLE_RATE);
    }
    ...
    public BaseDoubleAxisHingeJoint(VRMLNodeType node) {
        ...
        try {
            ...
            vfAnchorPoint[0] = field.floatArrayValues[0];
            vfAnchorPoint[1] = field.floatArrayValues[1];
            vfAnchorPoint[2] = field.floatArrayValues[2];

            index = node.getFieldIndex("axis1");
            field = node.getFieldValue(index);
            vfAxis1[0] = field.floatArrayValues[0];
            vfAxis1[1] = field.floatArrayValues[1];
            vfAxis1[2] = field.floatArrayValues[2];

            index = node.getFieldIndex("axis2");
            field = node.getFieldValue(index);
            vfAxis2[0] = field.floatArrayValues[0];
            vfAxis2[1] = field.floatArrayValues[1];
            vfAxis2[2] = field.floatArrayValues[2];
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            case FIELD_ANCHOR_POINT:
                fieldData.clear();
                fieldData.floatArrayValues = vfAnchorPoint;
            ...
            case FIELD_AXIS1:
                fieldData.clear();
                fieldData.floatArrayValues = vfAxis1;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 1;
                break;
            ...
            case FIELD_AXIS2:
                fieldData.clear();
                fieldData.floatArrayValues = vfAxis2;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 1;
                break;
            ...
            case FIELD_BODY1_ANCHOR_POINT:
                fieldData.clear();
                fieldData.floatArrayValues = vfBody1AnchorPoint;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 1;
                break;
            ...
            case FIELD_BODY2_ANCHOR_POINT:
                fieldData.clear();
                fieldData.floatArrayValues = vfBody2AnchorPoint;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 1;
                break;
            ...
            case FIELD_BODY1_AXIS:
                fieldData.clear();
                fieldData.floatArrayValues = vfBody1Axis;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 1;
                break;
            ...
            case FIELD_BODY2_AXIS:
                fieldData.clear();
                fieldData.floatArrayValues = vfBody2Axis;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 1;
                break;
