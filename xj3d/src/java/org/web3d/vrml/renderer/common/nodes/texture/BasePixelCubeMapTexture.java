...
public abstract class BasePixelCubeMapTexture extends BaseTextureNode
    ...
    public BasePixelCubeMapTexture(VRMLNodeType node) {
        ...
        try {
            ...
            int size = field.intArrayValues[1] * field.intArrayValues[2];
            vfFront = new int[size];
            System.arraycopy(field.intArrayValues, 0, vfFront, 0, size);
            vfFrontLen = size;

            index = node.getFieldIndex("back");
            field = node.getFieldValue(index);
            size = field.intArrayValues[1] * field.intArrayValues[2];
            vfBack = new int[size];
            System.arraycopy(field.intArrayValues, 0, vfBack, 0, size);
            vfBackLen = size;
            ...
            size = field.intArrayValues[1] * field.intArrayValues[2];
            vfLeft = new int[size];
            System.arraycopy(field.intArrayValues, 0, vfLeft, 0, size);
            vfLeftLen = size;
            ...
            System.arraycopy(field.intArrayValues, 0, vfRight, 0, size);
            vfRightLen = size;
            ...
            size = field.intArrayValues[1] * field.intArrayValues[2];
            vfTop = new int[size];
            System.arraycopy(field.intArrayValues, 0, vfTop, 0, size);
            vfTopLen = size;
            ...
            System.arraycopy(field.intArrayValues, 0, vfBottom, 0, size);
            vfBottomLen = size;
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            case FIELD_FRONT:
                fieldData.clear();
                fieldData.intArrayValues = vfFront;
            ...
            case FIELD_BACK:
                fieldData.clear();
                fieldData.intArrayValues = vfBack;
                fieldData.dataType = VRMLFieldData.INT_ARRAY_DATA;
            ...
            case FIELD_LEFT:
                fieldData.clear();
                fieldData.intArrayValues = vfLeft;
                fieldData.dataType = VRMLFieldData.INT_ARRAY_DATA;
            ...
            case FIELD_RIGHT:
                fieldData.clear();
                fieldData.intArrayValues = vfRight;
                fieldData.dataType = VRMLFieldData.INT_ARRAY_DATA;
            ...
            case FIELD_TOP:
                fieldData.clear();
                fieldData.intArrayValues = vfTop;
                fieldData.dataType = VRMLFieldData.INT_ARRAY_DATA;
            ...
            case FIELD_BOTTOM:
                fieldData.clear();
                fieldData.intArrayValues = vfBottom;
                fieldData.dataType = VRMLFieldData.INT_ARRAY_DATA;
