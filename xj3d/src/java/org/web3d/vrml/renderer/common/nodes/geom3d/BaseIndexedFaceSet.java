...
public abstract class BaseIndexedFaceSet extends BaseIndexedGeometryNode {
    ...
    static {
        ...
        fieldMap.put("normalIndex", FIELD_NORMALINDEX);
        fieldMap.put("set_normalIndex", FIELD_SET_NORMALINDEX);

        fieldMap.put("coordIndex", FIELD_COORDINDEX);
        fieldMap.put("set_coordIndex", FIELD_SET_COORDINDEX);

        fieldMap.put("colorIndex", FIELD_COLORINDEX);
        fieldMap.put("set_colorIndex", FIELD_SET_COLORINDEX);

        fieldMap.put("texCoordIndex", FIELD_TEXCOORDINDEX);
        fieldMap.put("set_texCoordIndex", FIELD_SET_TEXCOORDINDEX);
    }
