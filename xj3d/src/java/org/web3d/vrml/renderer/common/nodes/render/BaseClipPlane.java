...
public class BaseClipPlane extends AbstractNode implements VRMLChildNodeType {
    ...
    public BaseClipPlane(VRMLNodeType node) {
        ...
        try {
            ...
            vfPlane[0] = field.doubleArrayValues[0];
            vfPlane[1] = field.doubleArrayValues[1];
            vfPlane[2] = field.doubleArrayValues[2];
            vfPlane[3] = field.doubleArrayValues[3];
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            case FIELD_PLANE:
                fieldData.clear();
                fieldData.doubleArrayValues = vfPlane;
