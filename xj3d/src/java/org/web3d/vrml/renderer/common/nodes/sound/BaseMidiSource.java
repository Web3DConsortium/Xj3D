...
public class BaseMidiSource extends AbstractNode
    ...
    public BaseMidiSource(VRMLNodeType node) {
        ...
        try {
            ...
            if(field.numElements != 0) {
                ...
                System.arraycopy(field.stringArrayValues, 0, vfSelected, 0,
                    field.numElements);
            }
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            case FIELD_SELECTED:
                fieldData.clear();
                fieldData.stringArrayValues = vfSelected;
            ...
            case FIELD_AVAILABLE:
                fieldData.clear();
                fieldData.stringArrayValues = vfAvailable;
                fieldData.dataType = VRMLFieldData.STRING_ARRAY_DATA;
            ...
            case FIELD_EVENT_CHANNEL:
                fieldData.clear();
                fieldData.intArrayValues = vfEventChannel;
            ...
            case FIELD_EVENT_COMMAND:
                fieldData.clear();
                fieldData.intArrayValues = vfEventCommand;
                fieldData.dataType = VRMLFieldData.INT_ARRAY_DATA;
            ...
            case FIELD_EVENT_DATA1:
                fieldData.clear();
                fieldData.intArrayValues = vfEventData1;
                fieldData.dataType = VRMLFieldData.INT_ARRAY_DATA;
            ...
            case FIELD_EVENT_DATA2:
                fieldData.clear();
                fieldData.intArrayValues = vfEventData2;
                fieldData.dataType = VRMLFieldData.INT_ARRAY_DATA;
...
//                    System.out.println("Control change2: " + smsg.getData1() + " val: " + smsg.getData2());
    ...
    private void initMidiDevice() {
        ...
        if (info == null) {
            ...
            for (String vfSelected1 : vfSelected) {
                System.out.println("   " + vfSelected1);
            }
