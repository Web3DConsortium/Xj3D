...
public abstract class BaseImage2D extends BaseSurfaceChildNode
    ...
    static {
        ...
        fieldMap.put("windowRelative", FIELD_WINDOW_RELATIVE);
        fieldMap.put("isActive", FIELD_ISACTIVE);
        fieldMap.put("isOver", FIELD_ISOVER);
        fieldMap.put("touchTime", FIELD_TOUCHTIME);
   ...
   public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            ...
            case FIELD_TRACKPOINT_CHANGED:
                fieldData.clear();
                fieldData.floatArrayValues = vfTrackPoint;
