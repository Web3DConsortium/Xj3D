...
public class BaseAnchor extends BaseGroupingNode implements VRMLLinkNodeType {
    ...
    protected static final int FIELD_AUTOREFRESH = LAST_GROUP_INDEX + 4;

    /** Index of the autoRefreshTimeLimit field */
    protected static final int FIELD_AUTOREFRESHTIMELIMIT = LAST_GROUP_INDEX + 5;

    /** Index of the load field */
    protected static final int FIELD_LOAD = LAST_GROUP_INDEX + 6;

    /** Index of the visible field, note
        overloading superclass BaseGroupingNode FIELD_VISIBLE */
    @SuppressWarnings("FieldNameHidesFieldInSuperclass")
    protected static final int FIELD_VISIBLE = LAST_GROUP_INDEX + 7; 
    // 

    /** The last index used by this field */
    protected static final int LAST_ANCHOR_INDEX = FIELD_VISIBLE;
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            ...
            case FIELD_PARAMETER:
                fieldData.clear();
                fieldData.stringArrayValues = vfParameter;
