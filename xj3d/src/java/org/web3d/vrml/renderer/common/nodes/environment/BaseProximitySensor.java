...
public abstract class BaseProximitySensor extends BaseSensorNode
    ...
    static {
        ...
        fieldMap.put("centerOfRotation_changed", FIELD_CENTEROFROTATION_CHANGED);
        fieldMap.put("position_changed", FIELD_POSITION_CHANGED);
        fieldMap.put("orientation_changed", FIELD_ORIENTATION_CHANGED);
        fieldMap.put("enterTime", FIELD_ENTER_TIME);
        fieldMap.put("exitTime", FIELD_EXIT_TIME);
    }
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            ...
            case FIELD_POSITION_CHANGED:
                fieldData.clear();
                fieldData.floatArrayValues = vfPositionChanged;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 1;
                break;
            ...
            case FIELD_ORIENTATION_CHANGED:
                fieldData.clear();
                fieldData.floatArrayValues = vfOrientationChanged;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 1;
                break;
            ...
            case FIELD_CENTEROFROTATION_CHANGED:
                fieldData.clear();
                fieldData.floatArrayValues = vfCenterOfRotationChanged;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 1;
                break;
