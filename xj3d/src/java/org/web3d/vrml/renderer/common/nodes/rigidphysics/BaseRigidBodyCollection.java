...
public class BaseRigidBodyCollection extends AbstractNode
    ...
    protected List<BaseContact> vfSetContacts;
    ...
    static {
        ...
        fieldMap.put("set_contacts", FIELD_SET_CONTACTS);
        fieldMap.put("collider", FIELD_COLLIDER);
    ...
    public BaseRigidBodyCollection(VRMLNodeType node) {
        ...
        try {
            ...
            field = node.getFieldValue(index);
            vfGravity[0] = field.floatArrayValues[0];
            vfGravity[1] = field.floatArrayValues[1];
            vfGravity[2] = field.floatArrayValues[2];
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            ...
            case FIELD_BODIES:
                fieldData.clear();
                fieldData.nodeArrayValues = vfBodies;
            ...
            case FIELD_GRAVITY:
                fieldData.clear();
                fieldData.floatArrayValues = vfGravity;
            ...
            case FIELD_JOINTS:
                fieldData.clear();
                fieldData.nodeArrayValues = vfJoints;
                fieldData.dataType = VRMLFieldData.NODE_ARRAY_DATA;
    ...
    private void setContacts(VRMLNodeType[] children, int numValid) {
        vfSetContacts.clear();
        ((ArrayList)vfSetContacts).ensureCapacity(numValid);
