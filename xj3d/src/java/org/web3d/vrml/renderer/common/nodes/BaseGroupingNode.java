...
public abstract class BaseGroupingNode extends AbstractNode
    ...
    protected static final int FIELD_BBOX_DISPLAY = LAST_NODE_INDEX + 6;
    
    /** Index of the Bounding box display visible field */
    protected static final int FIELD_VISIBLE = LAST_NODE_INDEX + 7;

    /** The last field index used by this class */
    protected static final int LAST_GROUP_INDEX = FIELD_VISIBLE;
     ...
     * Add nodes to NR that have no scene graph object (such as
