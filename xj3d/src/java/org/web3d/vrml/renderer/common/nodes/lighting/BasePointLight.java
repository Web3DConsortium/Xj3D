    ...
    protected BasePointLight(VRMLNodeType node) {
        ...
        try {
            ...
            if (field.numElements != 0) {
                vfLocation[0] = field.floatArrayValues[0];
                vfLocation[1] = field.floatArrayValues[1];
                vfLocation[2] = field.floatArrayValues[2];
            }
            ...
            field = node.getFieldValue(index);
            if (field.numElements != 0) {
                vfAttenuation[0] = field.floatArrayValues[0];
                vfAttenuation[1] = field.floatArrayValues[1];
                vfAttenuation[2] = field.floatArrayValues[2];
            }
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            case FIELD_ATTENUATION:
                fieldData.clear();
                fieldData.floatArrayValues = vfAttenuation;
