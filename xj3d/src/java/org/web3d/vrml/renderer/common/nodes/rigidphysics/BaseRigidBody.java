...
public abstract class BaseRigidBody extends AbstractNode
    ...
    static {
        ...
        idx = FIELD_FINITE_ROTATION_AXIS;
        ...
        idx = FIELD_LINEAR_DAMPING_FACTOR;
    ...
    public BaseRigidBody(VRMLNodeType node) {
        ...
        try {
            ...
            vfAngularVelocity[0] = field.floatArrayValues[0];
            vfAngularVelocity[1] = field.floatArrayValues[1];
            vfAngularVelocity[2] = field.floatArrayValues[2];
            ...
            field = node.getFieldValue(index);
            vfCenterOfMass[0] = field.floatArrayValues[0];
            vfCenterOfMass[1] = field.floatArrayValues[1];
            vfCenterOfMass[2] = field.floatArrayValues[2];
            ...
            field = node.getFieldValue(index);
            vfFiniteRotationAxis[0] = field.floatArrayValues[0];
            vfFiniteRotationAxis[1] = field.floatArrayValues[1];
            vfFiniteRotationAxis[2] = field.floatArrayValues[2];
            ...
            if(vfMassDensityModel != null) {
                ...
                switch (name) {
                    ...
                    case "Box":
                        ...
                        float[] size = field.floatArrayValues;
                    ...
                    case "Sphere":
                        ...
                        break;
                    default:
                        System.err.println("RigidBody unhandled mass density model type object: " + name);
                }
            }
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            case FIELD_ANGULAR_VELOCITY:
                fieldData.clear();
                fieldData.floatArrayValues = vfAngularVelocity;
            ...
            case FIELD_CENTER_OF_MASS:
                fieldData.clear();
                fieldData.floatArrayValues = vfCenterOfMass;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 1;
                break;
            ...
            case FIELD_FINITE_ROTATION_AXIS:
                fieldData.clear();
                fieldData.floatArrayValues = vfFiniteRotationAxis;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 1;
                break;
            ...
            case FIELD_FORCES:
                fieldData.clear();
                fieldData.floatArrayValues = vfForces;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
            ...
            case FIELD_GEOMETRY:
                fieldData.clear();
                fieldData.nodeArrayValues = vfGeometry;
            ...
            case FIELD_INERTIA:
                fieldData.clear();
                fieldData.floatArrayValues = vfInertia;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 1;
                break;
            ...
            case FIELD_TORQUES:
                fieldData.clear();
                fieldData.floatArrayValues = vfTorques;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
