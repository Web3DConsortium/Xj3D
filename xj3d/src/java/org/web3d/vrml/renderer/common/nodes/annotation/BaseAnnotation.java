...
public abstract class BaseAnnotation extends AbstractNode
    ...
    private float[] vfReferencePoint;
    ...
    static {
        ...
        fieldDecl[FIELD_ENABLED] =
            new VRMLFieldDeclaration(FieldConstants.EXPOSEDFIELD,
                                     "SFBool",
                                     "enabled");
        fieldDecl[BaseAnnotationTarget.FIELD_REFERENCE_POINT] =
            new VRMLFieldDeclaration(FieldConstants.EXPOSEDFIELD,
                                     "SFVec3f",
                                     "referencePoint");
     ...
     * @param name name of this new BaseAnnotation
     */
    protected BaseAnnotation(String name) {
        super(name);
    ...
    public BaseAnnotation(VRMLNodeType node) {
        ...
        try {
            ...
            vfReferencePoint[0] = field.floatArrayValues[0];
            vfReferencePoint[1] = field.floatArrayValues[1];
            vfReferencePoint[2] = field.floatArrayValues[2];
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            ...
            case FIELD_ANNOTATION_GROUP_ID:
                fieldData.stringValue = vfAnnotationGroupID;
                fieldData.dataType = VRMLFieldData.STRING_DATA;
                break;
    ...
    public void setValue(int index, float[] value, int numValid)
        ...
        switch(index) {
            case BaseAnnotationTarget.FIELD_REFERENCE_POINT:
