...
public abstract class BaseParticleSystem extends AbstractNode
    ...
    protected static final int FIELD_BBOX_DISPLAY = LAST_NODE_INDEX + 5;
    
    /** Index of the Bounding box display visible field */
    protected static final int FIELD_VISIBLE = LAST_NODE_INDEX + 6;

    /** Index for the geometryType field */
    protected static final int FIELD_GEOMETRY_TYPE = LAST_NODE_INDEX + 7;

    /** Index for the enabled field */
    protected static final int FIELD_ENABLED = LAST_NODE_INDEX + 8;

    /** Index for the maxParticles field */
    protected static final int FIELD_MAX_PARTICLES = LAST_NODE_INDEX + 9;

    /** Index for the particleLifetime field */
    protected static final int FIELD_PARTICLE_LIFETIME = LAST_NODE_INDEX + 10;

    /** Index for the lifetimeVariation field */
    protected static final int FIELD_LIFETIME_VARIATION = LAST_NODE_INDEX + 11;

    /** Index for the emitter field */
    protected static final int FIELD_EMITTER = LAST_NODE_INDEX + 12;

    /** Index for the physics field */
    protected static final int FIELD_PHYSICS = LAST_NODE_INDEX + 13;

    /** Index for the colorRamp field */
    protected static final int FIELD_COLOR_RAMP = LAST_NODE_INDEX + 14;

    /** Index for the colorKey field */
    protected static final int FIELD_COLOR_KEY = LAST_NODE_INDEX + 15;

    /** Index for the colorKey field */
    protected static final int FIELD_IS_ACTIVE = LAST_NODE_INDEX + 16;

    /** Index for the particleSize field */
    protected static final int FIELD_PARTICLE_SIZE = LAST_NODE_INDEX + 17;

    /** Index for the createParticles field */
    protected static final int FIELD_CREATE_PARTICLES = LAST_NODE_INDEX + 18;

    /** Index for the texCoordRamp field */
    protected static final int FIELD_TEXCOORD_RAMP = LAST_NODE_INDEX + 19;

    /** Index for the texCoordKey field */
    protected static final int FIELD_TEXCOORD_KEY = LAST_NODE_INDEX + 20;
    ...
    static {
        ...
        fieldMap.put("emitter", FIELD_EMITTER);
        fieldMap.put("physics", FIELD_PHYSICS);
        ...
        fieldMap.put("geometryType", FIELD_GEOMETRY_TYPE);
        fieldMap.put("isActive", FIELD_IS_ACTIVE);
        fieldMap.put("colorRamp", FIELD_COLOR_RAMP);
        fieldMap.put("colorKey", FIELD_COLOR_KEY);
        fieldMap.put("texCoordRamp", FIELD_TEXCOORD_RAMP);
        fieldMap.put("texCoordKey", FIELD_TEXCOORD_KEY);


        geomTypeMap = new HashMap<>();
        geomTypeMap.put("QUAD", TYPE_QUADS);
        geomTypeMap.put("TRIANGLE", TYPE_TRIS);
        geomTypeMap.put("LINE", TYPE_LINES);
        geomTypeMap.put("POINT", TYPE_POINTS);
        geomTypeMap.put("SPRITE", TYPE_SPRITES);
        geomTypeMap.put("GEOMETRY", TYPE_CUSTOM);
    }
    ...
    protected BaseParticleSystem(VRMLNodeType node) {
        ...
        try {
            ...
            field = node.getFieldValue(index);
            vfParticleSize[0] = field.floatArrayValues[0];
            vfParticleSize[1] = field.floatArrayValues[1];
   ...
   //----------------------------------------------------------
    ...
    public void setupFinished() {
        ...
        if(vfEmitter != null) {
            ...
            emitter.setParticleLifetime((int)(vfParticleLifetime * 1_000));
            vfIsActive = true;
        }
        ...
        if((vfTexCoordRamp != null) && (numTexCoordKey != 0)) {
            ...
            for(int i = 0; i < num_elements; i++)
                time_keys[i] = vfTexCoordKey[i] * 1_000;
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            ...
            case FIELD_PHYSICS:
                fieldData.clear();
                fieldData.nodeArrayValues = vfPhysics;
            ...
            case FIELD_COLOR_KEY:
                fieldData.clear();
                fieldData.floatArrayValues = vfColorKey;
            ...
            case FIELD_PARTICLE_SIZE:
                fieldData.clear();
                fieldData.floatArrayValues = vfParticleSize;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 1;
                break;
