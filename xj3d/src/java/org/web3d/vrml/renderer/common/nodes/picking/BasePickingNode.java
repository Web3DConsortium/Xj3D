...
public abstract class BasePickingNode extends BaseSensorNode
    ...
    static {
        ...
        sortTypeMap.put("CLOSEST", SORT_CLOSEST);
        sortTypeMap.put("ALL", SORT_ALL);
        sortTypeMap.put("ALL_SORTED", SORT_ALL_SORTED);
        sortTypeMap.put("ANY", SORT_ANY);

        intersectTypeMap = new HashMap<>();
        intersectTypeMap.put("BOUNDS", INTERSECT_BOUNDS);
        intersectTypeMap.put("GEOMETRY", INTERSECT_GEOMETRY);
    }
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            ...
            case FIELD_PICK_TARGET:
                fieldData.clear();
                fieldData.nodeArrayValues = vfPickTarget;
            ...
            case FIELD_PICKED_GEOMETRY:
                fieldData.clear();
                fieldData.nodeArrayValues = vfPickedGeometry;
                fieldData.dataType = VRMLFieldData.NODE_ARRAY_DATA;
            ...
            case FIELD_OBJECT_TYPE:
                ...
                fieldData.stringArrayValues = vfObjectType;
    ...
    /**
     * Common initialization routine for startup.
     */
    private void init() {
