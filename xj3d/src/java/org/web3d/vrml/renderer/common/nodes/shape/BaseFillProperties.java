...
public abstract class BaseFillProperties extends AbstractNode
    ...
    protected BaseFillProperties(VRMLNodeType node) {
        ...
        try {
            ...
            field = node.getFieldValue(index);
            vfHatchColor[0] = field.floatArrayValues[0];
            vfHatchColor[1] = field.floatArrayValues[1];
            vfHatchColor[2] = field.floatArrayValues[2];
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            ...
            case FIELD_HATCHCOLOR:
                fieldData.clear();
                fieldData.floatArrayValues = vfHatchColor;
