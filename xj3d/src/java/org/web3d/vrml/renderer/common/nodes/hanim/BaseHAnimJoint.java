 ...
 */
// method not found for javadoc reference above: {@link #updateMatrix()}
...
public abstract class BaseHAnimJoint extends BaseGroupingNode
    ...
    public BaseHAnimJoint(VRMLNodeType node) {
        ...
        try {
            ...
            vfLimitOrientation[0] = field.floatArrayValues[0];
            vfLimitOrientation[1] = field.floatArrayValues[1];
            vfLimitOrientation[2] = field.floatArrayValues[2];
            vfLimitOrientation[3] = field.floatArrayValues[3];
