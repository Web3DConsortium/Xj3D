...
public abstract class BaseMultiTextureCoordinate extends BaseGeometricPropertyNode
  implements VRMLTextureCoordinateNodeType {
    ...
    public void setupFinished() {
        ...
        for (VRMLNodeType vfTextureCoordinate1 : vfTextureCoordinate) {
            vfTextureCoordinate1.setupFinished();
        }
    }
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            case FIELD_TEXCOORD:
                fieldData.clear();
                fieldData.nodeArrayValues = vfTextureCoordinate;
