...
public class BaseCADFace extends AbstractNode
    ...
    protected static final int LAST_CADFACE_INDEX = FIELD_VISIBLE;
     ...
     * at setup.
     *
     * @param val The box display to set
     */
    protected void setBboxDisplay(boolean val) {
        if(!inSetup)
            throw new InvalidFieldAccessException("Cannot set bboxDisplay");

        vfBboxDisplay = val;
    }
    
    /**
     * Set the visible field for this node. Only used by the field parser
     * at setup.
     *
     * @param val The box display to set
     */
    protected void setVisible(boolean val) {
        if(!inSetup)
            throw new InvalidFieldAccessException("Cannot set visible");
