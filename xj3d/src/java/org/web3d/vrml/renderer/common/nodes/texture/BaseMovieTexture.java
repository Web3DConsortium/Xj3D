...
public class BaseMovieTexture extends BaseTimeControlledNode
    ...
    protected static final int FIELD_DESCRIPTION = LAST_TIME_INDEX + 8;

    /** The last field index used by this class */
    private static final int LAST_MOVIETEXTURE_INDEX = FIELD_DESCRIPTION;

    /** Number of fields implemented */
    private static final int NUM_FIELDS = LAST_MOVIETEXTURE_INDEX + 1;
    ...
    static {
        ...
        fieldMap.put("duration_changed", FIELD_DURATION);
        fieldMap.put("elapsedTime", FIELD_ELAPSED_TIME);
    ...
    public BaseMovieTexture() {
        ...
        hasChanged = new boolean[LAST_MOVIETEXTURE_INDEX + 1];
    ...
    public void copy(VRMLNodeType node) {
        ...
        try {
            ...
            field = node.getFieldValue(index);
            setUrl(field.stringArrayValues, field.numElements);
...
*/
     ...
     *
     * @param newDescription for this node.
     */
    ...
    public VRMLFieldDeclaration getFieldDeclaration(int index) {
        if(index < 0  || index > LAST_MOVIETEXTURE_INDEX)
            return null;
    ...
    public void setValue(int index, float value)
        ...
        switch(index) {
            case FIELD_SPEED :
                if(value < 0)
                {
                     errorReporter.messageReport("Negative MovieTexture speed='" + value + "' not yet supported");
                }
                setSpeed( value);
                break;
