...
//    private boolean smooth = true;
    ...
    /** The value read from the system property for DEADRECKON_POSITION_PROP */
        ...
        switch (newRole) {
            ...
            case VRMLNetworkInterfaceNodeType.ROLE_READER:
                ...
                try {
                    ...
                    Logger.getLogger(DISProtocolHandler.class.getName()).log(Level.SEVERE, null, ex);
                }
