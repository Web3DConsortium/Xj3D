...
public class BaseGeoObliqueMercatorParameters extends BaseGeoSRFTParametersNode {
    ...
    static {
        ...
        fieldMap.put("latitude1", FIELD_LATITUDE1);
        fieldMap.put("latitude2", FIELD_LATITUDE2);
        fieldMap.put("longitude1", FIELD_LONGITUDE1);
        fieldMap.put("longitude1", FIELD_LONGITUDE2);
    }
