    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            case FIELD_REFERENCE_POINT:
                fieldData.clear();
                fieldData.floatArrayValues = vfReferencePoint;
            ...
            case FIELD_ANNOTATIONS:
                fieldData.clear();
                fieldData.nodeArrayValues = vfAnnotations;
