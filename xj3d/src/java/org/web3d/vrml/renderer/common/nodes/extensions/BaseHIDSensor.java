    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            ...
            case FIELD_AXIS_VALUE:
                fieldData.clear();
                fieldData.floatArrayValues = vfAxisValue;
            ...
            case FIELD_AXIS_MIN_VALUE:
                fieldData.clear();
                fieldData.floatArrayValues = vfAxisMinValue;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
            ...
            case FIELD_AXIS_MAX_VALUE:
                fieldData.clear();
                fieldData.floatArrayValues = vfAxisMaxValue;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
            ...
            case FIELD_AXIS_NAME:
                fieldData.clear();
                fieldData.stringArrayValues = vfAxisName;
            ...
            case FIELD_AXIS_WRAP:
                fieldData.clear();
                fieldData.booleanArrayValues = vfAxisWrap;
            ...
            case FIELD_OUTPUT_MIN_VALUE:
                fieldData.clear();
                fieldData.floatArrayValues = vfOutputMinValue;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
            ...
            case FIELD_OUTPUT_MAX_VALUE:
                fieldData.clear();
                fieldData.floatArrayValues = vfOutputMaxValue;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
            ...
            case FIELD_OUTPUT_NAME:
                fieldData.clear();
                fieldData.stringArrayValues = vfOutputName;
                fieldData.dataType = VRMLFieldData.STRING_ARRAY_DATA;
            ...
            case FIELD_OUTPUT_WRAP:
                fieldData.clear();
                fieldData.booleanArrayValues = vfOutputWrap;
                fieldData.dataType = VRMLFieldData.BOOLEAN_ARRAY_DATA;
