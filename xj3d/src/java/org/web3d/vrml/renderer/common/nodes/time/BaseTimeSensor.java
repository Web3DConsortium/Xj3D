...
public class BaseTimeSensor extends BaseTimeControlledNode
    ...
    static {
        ...
        fieldMap.put("time", FIELD_TIME);
        fieldMap.put("cycleTime", FIELD_CYCLE_TIME);
        fieldMap.put("isActive", FIELD_IS_ACTIVE);
        fieldMap.put("isPaused", FIELD_IS_PAUSED);
        fieldMap.put("fraction_changed", FIELD_FRACTION);
