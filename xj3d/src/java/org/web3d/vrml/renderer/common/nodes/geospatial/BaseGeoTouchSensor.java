...
public class BaseGeoTouchSensor extends BaseSensorNode
    ...
    static {
        ...
        fieldMap.put("hitNormal_changed", FIELD_HITNORMAL_CHANGED);
        fieldMap.put("hitPoint_changed", FIELD_HITPOINT_CHANGED);
        fieldMap.put("hitTexCoord_changed", FIELD_HITTEXCOORD_CHANGED);
        fieldMap.put("hitGeoCoord_changed", FIELD_HITGEOCOORD_CHANGED);

        fieldMap.put("isActive", FIELD_IS_ACTIVE);
        fieldMap.put("isOver", FIELD_IS_OVER);
        fieldMap.put("touchTime", FIELD_TOUCH_TIME);
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            case FIELD_HITNORMAL_CHANGED:
                fieldData.clear();
                fieldData.floatArrayValues = vfHitNormalChanged;
            ...
            case FIELD_HITPOINT_CHANGED:
                fieldData.clear();
                fieldData.floatArrayValues = vfHitPointChanged;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 1;
                break;
            ...
            case FIELD_HITTEXCOORD_CHANGED:
                fieldData.clear();
                fieldData.floatArrayValues = vfHitTexCoordChanged;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 1;
                break;
            ...
            case FIELD_HITGEOCOORD_CHANGED:
                fieldData.clear();
                fieldData.doubleArrayValues = vfHitGeoCoordChanged;
