...
public abstract class BaseMotorJoint extends BaseJointNode {
    ...
    static {
        ...
        idx = FIELD_STOP2_ERROR_CORRECTION;
        ...
        idx = FIELD_STOP3_ERROR_CORRECTION;
        ...
        idx = FIELD_ENABLED_AXES;
        fieldMap.put("enabledAxes", idx);
        fieldMap.put("set_enabledAxes", idx);
        fieldMap.put("enabledAxes_changed", idx);

        fieldMap.put("motor1Angle", FIELD_MOTOR1_ANGLE);
        fieldMap.put("motor2Angle", FIELD_MOTOR2_ANGLE);
        fieldMap.put("motor3Angle", FIELD_MOTOR3_ANGLE);
        fieldMap.put("motor1AngleRate", FIELD_MOTOR1_ANGLE_RATE);
        fieldMap.put("motor2AngleRate", FIELD_MOTOR2_ANGLE_RATE);
        fieldMap.put("motor3AngleRate", FIELD_MOTOR3_ANGLE_RATE);
    }
    ...
    public BaseMotorJoint(VRMLNodeType node) {
        ...
        try {
            ...
            vfMotor1Axis[0] = field.floatArrayValues[0];
            vfMotor1Axis[1] = field.floatArrayValues[1];
            vfMotor1Axis[2] = field.floatArrayValues[2];

            index = node.getFieldIndex("motor2Axis");
            field = node.getFieldValue(index);
            vfMotor2Axis[0] = field.floatArrayValues[0];
            vfMotor2Axis[1] = field.floatArrayValues[1];
            vfMotor2Axis[2] = field.floatArrayValues[2];

            index = node.getFieldIndex("motor3Axis");
            field = node.getFieldValue(index);
            vfMotor3Axis[0] = field.floatArrayValues[0];
            vfMotor3Axis[1] = field.floatArrayValues[1];
            vfMotor3Axis[2] = field.floatArrayValues[2];
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            ...
            case FIELD_MOTOR1_AXIS:
                fieldData.clear();
                fieldData.floatArrayValues = vfMotor1Axis;
            ...
            case FIELD_MOTOR2_AXIS:
                fieldData.clear();
                fieldData.floatArrayValues = vfMotor2Axis;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 1;
                break;
            ...
            case FIELD_MOTOR3_AXIS:
                fieldData.clear();
                fieldData.floatArrayValues = vfMotor3Axis;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 1;
                break;
