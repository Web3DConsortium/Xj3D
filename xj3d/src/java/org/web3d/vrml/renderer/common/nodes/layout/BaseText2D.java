...
public abstract class BaseText2D extends BaseSurfaceChildNode
    ...
    static {
        ...
        fieldMap.put("fixedSize", FIELD_FIXED_SIZE);
    ...
    protected BaseText2D(VRMLNodeType node) {
        ...
        try {
            ...
            data = node.getFieldValue(index);
            vfTextColor[0] = data.floatArrayValues[0];
            vfTextColor[1] = data.floatArrayValues[1];
            vfTextColor[2] = data.floatArrayValues[2];

            index = node.getFieldIndex("backgroundColor");
            data = node.getFieldValue(index);
            vfBackgroundColor[0] = data.floatArrayValues[0];
            vfBackgroundColor[1] = data.floatArrayValues[1];
            vfBackgroundColor[2] = data.floatArrayValues[2];
   ...
   public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            ...
            case FIELD_TEXTCOLOR:
                fieldData.clear();
                fieldData.floatArrayValues = vfTextColor;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                break;

            case FIELD_BGCOLOR:
                fieldData.clear();
                fieldData.floatArrayValues = vfBackgroundColor;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                break;
