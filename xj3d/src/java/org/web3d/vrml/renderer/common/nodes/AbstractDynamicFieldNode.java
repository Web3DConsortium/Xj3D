...
public abstract class AbstractDynamicFieldNode implements VRMLNodeType {
    ...
    public VRMLFieldDeclaration getFieldDeclaration(int index) {
        if  ((fieldDeclList == null) || fieldDeclList.isEmpty() || (index < 0))
             return null;
        else return (index >= fieldDeclList.size()) ? null :
    ...
    public int appendField(VRMLFieldDeclaration field)
        ...
        fieldIndexMap.put(name, fieldCount);
    ...
    public List<VRMLFieldDeclaration> getAllFields() {
        List<VRMLFieldDeclaration> ret_val = new ArrayList<>();
