...
public abstract class BaseBorderLayout extends BaseSurfaceLayoutNode {
    ...
    static {
        ...
        alignmentMap.put(LEFT, LEFT_ALIGN);
        alignmentMap.put(RIGHT, RIGHT_ALIGN);
        alignmentMap.put(CENTER, CENTER_ALIGN);
        alignmentMap.put(TOP, TOP_ALIGN);
        alignmentMap.put(BOTTOM, BOTTOM_ALIGN);
