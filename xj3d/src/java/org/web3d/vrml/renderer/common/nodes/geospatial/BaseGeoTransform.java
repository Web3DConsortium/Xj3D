...
public class BaseGeoTransform extends BaseGroupingNode implements OriginListener {
    ...
    public BaseGeoTransform(VRMLNodeType node) {
        ...
        try {
            ...
            vfGeoCenter[0] = field.doubleArrayValues[0];
            vfGeoCenter[1] = field.doubleArrayValues[1];
            vfGeoCenter[2] = field.doubleArrayValues[2];
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch (index) {
            case FIELD_GEO_CENTER:
                ...
                fieldData.doubleArrayValues = vfGeoCenter;
                break;
