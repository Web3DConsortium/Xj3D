 ...
 */
public abstract class BaseVolumePickSensor extends BasePickingNode {
    ...
    private static final String PICK_GEOM_MSG = "The pickGeometry type is " +
        "invalid for VolumePickSensor. It must be one of the " +
     ...
     */
    public BaseVolumePickSensor() {
        super("VolumePickSensor", PICK_GEOM_MSG);
     ...
     */
    public BaseVolumePickSensor(VRMLNodeType node) {
