 ...
 */
public abstract class BasePointPickSensor extends BasePickingNode {
    ...
    private static final String PICK_GEOM_MSG = "The pickGeometry type is " +
        "invalid for PointPickSensor. It must be a PointSet";
     ...
     */
    public BasePointPickSensor() {
        super("PointPickSensor", PICK_GEOM_MSG);
     ...
     */
    public BasePointPickSensor(VRMLNodeType node) {
