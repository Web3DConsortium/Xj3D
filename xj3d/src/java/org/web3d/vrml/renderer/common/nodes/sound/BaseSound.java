...
public class BaseSound extends AbstractNode
    ...
    static {
        ...
        fieldMap.put("spatialize", FIELD_SPATIALIZE);
    }
    ...
    public void copy(VRMLNodeType node) {
        ...
        try {
            ...
            setDirection(field.floatArrayValues);
            ...
            field = node.getFieldValue(index);
            setLocation(field.floatArrayValues);
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            case FIELD_DIRECTION:
                fieldData.clear();
                fieldData.floatArrayValues = vfDirection;
            ...
            case FIELD_LOCATION:
                fieldData.clear();
                fieldData.floatArrayValues = vfLocation;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 3;
                break;
    ...
    public void setSource(VRMLNodeType source) {
        ...
        } else if(source != null && !(source instanceof VRMLAudioClipNodeType) && !(source instanceof VRMLTexture2DNodeType)) { // TODO better test for MovieTexture
        ...
        if(source != null) {
            ...
            // TODO REVISIT - These methods must be moved to a new
            // interface which can be implemented by the MovieTexture node.
            vfSource.addContentStateListener(this);
    ...
    public void deleteSource() {
        ...
        // interface which can be implemented by the MovieTexture node.
            ...
            vfSource.removeContentStateListener(this);
        }
        vfSource = null;
    }
}
