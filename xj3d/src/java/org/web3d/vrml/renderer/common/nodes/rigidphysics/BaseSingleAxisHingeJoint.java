...
public abstract class BaseSingleAxisHingeJoint extends BaseJointNode {
    ...
    static {
        ...
        fieldMap.put("angle", FIELD_ANGLE);
        fieldMap.put("angleRate", FIELD_ANGLE_RATE);
    }
    ...
    public BaseSingleAxisHingeJoint(VRMLNodeType node) {
        ...
        try {
            ...
            vfAxis[0] = field.floatArrayValues[0];
            vfAxis[1] = field.floatArrayValues[1];
            vfAxis[2] = field.floatArrayValues[2];
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            ...
            case FIELD_AXIS:
                fieldData.clear();
                fieldData.floatArrayValues = vfAxis;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 1;
                break;
