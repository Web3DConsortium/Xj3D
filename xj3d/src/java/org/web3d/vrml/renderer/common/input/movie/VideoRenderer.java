...
public class VideoRenderer extends Renderer implements javax.media.renderer.VideoRenderer {
    ...
    /**
     * List of formats we are prepared to accept. Initialized in static
     * initializer.
     */
    ...
    /**
     * Enable or disable callbacks to the videoStreamHandler. We allow callbacks
     * to be disabled because certain transport operations (rewind) have the
     * side effect of calling the start/stop methods in this class, and we do
     * not want them propagated to the videoStreamhandler.
     *
   ...
   @Override
     ...
     * Video is to be scaled if necessary. If rect is null, then the video
     * occupies the entire component. This call is ignored in this
     * implementation.
     *
     ...
     * Returns null if the entire component is being used. (Always returns
     * null.)
     *
     * @return
     */
     ...
     *
     * @param format
     * @return The Format that was set. This is typically the supported Format
     * that most closely matches the specified Format. If possible, the format
     * fields that were not specified are set to the preferred values in the
     * returned Format. Returns null if the specified Format is not supported.
     */
    @Override
     ...
     *
     * @return An array of Format objects that represent the input formats
    ...
    /**
     * Processes the data and renders it to the output device represented by
     * this Renderer.
     *
     * @param buffer
