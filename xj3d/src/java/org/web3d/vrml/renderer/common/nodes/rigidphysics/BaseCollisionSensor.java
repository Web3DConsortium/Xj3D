...
public abstract class BaseCollisionSensor extends BaseSensorNode
    ...
    static {
        ...
        fieldMap.put("contacts", FIELD_CONTACTS);
        fieldMap.put("intersections", FIELD_INTERSECTIONS);
...
//     * @param numContacts The number of contacts to process from the list
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            ...
            case FIELD_CONTACTS:
                fieldData.clear();
                fieldData.nodeArrayValues = vfContacts;
            ...
            case FIELD_INTERSECTIONS:
                fieldData.clear();
                fieldData.nodeArrayValues = vfIntersections;
                fieldData.dataType = VRMLFieldData.NODE_ARRAY_DATA;
