...
public abstract class BaseCylinderSensor extends BaseDragSensorNode {
    ...
    /**
     * The field index for rotation_changed
     */
    ...
    protected static final int FIELD_AXIS_ROTATION = LAST_DRAG_SENSOR_INDEX + 6;
    ...
    static {
        ...
        fieldMap.put("rotation_changed", FIELD_ROTATION_CHANGED);
    }
    ...
    public BaseCylinderSensor() {
        ...
        vfRotationChanged = new float[] {0, 1, 0, 0};
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch (index) {
            case FIELD_ROTATION_CHANGED:
                fieldData.clear();
                fieldData.floatArrayValues = vfRotationChanged;
