...
public abstract class BaseGeoLOD extends BaseGroupingNode
    ...
    static {
        ...
        fieldMap.put("rootNode", FIELD_ROOT_NODE);
        fieldMap.put("rootUrl", FIELD_ROOT_URL);
        fieldMap.put("child1Url", FIELD_CHILD1_URL);
        fieldMap.put("child2Url", FIELD_CHILD2_URL);
        fieldMap.put("child3Url", FIELD_CHILD3_URL);
        fieldMap.put("child4Url", FIELD_CHILD4_URL);
    ...
    protected BaseGeoLOD(VRMLNodeType node) {
        ...
        try {
            ...
            vfCenter[0] = field.doubleArrayValues[0];
            vfCenter[1] = field.doubleArrayValues[1];
            vfCenter[2] = field.doubleArrayValues[2];
            ...
            if(field.numElements != 0) {
                ...
                System.arraycopy(field.stringArrayValues, 0, vfChild1Url, 0,
                                 field.numElements);
            }
            ...
            if(field.numElements != 0) {
                ...
                System.arraycopy(field.stringArrayValues, 0, vfChild2Url, 0,
                                 field.numElements);
            }
            ...
            if(field.numElements != 0) {
                ...
                System.arraycopy(field.stringArrayValues, 0, vfChild3Url, 0,
                                 field.numElements);
            }
            ...
            if(field.numElements != 0) {
                ...
                System.arraycopy(field.stringArrayValues, 0, vfChild4Url, 0,
                                 field.numElements);
            }
            ...
            if(field.numElements != 0) {
                ...
                System.arraycopy(field.stringArrayValues, 0, vfRootUrl, 0,
                                 field.numElements);
            }
...
*/
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            case FIELD_CENTER:
                fieldData.clear();
                fieldData.doubleArrayValues = vfCenter;
            ...
            case FIELD_ROOT_URL:
                fieldData.clear();
                fieldData.stringArrayValues = vfRootUrl;
                fieldData.dataType = VRMLFieldData.STRING_ARRAY_DATA;
            ...
            case FIELD_CHILD1_URL:
                fieldData.clear();
                fieldData.stringArrayValues = vfChild1Url;
                fieldData.dataType = VRMLFieldData.STRING_ARRAY_DATA;
            ...
            case FIELD_CHILD2_URL:
                fieldData.clear();
                fieldData.stringArrayValues = vfChild2Url;
                fieldData.dataType = VRMLFieldData.STRING_ARRAY_DATA;
            ...
            case FIELD_CHILD3_URL:
                fieldData.clear();
                fieldData.stringArrayValues = vfChild3Url;
                fieldData.dataType = VRMLFieldData.STRING_ARRAY_DATA;
            ...
            case FIELD_CHILD4_URL:
                fieldData.clear();
                fieldData.stringArrayValues = vfChild4Url;
                fieldData.dataType = VRMLFieldData.STRING_ARRAY_DATA;
