...
public abstract class BaseCollisionSpace extends AbstractNode
    ...
    protected static final int FIELD_COLLIDABLES = LAST_NODE_INDEX + 5;

    /** The field index for useGeometry */
    protected static final int FIELD_USE_GEOMETRY = LAST_NODE_INDEX + 6;

    /** The field index for enabled */
    protected static final int FIELD_ENABLED = LAST_NODE_INDEX + 7;
    ...
    /** value of the field bboxDisplay false */
    protected boolean vfBboxDisplay;
    
    /** value of the field visible true */
     ...
     * by it's parent space (e.g. deletes it).
     *
     ...
     * parser at setup.
     * 
     * @param val the box display value to set
     */
