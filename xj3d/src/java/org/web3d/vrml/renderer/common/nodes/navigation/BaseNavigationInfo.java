    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            case FIELD_AVATAR_SIZE:
                fieldData.clear();
                fieldData.floatArrayValues = vfAvatarSize;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = numAvatarSize;
                break;
            case FIELD_TRANSITION_TIME:
                fieldData.clear();
                fieldData.floatArrayValues = vfTransitionTime;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
            ...
            case FIELD_TYPE:
                fieldData.clear();
                fieldData.stringArrayValues = vfType;
            ...
            case FIELD_TRANSITION_TYPE:
                fieldData.clear();
                fieldData.stringArrayValues = vfTransitionType;
                fieldData.dataType = VRMLFieldData.STRING_ARRAY_DATA;
