...
public abstract class BaseOrthoViewpoint extends BaseBindableNode
    ...
    protected static final int FIELD_CENTEROFROTATION = LAST_BINDABLE_INDEX + 6;

    /** Index of the retainUserOffsets field */
    protected static final int FIELD_RETAIN_USER_OFFSETS = LAST_BINDABLE_INDEX + 7;

    /** Index of the viewAll field */
    protected static final int FIELD_VIEWALL = LAST_BINDABLE_INDEX + 8;

    /** Index of the farDistance field */
    protected static final int FIELD_FARDISTANCE = LAST_BINDABLE_INDEX + 9;

    /** Index of the nearDistance field */
    protected static final int FIELD_NEARDISTANCE = LAST_BINDABLE_INDEX + 10;
    ...
    protected BaseOrthoViewpoint(VRMLNodeType node) {
        ...
        try {
            ...
            vfFieldOfView[0] = field.floatArrayValues[0];
            vfFieldOfView[1] = field.floatArrayValues[1];
            vfFieldOfView[2] = field.floatArrayValues[2];
            vfFieldOfView[3] = field.floatArrayValues[3];
            ...
            field = node.getFieldValue(index);
            vfCenterOfRotation[0] = field.floatArrayValues[0];
            vfCenterOfRotation[1] = field.floatArrayValues[1];
            vfCenterOfRotation[2] = field.floatArrayValues[2];
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            ...
            case FIELD_FIELDOFVIEW:
                fieldData.clear();
                fieldData.floatArrayValues = vfFieldOfView;
            ...
            case FIELD_CENTEROFROTATION:
                fieldData.clear();
                fieldData.floatArrayValues = vfCenterOfRotation;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 1;
                break;
            default:
