...
public abstract class BasePlaneSensor extends BaseDragSensorNode {
    ...
    /** The field index for axisRotation */
    protected static final int FIELD_AXIS_ROTATION = LAST_DRAG_SENSOR_INDEX + 5;

    /** The last field index used by this class */
    protected static final int LAST_PLANESENSOR_INDEX = FIELD_AXIS_ROTATION;
    ...
    /** The value of the axisRotation field */
    protected float[] vfAxisRotation;
    ...
    static {
        ...
        fieldMap.put("isOver", FIELD_IS_OVER);
        fieldMap.put("trackPoint_changed", FIELD_TRACKPOINT_CHANGED);

        idx = FIELD_AUTOOFFSET;
        ...
        idx = FIELD_AXIS_ROTATION;
        fieldMap.put("axisRotation", idx);
        fieldMap.put("set_axisRotation", idx);
        fieldMap.put("axisRotation_changed", idx);

        idx = FIELD_MAXPOSITION;
        fieldMap.put("maxPosition", idx);
        fieldMap.put("set_maxPosition", idx);
        fieldMap.put("maxPosition_changed", idx);

        idx = FIELD_MINPOSITION;
        fieldMap.put("minPosition", idx);
        fieldMap.put("set_minPosition", idx);
        fieldMap.put("minPosition_changed", idx);

        fieldMap.put("translation_changed", FIELD_TRANSLATION_CHANGED);
    }
    ...
    public BasePlaneSensor() {
        ...
        // TODO: What now, how to apply?
        vfAxisRotation = new float[] {0, 1, 0, 0};
    ...
    public BasePlaneSensor(VRMLNodeType node) {
        ...
        try {
            ...
            vfOffset[0] = field.floatArrayValues[0];
            vfOffset[1] = field.floatArrayValues[1];
            vfOffset[2] = field.floatArrayValues[2];

            index = node.getFieldIndex("minPosition");
            field = node.getFieldValue(index);

            vfMinPosition[0] = field.floatArrayValues[0];
            vfMinPosition[1] = field.floatArrayValues[1];

            index = node.getFieldIndex("maxPosition");
            field = node.getFieldValue(index);

            vfMaxPosition[0] = field.floatArrayValues[0];
            vfMaxPosition[1] = field.floatArrayValues[1];

            index = node.getFieldIndex("axisRotation");
            field = node.getFieldValue(index);
            vfAxisRotation = field.floatArrayValues;
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        switch(index) {
            case FIELD_TRANSLATION_CHANGED:
                fieldData.clear();
                fieldData.floatArrayValues = vfTranslationChanged;
            ...
            case FIELD_MAXPOSITION:
                fieldData.clear();
                fieldData.floatArrayValues = vfMaxPosition;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 1;
                break;
            ...
            case FIELD_MINPOSITION:
                fieldData.clear();
                fieldData.floatArrayValues = vfMinPosition;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 1;
                break;
            ...
            case FIELD_OFFSET:
                fieldData.clear();
                fieldData.floatArrayValues = vfOffset;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 1;
                break;

            case FIELD_AXIS_ROTATION:
                fieldData.clear();
                fieldData.floatArrayValues = vfAxisRotation;
                fieldData.dataType = VRMLFieldData.FLOAT_ARRAY_DATA;
                fieldData.numElements = 1;
                break;
    ...
    public void sendRoute(double time,
        ...
        try {
            switch(srcIndex) {
                ...
                case FIELD_AXIS_ROTATION:
                    destNode.setValue(destIndex, vfAxisRotation, 4);
                    break;
     ...
     * be used to set SFVec2f, SFVec3f and SFRotation field types.
     *
    ...
    protected void processDrag(float[] location, float[] direction) {
        ...
        // TODO: Figure out how axisRotation figures into this calculation
