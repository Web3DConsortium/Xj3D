 ...
 * If you are trying to perform multiple views of the scene graph, such as an
...
public class OGLStandardBrowserCore
     ...
     * @param dc
     */
    @SuppressWarnings("unchecked") // cast from an empty collection
    public OGLStandardBrowserCore(EventModelEvaluator eme,
        ...
        sceneManager.setMinimumFrameInterval(2_000);
    }
    ...
    public void changeWorld() {
        if(currentScene != null) {
            ...
            sceneManager.setMinimumFrameInterval(1_000 / PAUSED_FPS);
...
//        sceneManager.setEnabled(true);
    ...
    public void shutdown() {
        for (OGLLayerManager allManager : allManagers) {
            if (allManager != null)
                allManager.shutdown();
        }
    }
     ...
     * @param enabled whether stereo is enabled for all layers
     */
