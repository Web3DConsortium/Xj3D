...
import org.web3d.vrml.renderer.common.nodes.rigidphysics.BaseRigidBody;
 ...
 */
public class OGLRigidBody extends BaseRigidBody
     ...
     */
    public OGLRigidBody(VRMLNodeType node) {
        super(node);
    }
