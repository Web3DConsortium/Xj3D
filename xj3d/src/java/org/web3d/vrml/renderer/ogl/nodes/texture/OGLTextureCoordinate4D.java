 ...
 * <p>
 *
 * The texture coordinate node does not occupy a space in the Aviatrix4D
 ...
 */
public class OGLTextureCoordinate4D extends BaseTextureCoordinate4D
    implements OGLVRMLNode {

    /**
     * Empty constructor
     */
    public OGLTextureCoordinate4D() {
    }
     ...
     */
    public OGLTextureCoordinate4D(VRMLNodeType node) {
        super(node);
    }
