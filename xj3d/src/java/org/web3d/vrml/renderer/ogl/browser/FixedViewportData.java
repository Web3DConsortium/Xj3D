...
/**
 * Internal data holder used by viewport resize manager for fixed size
 * viewports.
 ...
 */
class FixedViewportData {

    /** The X position of the viewport, in pixels */
    int viewX;

    /** The Y position of the viewport, in pixels */
    int viewY;
    ...
    public String toString() {
        StringBuilder buf = new StringBuilder("ProportionalViewportData: ");
        buf.append("Viewport : ");
