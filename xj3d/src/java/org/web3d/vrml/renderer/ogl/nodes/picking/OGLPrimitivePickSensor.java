...
import org.web3d.vrml.renderer.common.nodes.picking.BasePrimitivePickSensor;
 ...
 */
public class OGLPrimitivePickSensor extends BasePrimitivePickSensor
     ...
     */
    public OGLPrimitivePickSensor(VRMLNodeType node) {
        super(node);
        targetSet = new HashMap<>();
    }
