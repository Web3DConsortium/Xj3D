...
import org.web3d.vrml.renderer.common.nodes.rigidphysics.BaseCollisionSpace;
 ...
 */
public class OGLCollisionSpace extends BaseCollisionSpace
     ...
     */
    public OGLCollisionSpace(VRMLNodeType node) {
        super(node);
    }
