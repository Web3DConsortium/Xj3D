...
public class DefaultUserInputHandler
    ...
    *  with the shift modifier active */
    ...
    static {
        ...
        navigationTypes.put(Xj3DConstants.EXAMINE_NAV_MODE, NavigationState.EXAMINE_STATE);
        navigationTypes.put(Xj3DConstants.WALK_NAV_MODE, NavigationState.WALK_STATE);
        navigationTypes.put(Xj3DConstants.FLY_NAV_MODE, NavigationState.FLY_STATE);
        navigationTypes.put(Xj3DConstants.NONE_NAV_MODE, NavigationState.NO_STATE);
        navigationTypes.put(Xj3DConstants.LOOKAT_NAV_MODE, NavigationState.LOOKAT_STATE);
        navigationTypes.put(Xj3DConstants.PAN_NAV_MODE, NavigationState.PAN_STATE);
        navigationTypes.put(Xj3DConstants.TILT_NAV_MODE, NavigationState.TILT_STATE);
        navigationTypes.put(Xj3DConstants.INSPECT_NAV_MODE, Xj3DNavigationState.INSPECT_STATE);
        navigationTypes.put(Xj3DConstants.TRACK_EXAMINE_NAV_MODE, Xj3DNavigationState.TRACK_EXAMINE_STATE);
        navigationTypes.put(Xj3DConstants.TRACK_PAN_NAV_MODE, Xj3DNavigationState.TRACK_PAN_STATE);
        navigationTypes.put(Xj3DConstants.FLY_LEVEL_NAV_MODE, Xj3DNavigationState.FLY_LEVEL_STATE);
    ...
    public void trackerMoved(int tracker, TrackerState evt) {
        ...
        for(int i = node_count - 1; i >= 0; i--) {
            ...
            for (VRMLPointingDeviceSensorNodeType sensor : u_data.sensors) {
                sens = sensor;
    ...
    public void trackerWheel(int tracker, TrackerState state) {
        if (wheelEnabled) {
            ...
            switch (current) {
                case Xj3DConstants.EXAMINE_NAV_MODE:
                    tmpVec1[0] = 0;
                    tmpVec1[1] = 0;
                    ...
                    wheelMoved = true;
                    break;
                case Xj3DConstants.FLY_LEVEL_NAV_MODE:
                    tmpVec1[0] = 0;
                    tmpVec1[1] = 0;
                    tmpVec1[2] = state.wheelClicks;
                    ...
                    wheelMoved = true;
                    break;
                case Xj3DConstants.TRACK_EXAMINE_NAV_MODE:
                    tmpVec1[0] = 0;
                    tmpVec1[1] = 0;
                    tmpVec1[2] = state.wheelClicks;
     ...
     *
     * @param node The scene graph object to process
    ...
    private boolean processNodePress(SceneGraphObject node) {
        ...
        if(user_data.sensors != null) {
            ...
            for (VRMLPointingDeviceSensorNodeType sensor : sensors) {
                if (sensor.getEnabled()) {
                    if (sensor instanceof VRMLTouchSensorNodeType) {
                        touch = (VRMLTouchSensorNodeType) sensor;
                        activeTouchSensors.add(touch);
                        hasTouchSensor = true;
                    } else {
                        drag = (VRMLDragSensorNodeType) sensor;
    ...
    private void fireDeviceOver(Object sensor) {
        ...
        if (sensor instanceof VRMLTouchSensorNodeType) {
            ...
            desc = ((VRMLPointingDeviceSensorNodeType) sensor).getDescription();
