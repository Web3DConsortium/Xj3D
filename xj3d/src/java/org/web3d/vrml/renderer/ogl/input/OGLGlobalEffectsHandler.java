...
public interface OGLGlobalEffectsHandler {
    ...
    int FOG_DISABLE = VRMLFogNodeType.FOG_TYPE_DISABLE;

    /** Constant used to set the fog state to linear. */
    int FOG_LINEAR = VRMLFogNodeType.FOG_TYPE_LINEAR;
     ...
     */
    void setViewMatrix(Matrix4f transform);
     ...
     */
    void setBackgroundMatrix(Matrix4f transform);
     ...
     */
    void setFogMatrix(Matrix4f transform);
     ...
     */
    void updateBackgroundTextures(Texture2D[] textures,
                                         boolean[] flags);
