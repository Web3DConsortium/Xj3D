...
import org.web3d.vrml.renderer.common.nodes.picking.BasePointPickSensor;
 ...
 */
public class OGLPointPickSensor extends BasePointPickSensor
     ...
     */
    public OGLPointPickSensor(VRMLNodeType node) {
        super(node);
        targetSet = new HashMap<>();
    }
