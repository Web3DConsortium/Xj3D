...
class ViewpointResizeManager
    ...
    void sendResizeUpdates() {
        ...
        for (ViewpointData perspectiveViewpoint : perspectiveViewpoints) {
            processPerspectiveViewpointChange(perspectiveViewpoint);
        }
        for (ViewpointData orthoViewpoint : orthoViewpoints) {
            processOrthoViewpointChange(orthoViewpoint);
        }
