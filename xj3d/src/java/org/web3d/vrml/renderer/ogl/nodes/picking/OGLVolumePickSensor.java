...
import org.web3d.vrml.renderer.common.nodes.picking.BaseVolumePickSensor;
 ...
 */
public class OGLVolumePickSensor extends BaseVolumePickSensor
     ...
     */
    public OGLVolumePickSensor(VRMLNodeType node) {
        super(node);
        targetSet = new HashMap<>();
    }
