...
class OGLLayerManager
    ...
    private final IntHashMap<BindableNodeManager> bindablesMap;

    /** Clock for setting bindTime information */
    private VRMLClock clock;

    /** The global effects for this layer */
    private final GlobalEffectsGroup globalEffects;
    ...
    private final DefaultLayerSensorManager layerSensorManager;
    ...
    private final Matrix4f worldScaleMatrix;

    /** A matrix used when calculating the scene graph path */
    private final Matrix4f pathMatrix;
    ...
    public void initialise(SensorManager smgr) {
        ...
        createDefaultBindables(3, 2); // <- TODO: this is highly suspect. Why force 3.2 here? (tdn) 10/4/24
    }
