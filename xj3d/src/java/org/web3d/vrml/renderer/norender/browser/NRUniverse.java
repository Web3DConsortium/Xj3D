...
public class NRUniverse
    ...
    private static final float INFINITE_VIS_LIMIT = 10_000;
...
//    private ViewpointTransition vpTransition;
     ...
     */
    @SuppressWarnings("unchecked") // cast from an empty Collections Map
...
//        userInput.setViewInfo(null, null);
    ...
    private void clearInlines(BasicScene scene) {
        ...
        for(int i = 0; i < size; i++) {
            ...
            // recurse further.
            sc = (VRMLScene)((VRMLExecutionSpace)node).getContainedScene();
