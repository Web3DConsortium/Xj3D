 ...
 */
public class NRSceneBuilderFactory implements SceneBuilderFactory {
     ...
     */
    public NRSceneBuilderFactory(boolean forceVRML97,
    ...
    public SceneBuilder createBuilder() {
        ...
        NRVRMLSceneBuilder builder = new NRVRMLSceneBuilder();
