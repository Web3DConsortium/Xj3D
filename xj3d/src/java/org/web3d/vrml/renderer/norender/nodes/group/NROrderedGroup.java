 ...
 */
public class NROrderedGroup extends BaseOrderedGroup
     ...
     * @throws IllegalArgumentException The node is not a OrderedGroup node
     */
    public NROrderedGroup(VRMLNodeType node) {
        super(node);
    }
}
