 ...
 */
public class NRMultiTextureCoordinate extends BaseMultiTextureCoordinate
    implements NRVRMLNode {

    /**
     * Empty constructor
     */
    public NRMultiTextureCoordinate() {
    }
     ...
     */
    public NRMultiTextureCoordinate(VRMLNodeType node) {
        super(node);
    }
}
