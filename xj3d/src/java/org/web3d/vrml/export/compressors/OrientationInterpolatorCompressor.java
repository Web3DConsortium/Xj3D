    ...
    public void fieldValue(String value) throws SAVException, VRMLException {
        ...
        try {
            if (currentField == 0) {
                ...
                CompressionTools.compressFloatArray(dos,true,1,fval);
            } else {
                ...
                if (dbits < rbits) {
                    bp.pack(0,1);
                    CompressionTools.compressFloatArray(dos, true, 4, fval);
                } else {
                    bp.pack(0,1);
                    CompressionTools.compressFloatArray(dos, false, 4, fval);
                }
            }
