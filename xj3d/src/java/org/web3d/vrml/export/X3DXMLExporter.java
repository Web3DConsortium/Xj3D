...
public class X3DXMLExporter extends Exporter {
    ...
    public void startDocument(String uri,
        ...
        if (containerFields.isEmpty() || new_minor != minor)
    ...
    public void startNode(String name, String defName)
        ...
        if (defName != null) {
            if (defTable.get(defName) != null) {
                ...
                String newName = defName + "_DUP" + num;
    ...
    public void startField(String name)
        ...
        if (type > 1) {
            ...
            if (name.equals("url") && ((VRMLNode)node).getVRMLNodeName().equals("Script")) {
                inCData=true;
