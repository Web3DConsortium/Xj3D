                ...
                if (value == null) {
                    ...
                    switch(atts.getAlgorithmIndex(i)) {
                        ...
                        case X3DBinaryConstants.QUANTIZED_ZLIB_FLOAT_ARRAY_ALGORITHM_ID2:
                            f2val = (float[]) atts.getAlgorithmData(i);
                            break;
                        default:
