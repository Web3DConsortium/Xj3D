...
*/
     ...
     * user should always check {@link org.web3d.vrml.scripting.ecmascript.builtin.FieldScriptableObject#hasChanged()} which
    ...
    protected FunctionObject locateFunction(String methodName) {
        ...
        try {
          function = new FunctionObject(methodName, method, this);
            ...
            errorReporter.errorReport("Unknown function: " + real_name +
                                        " on: " + getClass(), ex);
            return null;
        }
