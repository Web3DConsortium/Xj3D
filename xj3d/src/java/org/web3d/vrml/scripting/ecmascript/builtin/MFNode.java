...
public class MFNode extends NodeFieldObject {
     ...
     * @param numValid The number of valid values to copy from the array The number of valid nodes to use from the array
     */
     ...
     *
     * @return true if there are a local changes to this node instance
     */
