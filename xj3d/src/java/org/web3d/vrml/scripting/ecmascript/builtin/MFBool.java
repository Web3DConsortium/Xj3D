...
public class MFBool extends FieldScriptableObject {
     ...
     */
    public MFBool(boolean[] values, int numValid) {
     ...
     *
     * @param values The array to source values from
     * @param start The starting index in the array to work from
     * @param length size of array
     */
    public MFBool(boolean[] values, int start, int length) {
        this(); // invoke default constructor
        ...
        if((values != null) && (length > 0)) {
            ...
            sizeInt.setValue(values.length);
        } else {
            sizeInt.setValue(0);
        }
    }
