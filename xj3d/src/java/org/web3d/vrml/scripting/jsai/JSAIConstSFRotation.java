 ...
 */
class JSAIConstSFRotation extends ConstSFRotation
     ...
     */
    JSAIConstSFRotation(VRMLNodeType n, int index) {
        node = n;
        fieldIndex = index;
        valueChanged = true;
        updateLocalData();
    ...
    @Override
    public Object clone() {
        return new JSAIConstSFRotation(node, fieldIndex);
    }
