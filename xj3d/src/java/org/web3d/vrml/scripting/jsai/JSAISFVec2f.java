 ...
 */
class JSAISFVec2f extends SFVec2f
     ...
     */
    JSAISFVec2f(VRMLNodeType n, int index) {
        node = n;
        fieldIndex = index;
        valueChanged = true;
        updateLocalData();
    ...
    public void setValue(float[] val) {
        ...
        try {
            node.setValue(fieldIndex, val, 2);
    ...
    public void setValue(float x, float y) {
        ...
        try {
            node.setValue(fieldIndex, data, 2);
        } catch(FieldException ife) {
        }
    }
     ...
     */
    @Override
    public void setValue(ConstSFVec2f val) {
        val.getValue(data);
     ...
     */
    @Override
    public void setValue(SFVec2f val) {
        val.getValue(data);
    ...
    @Override
    public Object clone() {
        return new JSAISFVec2f(node, fieldIndex);
    }
