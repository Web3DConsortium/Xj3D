...
public abstract class CommonBrowser {
    ...
    /** The current version number.  NOTE: This is a departure from the trunk
     * for the NPS Branch.
     */
    private static final String BROWSER_VERSION = Xj3dVersionInformation.XJ3D_VERSION;
    ...
    protected String[] completeUrl(String[] base) {
        ...
        if (worldURL == null) {
            try {
                url_base=AccessController.doPrivileged((PrivilegedExceptionAction<String>) () -> System.getProperty("user.dir"));
            } catch (PrivilegedActionException pae) {
                errorReporter.errorReport("Error getting user.dir", pae);
                return null;
            }

            String complete_url = URLChecker.prependFileScheme(url_base);
