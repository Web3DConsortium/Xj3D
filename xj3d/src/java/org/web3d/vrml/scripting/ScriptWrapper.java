...
public interface ScriptWrapper {
     ...
     */
    void queueEvent(int type, String name, int value);
     ...
     */
    void queueEvent(int type, String name, int[] value, int numValid);
     ...
     * @param value The new value of the field
     */
    void queueEvent(int type, String name, long value);
     ...
     * @param numValid The number of valid values to copy from the array
     */
    void queueEvent(int type, String name, long[] value, int numValid);
     ...
     * @param value The new value of the field
     */
    void queueEvent(int type, String name, boolean value);
     ...
     * @param numValid The number of valid values to copy from the array
     */
    void queueEvent(int type, String name, boolean[] value, int numValid);
     ...
     * @param value The new value of the field
     */
    void queueEvent(int type, String name, float value);
     ...
     * @param numValid The number of valid values to copy from the array
     */
    void queueEvent(int type, String name, float[] value, int numValid);
     ...
     * @param value The new value of the field
     */
    void queueEvent(int type, String name, double value);
     ...
     * @param numValid The number of valid values to copy from the array
     */
    void queueEvent(int type, String name, double[] value, int numValid);
     ...
     * @param value The new value of the field
     */
    void queueEvent(int type, String name, String value);
     ...
     * @param numValid The number of valid values to copy from the array
     */
    void queueEvent(int type, String name, String[] value, int numValid);
     ...
     * @param value The new value of the field
     */
    void queueEvent(int type, String name, VRMLNodeType value);
     ...
     * @param numValid The number of valid values to copy from the array
     */
    void queueEvent(int type, String name, VRMLNodeType[] value, int numValid);
