...
ExternalEvent, ExternalOutputBuffer {
    ...
    public void getValue(float[] col) {
        if (storedOutput) {
            ...
            if (data.floatArrayValues==null)
                ...
                System.arraycopy(data.floatArrayValues,0,col,0,4);
        }
    }
    ...
    private void loadInputValue() {
        ...
        if (value.floatArrayValues==null)
            ...
            System.arraycopy(value.floatArrayValues,0,storedInputValue,0,4);
        storedInput=true;
    }
    ...
    public void loadOutputValue() {
        ...
        if (value.floatArrayValues==null)
            ...
            System.arraycopy(value.floatArrayValues,0,storedOutputValue,0,4);
        storedOutput=true;
    }
