...
class MFRotationWrapper extends BaseFieldWrapper
    ...
    public void get1Value(int index, float[] vec) {
        if (storedOutput)
            ...
            if (index<0 || index>=value.numElements)
                ...
                System.arraycopy(value.floatArrayValues,index*4,vec,0,4);
        }
    }
    ...
    public void getValue(float[] vec) {
        if (storedOutput) {
            ...
            if (data.numElements!=0)
                System.arraycopy(data.floatArrayValues,0,vec,0,data.numElements*4);
        }
    }
    ...
    public void getValue(float[][] vec) {
        if (storedOutput) {
            ...
            VRMLFieldData data=theNode.getFieldValue(fieldIndex);
            if (data.numElements!=0)
                ArrayUtils.raise4(data.floatArrayValues,data.numElements,vec);
        }
    }
    ...
    private void loadInputValue() {
        ...
        if (value.numElements!=0)
            System.arraycopy(value.floatArrayValues,0,storedInputValue,0,value.numElements*4);
        storedInput=true;
    ...
    public void loadOutputValue() {
        ...
        if (value.numElements!=0)
            System.arraycopy(value.floatArrayValues,0,storedOutputValue,0,value.numElements*4);
        storedOutput=true;
    }
