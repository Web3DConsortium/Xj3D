...
abstract class BaseFieldWrapper implements X3DField {
    ...
    /**
     * Checks to ensure that the field is readable at the time the call is made,
     * and generate an intelligible error message and exception if it isn't.
     */
    ...
    /**
     * Checks to ensure that the field is writable at the time the call is made,
     * and generate an intelligible error message and exception if it isn't.
     */
    ...
    /**
     * Compute equality of field wrappers. Two field wrappers which point to the
     * same node and same field are equal
     */
    @Override
    ...
    /**
     * Protected method for determining the access type of the field. Copied
     * from SAIFieldDefinition to avoid the creation of a secondary object for
     ...
     * reference to) it shall return true for eventOuts, exposedFields and false
     * for eventIn or field.
     *
     ...
     * application querying a node or a script querying another node it has a
     * reference to) it shall return true for eventIns, exposedFields and false
     * for eventOut or field.
     *
     * @return true if the values of this field are readable
     * @throws InvalidFieldException The underlying node this field came from
     * has been disposed of
    ...
    /**
     * Associate user data with this field. Whenever an field is generated on
     * this field, this data will be available with the Event through its
     * getData method.
     *
