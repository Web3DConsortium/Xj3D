...
class MFColorRGBAWrapper extends BaseFieldWrapper
    ...
    public void get1Value(int index, float[] col) {
        if (storedOutput)
            ...
            if (index<0 || index>=value.numElements)
                ...
                System.arraycopy(value.floatArrayValues,index*4,col,0,4);
        }
    }
    ...
    public void getValue(float[] col) {
        if (storedOutput) {
            ...
            if (data.numElements!=0)
                System.arraycopy(data.floatArrayValues,0,col,0,data.numElements*4);
        }
    }
    ...
    public void getValue(float[][] col) {
        if (storedOutput) {
            ...
            checkReadAccess();
            VRMLFieldData data=theNode.getFieldValue(fieldIndex);
            ArrayUtils.raise4(data.floatArrayValues,data.numElements,col);
        }
    }
