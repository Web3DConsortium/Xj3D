...
/**
 * ServerProcessingTask is the runnable which embodies the read and processing
 * loop for an individual connection.
 */
class ServerProcessingTask implements Runnable, BrowserCoreListener, FieldChangeTransmitter {
     ...
     *
     * @param socket The connection to deal with
     */
    ServerProcessingTask(Socket socket, ServerBrowser browser, VRMLClock clock) {
        ...
        theServerBrowser.setCoreListener(ServerProcessingTask.this);
        theServerBrowser.setFieldChangeTransmitter(ServerProcessingTask.this);
        timeClock = clock;
    }
                    ...
                    switch (packetType) {
                        ...
                        case NetworkProtocolConstants.CREATE_VRML_FROM_STRING_REQUEST: {
                            ...
                            synchronized (writeLock) {
                                ...
                                } catch (InvalidBrowserException | InvalidVrmlException | IOException t) {
                                    sendErrorPacket(t, dos);
                                }
                            }
                        }
                        ...
                        case NetworkProtocolConstants.GET_EVENTIN_REQUEST: {
                            ...
                            synchronized (writeLock) {
                                ...
                                } catch (InvalidNodeException | InvalidFieldException ine) {
                                    sendExceptionPacket(ine, dos);
                                } catch (IOException t) {
                                    sendErrorPacket(t, dos);
                                }
                        ...
                        case NetworkProtocolConstants.GET_NUM_FIELD_VALUES_REQUEST: {
                            ...
                            synchronized (writeLock) {
                                ...
                                try {
                                    ...
                                    sendExceptionPacket(ine, dos);
                                } catch (org.web3d.vrml.lang.InvalidFieldException | IOException t) {
                                    sendErrorPacket(t, dos);
                                }
                            }
    ...
    /**
     * Transmit the components of an SFImage field value type 0 for height, type
     * 1 for width, type 2 for components, anything else for the pixels.
     *
    ...
    private void transmitSubFieldValue(VRMLNodeType node, int localFieldID, byte subRequestType, DataOutputStream dos) throws IOException {
        ...
        switch (subRequestType) {
            case 0:
                dos.writeInt(data.intArrayValues[0]);
                break;
            case 1:
                dos.writeInt(data.intArrayValues[1]);
                break;
            case 2:
                dos.writeInt(data.intArrayValues[2]);
                break;
            default:
                int numPixels = data.intArrayValues[0] * data.intArrayValues[1];
                dos.writeInt(numPixels);
                for (int counter = 0; counter < numPixels; counter++) {
                    dos.writeInt(data.intArrayValues[3 + counter]);
                }
        }
    }
    ...
    /**
     * * @see
     * org.web3d.browser.BrowserCoreListener#browserInitialized(org.web3d.vrml.nodes.VRMLScene)
     */
    @Override
    ...
    /**
     * * @see
     * org.web3d.browser.BrowserCoreListener#urlLoadFailed(java.lang.String)
     */
    @Override
        ...
        switch (theServerBrowser.getFieldType(fieldID)) {
            case BaseField.MFColor:
                ...
                for (int counter = 0; counter < data.numElements; counter++) {
                    dos.writeFloat(data.floatArrayValues[innerCounter++]);
                    dos.writeFloat(data.floatArrayValues[innerCounter++]);
                    dos.writeFloat(data.floatArrayValues[innerCounter++]);
                }
                break;
            case BaseField.MFFloat:
                dos.writeInt(data.numElements);
                for (int counter = 0; counter < data.numElements; counter++) {
                    dos.writeFloat(data.floatArrayValues[counter]);
                }
                break;
            case BaseField.MFInt32:
                dos.writeInt(data.numElements);
                for (int counter = 0; counter < data.numElements; counter++) {
                    dos.writeInt(data.intArrayValues[counter]);
                }
                break;
            case BaseField.MFNode:
                dos.writeInt(data.numElements);
                for (int counter = 0; counter < data.numElements; counter++) {
                    dos
                            .writeInt(theServerBrowser
                                    .generateNodeID(data.nodeArrayValues[counter]));
                }
                break;
            case BaseField.MFRotation:
                dos.writeInt(data.numElements);
            ...
            case BaseField.MFString:
                dos.writeInt(data.numElements);
                for (int counter = 0; counter < data.numElements; counter++) {
                    dos.writeUTF(data.stringArrayValues[counter]);
                }
                break;
            case BaseField.MFTime:
                dos.writeInt(data.numElements);
                for (int counter = 0; counter < data.numElements; counter++) {
                    dos.writeDouble(data.doubleArrayValues[counter]);
                }
                break;
            case BaseField.MFVec2f:
                dos.writeInt(data.numElements);
            ...
            case BaseField.SFBool:
                ...
                break;
            case BaseField.SFColor:
                dos.writeFloat(data.floatArrayValues[0]);
                dos.writeFloat(data.floatArrayValues[1]);
                dos.writeFloat(data.floatArrayValues[2]);
                break;
            case BaseField.SFFloat:
            ...
            case BaseField.SFRotation:
                ...
                dos.writeFloat(data.floatArrayValues[1]);
                dos.writeFloat(data.floatArrayValues[2]);
                dos.writeFloat(data.floatArrayValues[3]);
                break;
            case BaseField.SFString:
