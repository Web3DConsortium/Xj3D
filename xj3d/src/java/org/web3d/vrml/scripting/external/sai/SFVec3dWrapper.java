...
class SFVec3dWrapper extends BaseFieldWrapper implements SFVec3d, ExternalEvent, ExternalOutputBuffer {
    ...
    public void getValue(double[] vec) {
        if (storedOutput) {
            ...
            if (data.doubleArrayValues==null)
                ...
                System.arraycopy(data.doubleArrayValues,0,vec,0,3);
        }
    }
    ...
    private void loadInputValue() {
        ...
        if (value.doubleArrayValues==null)
            ...
            System.arraycopy(value.doubleArrayValues,0,storedInputValue,0,3);
        storedInput=true;
    }
    ...
    public void loadOutputValue() {
        ...
        if (value.doubleArrayValues==null)
            ...
            System.arraycopy(value.doubleArrayValues,0,storedOutputValue,0,3);
        storedOutput=true;
    }
