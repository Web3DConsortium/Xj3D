...
class MFInt32Wrapper extends BaseFieldWrapper
    ...
    public int get1Value(int index)
        throws ArrayIndexOutOfBoundsException {
            if (storedOutput)
                ...
                // intArrayValues may be null if numElements == 0
                if (index<0 || index>=value.numElements)
                    throw new ArrayIndexOutOfBoundsException();
                else
                    return value.intArrayValues[index];
            }
    }
    ...
    public void getValue(int[] values) {
        if (storedOutput)
            ...
            if (data.numElements!=0)
                System.arraycopy(data.intArrayValues,0,values,0,data.numElements);
        }
    }
    ...
    public void loadOutputValue() {
        ...
        if (value.numElements!=0)
            System.arraycopy(value.intArrayValues,0,storedOutputValue,0,value.numElements);
        storedOutput=true;
    }
