 ...
 */
class SAIMFVec3d extends BaseMField implements MFVec3d {
     ...
     */
    SAIMFVec3d(VRMLNodeType n, int field, boolean internal) {
        super(n, field, internal);
    }

    //----------------------------------------------------------
    // Methods defined by MFVec3d
    //----------------------------------------------------------
    ...
    public void append(double value[]) {
        ...
        if((localValue == null) || (localValue.length == numElements * 3)) {
            double[] tmp = new double[numElements * 3 + ARRAY_INC];
