...
public class DefaultFieldFactory implements FieldFactory {
     ...
     * @param fieldQueue The access listener for propagating s2 requests
    ...
    public BaseField createField(VRMLNodeType node,
        ...
        switch(decl.getFieldType()) {
            ...
            case FieldConstants.SFNODE:
                ...
                ((NodeField)ret_val).setFieldFactory(this);
                ((NodeField)ret_val).setFieldReferenceQueue(fieldQueue);
                ((NodeField)ret_val).setNodeFactory(baseNodeFac);
                break;
