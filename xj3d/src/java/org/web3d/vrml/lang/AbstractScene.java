...
public abstract class AbstractScene implements BasicScene {
    ...
    public void addNode(VRMLNode node) {
        ...
        List<VRMLNode> list = primaryTypes.get(p_type);
        ...
        for(int i = 0; i < s_types.length; i++) {
            list = secondaryTypes.get(s_types[i]);
    ...
    public void removeNode(VRMLNode node) {
        ...
        List list = primaryTypes.get(p_type);
        list.remove(node);
    ...
    public List<VRMLNode> getByPrimaryType(int type) {
        ...
        List<VRMLNode> ret_val = primaryTypes.get(type);
     ...
     */
    @Override
    public List<VRMLNode> getBySecondaryType(int type) {

        List<VRMLNode> ret_val = secondaryTypes.get(type);
    ...
    /**
     * Set the root URL of the world that this scene graph represents
     *
    ...
    /**
     * Set the URI of the world that this scene graph represents
     *
