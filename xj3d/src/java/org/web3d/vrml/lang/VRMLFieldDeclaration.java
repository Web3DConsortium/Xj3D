...
public class VRMLFieldDeclaration {
    ...
    static {
        ...
        fieldTypeMap.put("SFInt32", FieldConstants.SFINT32);
        fieldTypeMap.put("MFInt32", FieldConstants.MFINT32);
        fieldTypeMap.put("SFFloat", FieldConstants.SFFLOAT);
        fieldTypeMap.put("MFFloat", FieldConstants.MFFLOAT);
        fieldTypeMap.put("SFDouble", FieldConstants.SFDOUBLE);
        fieldTypeMap.put("MFDouble", FieldConstants.MFDOUBLE);
        fieldTypeMap.put("SFLong", FieldConstants.SFLONG);
        fieldTypeMap.put("MFLong", FieldConstants.MFLONG);
        fieldTypeMap.put("SFBool", FieldConstants.SFBOOL);
        fieldTypeMap.put("MFBool", FieldConstants.MFBOOL);
        fieldTypeMap.put("SFVec2f", FieldConstants.SFVEC2F);
        fieldTypeMap.put("MFVec2f", FieldConstants.MFVEC2F);
        fieldTypeMap.put("SFVec2d", FieldConstants.SFVEC2D);
        fieldTypeMap.put("MFVec2d", FieldConstants.MFVEC2D);
        fieldTypeMap.put("SFVec3f", FieldConstants.SFVEC3F);
        fieldTypeMap.put("MFVec3f", FieldConstants.MFVEC3F);
        fieldTypeMap.put("SFVec3d", FieldConstants.SFVEC3D);
        fieldTypeMap.put("MFVec3d", FieldConstants.MFVEC3D);
        fieldTypeMap.put("SFVec4f", FieldConstants.SFVEC4F);
        fieldTypeMap.put("MFVec4f", FieldConstants.MFVEC4F);
        fieldTypeMap.put("SFVec4d", FieldConstants.SFVEC4D);
        fieldTypeMap.put("MFVec4d", FieldConstants.MFVEC4D);
        fieldTypeMap.put("SFImage", FieldConstants.SFIMAGE);
        fieldTypeMap.put("MFImage", FieldConstants.MFIMAGE);
        fieldTypeMap.put("SFTime", FieldConstants.SFTIME);
        fieldTypeMap.put("MFTime", FieldConstants.MFTIME);
        fieldTypeMap.put("SFNode", FieldConstants.SFNODE);
        fieldTypeMap.put("MFNode", FieldConstants.MFNODE);
        fieldTypeMap.put("SFString", FieldConstants.SFSTRING);
        fieldTypeMap.put("MFString", FieldConstants.MFSTRING);
        fieldTypeMap.put("SFRotation", FieldConstants.SFROTATION);
        fieldTypeMap.put("MFRotation", FieldConstants.MFROTATION);
        fieldTypeMap.put("SFColor", FieldConstants.SFCOLOR);
        fieldTypeMap.put("MFColor", FieldConstants.MFCOLOR);
        fieldTypeMap.put("SFColorRGBA", FieldConstants.SFCOLORRGBA);
        fieldTypeMap.put("MFColorRGBA", FieldConstants.MFCOLORRGBA);
        fieldTypeMap.put("SFMatrix3f", FieldConstants.SFMATRIX3F);
        fieldTypeMap.put("MFMatrix3f", FieldConstants.MFMATRIX3F);
        fieldTypeMap.put("SFMatrix3d", FieldConstants.SFMATRIX3D);
        fieldTypeMap.put("MFMatrix3d", FieldConstants.MFMATRIX3D);
        fieldTypeMap.put("SFMatrix4f", FieldConstants.SFMATRIX4F);
        fieldTypeMap.put("MFMatrix4f", FieldConstants.MFMATRIX4F);
        fieldTypeMap.put("SFMatrix4d", FieldConstants.SFMATRIX4D);
        fieldTypeMap.put("MFMatrix4d", FieldConstants.MFMATRIX4D);
        fieldTypeMap.put(UNKNOWN_IMPORT, FieldConstants.UNKNOWN_IMPORT_TYPE);
    }
