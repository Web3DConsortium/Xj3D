...
public interface VRMLNode {
     ...
     * i&period;e&period; MFNode and SFNode). Used for blind scene graph 
     * traversal without needing to spend time querying for all fields etc. If a 
     * node does not have any fields that contain nodes, this shall return null. 
     * The field list covers all field types, regardless of whether they are
