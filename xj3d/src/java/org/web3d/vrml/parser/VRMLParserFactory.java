...
public abstract class VRMLParserFactory {
    ...
    public static VRMLParserFactory newVRMLParserFactory()
        ...
        String classname = AccessController.doPrivileged((PrivilegedAction<String>) () -> System.getProperty(FACTORY_CLASS_PROP, DEFAULT_FACTORY));

        VRMLParserFactory ret_val = null;

        try {
            Class<?> cls = Class.forName(classname);
            Object fac = cls.getDeclaredConstructor().newInstance();
