...
public interface VRMLNavigationInfoNodeType extends VRMLBindableNodeType {
    ...
    String NAV_TYPE_ANY = "ANY";

    /** The navigation type is WALK */
    String NAV_TYPE_WALK = "WALK";

    /** The navigation type is EXAMINE */
    String NAV_TYPE_EXAMINE = "EXAMINE";

    /** The navigation type is LOOKAT */
    String NAV_TYPE_LOOKAT = "LOOKAT";

    /** The navigation type is FLY */
    String NAV_TYPE_FLY = "FLY";

    /** The navigation type is NONE */
    String NAV_TYPE_NONE = "NONE";

    /** The transition type LINEAR */
    String TRANSITION_TYPE_LINEAR = "LINEAR";

    /** The transition type TELEPORT */
    String TRANSITION_TYPE_TELEPORT = "TELEPORT";

    /** The transition type ANIMATE */
    String TRANSITION_TYPE_ANIMATE = "ANIMATE";
     ...
     */
    void setType(String[] types, int numValid)
     ...
     */
    void setSpeed(float newSpeed) throws InvalidFieldValueException;
     ...
     */
    void setVisibilityLimit(float limit) throws InvalidFieldValueException;
     ...
     */
    void addNavigationChangedListener(NavigationInfoChangeListener l);
     ...
     * @param l The new navigation info change listener
     */
    void removeNavigationChangedListener(NavigationInfoChangeListener l);
     ...
     */
    void setWorldLocation(Vector3f wcpos);
}
