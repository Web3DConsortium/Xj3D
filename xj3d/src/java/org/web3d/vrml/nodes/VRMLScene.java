 ...
 * list. If there are none of the given node types, the methods shall return
 * empty lists.
 *
 * @author Justin Couch
...
public interface VRMLScene extends BasicScene {
     ...
     */
    Map<String, VRMLProtoDeclare> getProtos();
     ...
     */
    Map<String, VRMLExternProtoDeclare> getExternProtos();
