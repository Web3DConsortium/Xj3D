...
public interface VRMLFogNodeType extends
     ...
     */
    void setColor(float[] color) throws InvalidFieldValueException;
     ...
     */
    void setFogType(int type) throws InvalidFieldValueException;
}
