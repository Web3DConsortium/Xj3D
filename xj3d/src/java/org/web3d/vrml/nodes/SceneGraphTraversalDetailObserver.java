...
public interface SceneGraphTraversalDetailObserver {
     ...
     */
    void groupingNode(VRMLGroupingNodeType parent,
     ...
     * @param used true if the node reference is actually a USE
     */
    void inlineNode(VRMLGroupingNodeType parent,
     ...
     * @param used true if the node reference is actually a USE
     */
    void lightNode(VRMLGroupingNodeType parent,
     ...
     * @param used true if the node reference is actually a USE
     */
    void bindableNode(VRMLGroupingNodeType parent,
     ...
     * @param used true if the node reference is actually a USE
     */
    void shapeNode(VRMLGroupingNodeType parent,
     ...
     * @param used true if the node reference is actually a USE
     */
    void appearanceNode(VRMLShapeNodeType parent,
     ...
     * @param used true if the node reference is actually a USE
     */
    void materialNode(VRMLAppearanceNodeType parent,
     ...
     * @param used true if the node reference is actually a USE
     */
    void textureNode(VRMLAppearanceNodeType parent,
     ...
     * @param used true if the node reference is actually a USE
     */
    void textureTransformNode(VRMLAppearanceNodeType parent,
     ...
     * @param used true if the node reference is actually a USE
     */
    void geometryNode(VRMLShapeNodeType parent,
     ...
     * @param used true if the node reference is actually a USE
     */
    void geometricPropertyNode(VRMLComponentGeometryNodeType parent,
     ...
     * @param used true if the node reference is actually a USE
     */
    void soundNode(VRMLGroupingNodeType parent,
     ...
     * @param used true if the node reference is actually a USE
     */
    void audioClipNode(VRMLSoundNodeType parent,
     ...
     * @param used true if the node reference is actually a USE
     */
    void sensorNode(VRMLGroupingNodeType parent,
     ...
     * @param used true if the node reference is actually a USE
     */
    void interpolatorNode(VRMLGroupingNodeType parent,
     ...
     * @param used true if the node reference is actually a USE
     */
    void scriptNode(VRMLGroupingNodeType parent,
     ...
     * @param used true if the node reference is actually a USE
     */
    void protoNode(VRMLNodeType parent,
     ...
     * @param used true if the node reference is actually a USE
     */
    void customNode(VRMLNodeType parent,
                           int fieldIndex,
                           VRMLNodeType child,
                           boolean used);
     ...
     * @param used true if the node reference is actually a USE
     */
    void miscellaneousNode(VRMLNodeType parent,
                                  int fieldIndex,
                                  VRMLNodeType node,
                                  boolean used);
}
