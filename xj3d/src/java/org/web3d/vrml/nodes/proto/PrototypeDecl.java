...
public class PrototypeDecl extends AbstractProto
     ...
     * of the proto that would allow it to be used in a scene graph.
     *
    ...
    public void addIS(String declFieldName, VRMLNodeType destNode, int destField)
        ...
        VRMLFieldDeclaration src_decl = fieldDeclList.get(index);
        ...
        if(dest_list == null) {
            dest_list = new ArrayList<>(5); // start small!
