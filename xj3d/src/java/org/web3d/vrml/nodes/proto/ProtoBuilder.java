...
public class ProtoBuilder
    ...
    public void startNode(String name, String defName)
        ...
        if(protoMap.containsKey(name)) {
            ...
            proto_def = externProtoMap.get(name);
    ...
    public void protoFieldDecl(int access,
        ...
        if((value != null) && (currentProto instanceof VRMLProtoDeclare)) { // TODO fix
    ...
    public void startProtoBody() throws SAVException, VRMLException {
        ...
        topOfStack++;
        currentNode = ((VRMLProtoDeclare)currentProto).getBodyGroup();
