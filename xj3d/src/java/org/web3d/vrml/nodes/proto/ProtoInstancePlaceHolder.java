 ...
 * </pre>
 *
 * In this case, when we are storing the definition of <code>Inner</code> then we
...
public class ProtoInstancePlaceHolder extends AbstractProto
     ...
     */
    private IntHashMap<VRMLFieldData> fieldValueMap;
    ...
    /** Actual array of node field indices. Set in setupComplete */
                    ...
                    if(data != null) {
                        ...
                        switch(field_type) {
                            ...
                            case FieldConstants.MFNODE:
                                ...
                                data.nodeArrayValues = new VRMLNodeType[5];
                                node_array.add(field_index);
                                break;
     ...
     * we can add this into the scene graph. If this is an empty prototype
    ...
    public VRMLFieldData getFieldValue(int index) throws InvalidFieldException {
        ...
        VRMLFieldData ret_val = fieldValueMap.get(index);
        ...
        if(!inSetup) {
            ...
            if(old_value != null) {
                ...
                if(decl.getFieldType() == FieldConstants.MFNODE) {
                    ...
                    if(data.nodeArrayValues.length == data.numElements) {
                        VRMLNodeType[] tmp =
                            new VRMLNodeType[data.numElements + 5];

                        System.arraycopy(data.nodeArrayValues,
                                         0,
                                         tmp,
                                         0,
                                         data.numElements);
                        data.nodeArrayValues = tmp;
                    }

                    // Now just append it to the list
                    data.nodeArrayValues[data.numElements] = child;
                    data.numElements++;
                } else {
