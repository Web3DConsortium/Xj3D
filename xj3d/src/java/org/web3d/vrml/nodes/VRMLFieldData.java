...
public class VRMLFieldData {
    ...
    public double[] doubleArrayValues;

    /** An array of boolean values for MFBool etc */
    public boolean[] booleanArrayValues;

    /** An array of node values of the field */
    public VRMLNodeType[] nodeArrayValues;
    ...
    public VRMLFieldData(VRMLFieldData data) {
        ...
        switch(dataType) {
            ...
            case BOOLEAN_ARRAY_DATA:
                booleanArrayValues = data.booleanArrayValues;
                break;

            case INT_ARRAY_DATA:
                intArrayValues = data.intArrayValues;
                break;

            case LONG_ARRAY_DATA:
                longArrayValues = data.longArrayValues;
                break;

            case FLOAT_ARRAY_DATA:
                floatArrayValues = data.floatArrayValues;
                break;

            case DOUBLE_ARRAY_DATA:
                doubleArrayValues = data.doubleArrayValues;
                break;

            case NODE_ARRAY_DATA:
                nodeArrayValues = data.nodeArrayValues;
                break;

            case STRING_ARRAY_DATA:
                stringArrayValues = data.stringArrayValues;
                break;
                
            default:
                DefaultErrorReporter.getDefaultReporter().messageReport("Error: VRMLFieldData unknown dataType=" + dataType);
                // TODO exception?
        }
    }
