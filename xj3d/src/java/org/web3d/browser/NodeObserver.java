...
public interface NodeObserver {
     ...
     * @param numNodes size of nodes array
     */
    void nodesAdded(int nodeType, VRMLNodeType[] nodes, int numNodes);
     ...
     * @param numNodes The number of node instances that have just been removed
     */
    void nodesRemoved(int nodeType, VRMLNodeType[] nodes, int numNodes);
