 ...
 * @deprecated since Java3D no longer supported.  Use
 * {@link org.xj3d.ui.awt.browser.ogl.X3DOGLBrowserFactoryImpl}
 */
@Deprecated
public class X3DBrowserFactoryImpl implements BrowserFactoryImpl {
     ...
     */
    @Override
    public ExternalBrowser getBrowser(java.applet.Applet applet, String frameName, int index)
        throws NotSupportedException,
               NoSuchBrowserException,
               ConnectionException {
        throw new NotSupportedException();
