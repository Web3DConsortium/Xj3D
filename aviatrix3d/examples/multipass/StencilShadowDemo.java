/**
 * ***************************************************************************
 * Yumetech, Inc Copyright (c) 2008 Java Source
 *
 ...
 * <p>
 *
 * This example code demonstrates how hard shadow effects can be implemented
 * using aviatrix3d scene graph. Essentially, multiple render passes are used
 * for drawing hard shadow effect. The algorithm used in this demo code is
 * z-fail a.k.a. Carmack's reverse.
 *
 * @author Sang Park
...
public class StencilShadowDemo extends Frame
    ...
    private static final String APP_NAME = "Stencil Shadow Demo";
    ...
    /**
     * Global transformation matrix of the silhouette edge geometry and the
    ...
    private void setupSceneGraph() {
        ...
        java.util.List<SEdgeIndTriArray> sceneGeomList
                = new ArrayList<>();
    ...
    /**
     * Creates a shadow volume scene where all polygons are front facing.
     *
     * @return Single render pass
     */
    ...
    /**
     * Creates a shadow volume scene where all polygons are back facing.
     *
     * @return Single render pass
     */
