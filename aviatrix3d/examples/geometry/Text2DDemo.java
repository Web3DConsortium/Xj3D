 ...
 */
public class Text2DDemo extends Frame
    implements WindowListener
{
    ...
    public Text2DDemo()
    {
        ...
        addWindowListener(Text2DDemo.this);
    ...
    private void setupSceneGraph()
    {
        ...
        Vector3f trans = new Vector3f(0, 0, 2);
        ...
        text.setHorizontalJustification(Text2D.JUSTIFY_MIDDLE);
        text.setVerticalJustification(Text2D.JUSTIFY_MIDDLE);
        text.setSize(0.3f);
