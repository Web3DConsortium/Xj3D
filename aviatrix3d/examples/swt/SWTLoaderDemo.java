...
public class SWTLoaderDemo
{
     ...
     */
    public SWTLoaderDemo(Shell parent)
    {
    ...
    private SimpleScene setupSceneGraph(Group loadedScene)
    {
        ...
        ModelRotationAnimation anim =
            new ModelRotationAnimation(rot_group, resizer);
    ...
    public static void main(String[] args)
    {
        ...
        SWTLoaderDemo demo = new SWTLoaderDemo(shell);
        demo.load(args[0]);

        shell.setSize (640, 480);
        shell.setText("Basic AV3D Loader + SWT Demo");
        shell.open();
