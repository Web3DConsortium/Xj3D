 ...
 */
public class UniformUpdateDemo extends Frame
    implements WindowListener
{
    ...
    /** Arguments that we are animating */
    ...
    private void setupSceneGraph()
    {
        ...
        shaderArgs = new ShaderArguments();
...
//        mat2.setScale(0.05f);
        ...
        UniformAnimation anim = new UniformAnimation(shaderArgs);
