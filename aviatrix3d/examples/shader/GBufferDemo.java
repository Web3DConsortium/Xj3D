...
import static org.j3d.util.TriangleUtils.createTangents;
    ...
    implements WindowListener
{
    ...
    public GBufferDemo()
    {
        super("Multiple Render Target Demo w/ NEWT");
...
//        BoxGenerator generator = new BoxGenerator(2.5f, 2.5f, 2.5f);
 //       generator.generate(data);
        ...
        createTangents(data.indexesCount / 3,
                                     data.indexes,
                                     data.coordinates,
                                     data.normals,
