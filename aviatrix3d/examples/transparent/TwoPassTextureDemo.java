    ...
    implements WindowListener
{
    ...
    private GraphicsOutputDevice tp_surface;
    ...
    public TwoPassTextureDemo()
    {
        ...
        Runnable r = new Runnable() {
            ...
            public void run() {
                ...
                // for demo purposes
                surface.enableTwoPassTransparentRendering(false);
    ...
    private void setupAviatrix()
    {
        ...
        sp_pipeline.setGraphicsOutputDevice(surface);
        ...
        tp_surface = new SimpleAWTSurface(caps);
        ...
        Component sp_comp = (Component)surface.getSurfaceObject();
