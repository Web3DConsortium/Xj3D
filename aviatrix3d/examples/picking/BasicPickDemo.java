 ...
 */
public class BasicPickDemo extends Frame
    implements WindowListener
{
    ...
    {
        super("Aviatrix Basic Pick Demo");

        setLayout(new BorderLayout());
        addWindowListener(BasicPickDemo.this);
    ...
    private void setupSceneGraph()
    {
        ...
        BasicPickHandler anim = new BasicPickHandler(scene_root,
                                                     shape_transform,
                                                     material);
