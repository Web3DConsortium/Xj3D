...
import java.net.URL;
import static javax.media.Controller.Prefetched;
import static javax.media.Manager.createProcessor;
import static javax.media.Processor.Configured;
...
*/
            ...
            if(!waitForState(Configured))
            {
                out.println("Failed to configure the processor");
                return;
            }
...
//                        controls[i].setFormat(renderer.getSupportedInputFormats()[0]);
                    ...
                    err.println("Unsupported plugin??? "+ e);
                }
            }
            ...
            if(!waitForState(Prefetched))
            {
                out.println("Failed to prefech the processor");
                return;
            }
        ...
        {
            out.println("Error starting movie handling");
