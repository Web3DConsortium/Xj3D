...
import static javax.media.Format.FALSE;
import static javax.media.Format.NOT_SPECIFIED;
import static javax.media.Format.TRUE;
import static javax.media.Format.byteArray;
...
*/
        ...
        Format req_rgb = new RGBFormat(null, //frame_size,
        NOT_SPECIFIED, byteArray, NOT_SPECIFIED,
                                       24,            // bitsPerPixel
                                       1,
                                       2,
                                       3,
                                       3, // pixel stride
        NOT_SPECIFIED, TRUE, NOT_SPECIFIED);
    ...
    public Format setInputFormat(Format format)
    {
        ...
        if(format instanceof RGBFormat)
        {
            ...
            out.println("frame width: " + frameWidth + " height: " + frameHeight);
            // Do we need it flipped, based on the Y-up flag of the
            // texture component?
            int flip = outputTexture.isYUp() ? TRUE : FALSE;
    ...
    public synchronized int process(Buffer buffer)
    {
        ...
        arraycopy(src_pixels, 0, inProgressFrame, 0, num_pixels);
