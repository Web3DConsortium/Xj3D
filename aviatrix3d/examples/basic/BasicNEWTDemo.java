 ...
 * rendering system.
 *
 * @author <a href="mailto:tdnorbra@nps.edu?subject=BasicNEWTDemo">Terry Norbraten, NPS MOVES</a>
 * @version $Id: BasicNEWTDemo.java 12670 2020-02-10 03:45:41Z tnorbraten $
 */
public class BasicNEWTDemo extends Frame
    implements WindowListener, ApplicationUpdateObserver
{
    private static final String APP_NAME = "Basic Aviatrix NEWT Demo";
    ...
    public BasicNEWTDemo()
    {
        ...
        addWindowListener(BasicNEWTDemo.this);
    ...
    private void setupAviatrix()
    {
        ...
        // screen first.
        Component comp = new NewtCanvasAWT((Window) surface.getSurfaceObject());
