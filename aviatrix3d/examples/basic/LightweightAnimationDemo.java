 ...
 * rendering system and renders using a lightweight JPanel.
 *
 * @author Justin Couch
 * @version $Revision: 1.3 $
 */
public class LightweightAnimationDemo extends JFrame
    implements WindowListener
{
    ...
    public LightweightAnimationDemo()
    {
        super("Lightweight Aviatrix Demo");
    ...
    private void setupAviatrix()
    {
        ...
        content_pane.add(comp, BorderLayout.CENTER);
    }
