 ...
 */
public class BasicLightweightDemo extends Frame
    implements WindowListener
{
    ...
    public BasicLightweightDemo()
    {
        super("Basic Aviatrix Lightweight Demo");

        setLayout(new BorderLayout());
        addWindowListener(BasicLightweightDemo.this);
...
//        surface = new SimpleAWTSurface(caps, true);
        surface = new DebugAWTSurface(caps, true);
