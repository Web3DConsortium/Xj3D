 ...
 */
public class TriangleStripArray extends BufferGeometry
{
    /** Message when the strip count is < 3 */
    private static final String MIN_COUNT_PROP =
        "org.j3d.renderer.aviatrix3d.nodes.TriangleStripArray.minStripSizeMsg";

    /** Message when the total count is less than strip totals */
    private static final String TOTAL_COUNT_PROP =
        "org.j3d.renderer.aviatrix3d.nodes.TriangleStripArray.totalCoordCountMsg";
        ...
        throws NotPickableException
    {
        ...
        for(int i = 0; i < numStrips; i++)
        {
            ...
            {
                vertexBuffer.get(wkPolygon, 0, 9);
