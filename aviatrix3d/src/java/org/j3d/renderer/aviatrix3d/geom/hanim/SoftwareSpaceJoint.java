 ...
 * the skin mesh updates and is optimised for space usage.
 * <p>
 * <b>Internationalisation Resource Names</b>
 * <ul>
 * <li>jointTypeSingleMsg: Error message when a non-software joint given</li>
 * <li>jointTypeMultiMsg: Error message when a non-software joint given</li>
 * </ul>
 *
 * @author Justin Couch
 * @version $Revision: 1.2 $
 */
class SoftwareSpaceJoint extends SoftwareJoint
{
    /** Speed joint added to a space joint */
    private static final String WRONG_TYPE_SINGLE_PROP =
        "org.j3d.renderer.aviatrix3d.geom.hanim.SoftwareSpaceJoint.jointTypeSingleMsg";

    /** Speed joint added to a space joint */
    private static final String WRONG_TYPE_MULTI_PROP =
        "org.j3d.renderer.aviatrix3d.geom.hanim.SoftwareSpaceJoint.jointTypeMultiMsg";
    ...
    public void setChildren(HAnimObject[] kids, int numValid)
    {
        ...
        {
            if(!(kids[i] instanceof SoftwareSpaceJoint))
            {
    ...
    {
        if(!(kid instanceof SoftwareSpaceJoint))
        {
            I18nManager intl_mgr = I18nManager.getManager();
            Locale lcl = intl_mgr.getFoundLocale();
                                  ...
                                  boolean parentChanged)
    {
        ...
        {
            FloatBuffer c_buf = (FloatBuffer)outputCoords;
        ...
        {
            FloatBuffer c_buf = (FloatBuffer)outputCoords;
            FloatBuffer n_buf = (FloatBuffer)outputNormals;
