    ...
    implements NodeUpdateListener, ShaderObjectParent
{
    ...
    ShaderHumanoid()
    {
        bufferGeometry = new ArrayList<>();
        vertexGeometry = new ArrayList<>();
        updatedChildAttribList = new ArrayList<>();
    ...
    private void updateAttributes()
    {
        ...
        for(int i = 0; i < size; i++)
        {
            VertexGeometry geom = vertexGeometry.get(i);
            if(geom.isLive())
