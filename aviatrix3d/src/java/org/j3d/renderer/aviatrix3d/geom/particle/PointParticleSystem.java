...
public class PointParticleSystem extends AVParticleSystem
{
                              ...
                              int numColors)
    {
        ...
        if(numColors != 0 && numColors != 3 && numColors != 4)
        {
            ...
            Object[] msg_args = { (float) numColors};
            Format[] fmts = { n_fmt };
    ...
    {
        ((VertexGeometry)particleGeometry).setVertices(PointArray.COORDINATE_3,
                                                   vertices,
                                                   particleCount);
    }
    ...
    public void updateNodeDataChanges(Object src)
    {
        ...
        {
            case 3:
                ((VertexGeometry)particleGeometry).setColors(false, colors);
                break;

            case 4:
                ((VertexGeometry)particleGeometry).setColors(true, colors);
                break;
     ...
     * it is recommended.
     * @return the attributes that the particle system implementation would
     * prefer to have
     */
