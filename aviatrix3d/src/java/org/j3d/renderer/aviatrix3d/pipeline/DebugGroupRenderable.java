...
/**
 * Debugging Renderable object representing a group node during traversal
 * <p>
 *
 * @author Justin Couch
 * @version $Revision: 1.2 $
 */
class DebugGroupRenderable
               ...
               GeometryRenderable
{
    ...
    /** Indicate this is one that is culled */
    private boolean isCulled;

    /** Indicate this is one that is partially culled */
    ...
    DebugGroupRenderable(boolean culled,
                         boolean partial,
                         float[] min,
                         float[] max,
                         float[] center,
    ...
    {
        DebugGroupRenderable sh = (DebugGroupRenderable)o;
