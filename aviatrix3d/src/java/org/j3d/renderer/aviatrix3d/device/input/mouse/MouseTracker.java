    ...
    implements MouseListener, MouseMotionListener, MouseWheelListener
{
    ...
    public void mousePressed(MouseEvent evt)
    {
        ...
        tstate[currentIndex].buttonState[0] = (mods & MouseEvent.BUTTON1_DOWN_MASK) ==
                MouseEvent.BUTTON1_DOWN_MASK;

        tstate[currentIndex].buttonState[1] = (mods & MouseEvent.BUTTON2_DOWN_MASK) ==
                MouseEvent.BUTTON2_DOWN_MASK;

        tstate[currentIndex].buttonState[2] = (mods & MouseEvent.BUTTON3_DOWN_MASK) ==
    ...
    private void transformMouse(int layer, int subLayer, TrackerState state)
    {
        ...
        state.worldPos[0] = mousePosition.x;
        state.worldPos[1] = mousePosition.y;
        state.worldPos[2] = mousePosition.z;

        state.worldOri[0] = mousePickDirection.x;
        state.worldOri[1] = mousePickDirection.y;
        state.worldOri[2] = mousePickDirection.z;
    }
}
