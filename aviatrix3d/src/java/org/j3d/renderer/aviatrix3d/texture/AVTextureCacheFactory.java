 ...
 * scene graph by allowing texture instances to be shared, rather than
 * duplicated.
 * <p>
 *
...
public class AVTextureCacheFactory implements TextureCacheFactory
{
    ...
    private static IntHashMap<AVTextureCache> cacheMap;
    ...
    {
        AVTextureCache ret_val = cacheMap.get(cacheType);
