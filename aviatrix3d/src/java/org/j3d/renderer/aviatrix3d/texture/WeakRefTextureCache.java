...
class WeakRefTextureCache extends AbstractTextureCache
{
    ...
    private Map<String, WeakReference<Texture>> textureMap;

    /** Mapping of the filename or URL to a AV3D texture component object */
    private Map<String, WeakReference<TextureComponent>> componentMap;
...
*/
    ...
    /**
     * Fetch the image component named by the filename. The filename may
...
*/
    ...
    {
        WeakReference<Texture> ref = new WeakReference<>(texture);
        textureMap.put(filename, ref);
