...
public interface AVTextureCache extends TextureCache
{
     ...
     */
    Texture fetchTexture(String filename)
        throws IOException;
     ...
     * @throws IOException An I/O error occurred during loading
     */
    TextureComponent fetchTextureComponent(String filename)
        throws IOException;
     ...
     * @throws IOException An I/O error occurred during loading
     */
    TextureComponent fetchTextureComponent(URL url)
        throws IOException;
     ...
     */
    boolean checkTextureComponent(String filename);
     ...
     */
    void registerTexture(Texture texture, String filename);

    /**
     * Register an image component with the cache assigned to a filename.
     *
     * @param component The texture to store
     * @param filename The filename to register
     */
    void registerTextureComponent(TextureComponent component, String filename);
