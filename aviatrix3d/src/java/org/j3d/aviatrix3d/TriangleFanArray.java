 ...
 */
public class TriangleFanArray extends VertexGeometry
{
    /** Message when the fan count is < 3 */
    private static final String MIN_COUNT_PROP =
        "org.j3d.aviatrix3d.TriangleFanArray.minStripSizeMsg";

    /** Message when the total count is less than fan totals */
    private static final String TOTAL_COUNT_PROP =
        "org.j3d.aviatrix3d.TriangleFanArray.totalCoordCountMsg";
     ...
     */
    public TriangleFanArray(boolean useVbo, int vboHint)
    {
            ...
            for(int j = 0; j < num_tris; j++)
            {
                switch(coord_comps)
                {
                    case 2:
                        ...
                        wkPolygon[4] = coordinates[coord_offset + 1];
                        wkPolygon[5] = 0;

                        wkPolygon[6] = coordinates[coord_offset + 2];
                        wkPolygon[7] = coordinates[coord_offset + 3];
                        wkPolygon[8] = 0;
                        coord_offset += 2;
                        break;
                    ...
                    case 3:
                        wkPolygon[3] = coordinates[coord_offset];
                        wkPolygon[4] = coordinates[coord_offset + 1];
                        wkPolygon[5] = coordinates[coord_offset + 2];

                        wkPolygon[6] = coordinates[coord_offset + 3];
                        wkPolygon[7] = coordinates[coord_offset + 4];
                        wkPolygon[8] = coordinates[coord_offset + 5];
                        coord_offset += 3;
                        break;
                    ...
                    case 4:
                        ...
                        wkPolygon[8] = coordinates[coord_offset + 6];
                        coord_offset += 4;
                        break;
                }
     ...
     * sure that the number of vertices is high enough to support the total
