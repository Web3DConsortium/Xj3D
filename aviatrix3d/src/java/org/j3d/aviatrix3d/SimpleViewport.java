               ...
               ViewportLayerCullable
{
    ...
    private static final String HAS_PARENT_PROP =
        "org.j3d.aviatrix3d.SimpleViewport.hasParentMsg";
   ...
   /** Flag to describe whether this is the currently active sound layer */
    ...
    /**
     * Clear the current scene instance used by this viewport.
     *
     * @throws InvalidWriteTimingException An attempt was made to write outside
     *   of the NodeUpdateListener data changed callback method
     */
    public void removeScene() throws InvalidWriteTimingException
    {
        if(isLive() && updateHandler != null &&
           !updateHandler.isDataWritePermitted(this))
            throw new InvalidWriteTimingException(getDataWriteTimingMessage());
