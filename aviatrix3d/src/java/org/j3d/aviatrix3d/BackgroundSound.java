...
/**
 * A BackgroundSound class which emits a sound which doesn't change
    ...
    public void render(AL al, Matrix4f transform)
    {
        if (dataChanged)
        {
            ...
            else
            {
                ...
                al.alSource3f(source, AL.AL_POSITION, sourcePosition.x, sourcePosition.y, sourcePosition.z);
