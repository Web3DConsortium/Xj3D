               ...
               ShaderComponentRenderable
{
    ...
    private List<ShaderObject> pendingAdds;

    /** List of shader objects that are queued to be removed at the next link */
    private List<ShaderObject> pendingDeletes;

    /** List of all the current shader objects */
    private List<ShaderObject> currentObjects;
    ...
    private Map<GL, Integer> programIdMap;
    ...
    protected void setUpdateHandler(NodeUpdateHandler handler)
    {
        ...
        if((linked.isEmpty()) && (updateHandler != null))
    ...
    /**
     * Request that the shader link at the next available opportunity. If any
     ...
     * indeterminate time later. That is the normal process this class takes.
     * If the end user wants to first confirm that the compile succeeds before
