               ...
               ObjectRenderable
{
    ...
    private static final String PICK_TIMING_PROP =
        "org.j3d.aviatrix3d.Shape3D.pickTimingMsg";
    ...
    private static final String PICKABLE_FALSE_PROP =
        "org.j3d.aviatrix3d.Shape3D.notPickableMsg";
    ...
    {
        return (geom instanceof PickTarget) ? geom : null;
    }
    ...
    public boolean equals(Shape3D sh)
    {
        ...
        return (geom == sh.geom) || ((geom != null) && geom.equals(sh.geom));
    }
}
