...
public class Texture2D extends Texture
{
    ...
    public void render(GL2 gl)
    {
        ...
        if(t_id == null)
        {
            ...
            textureIdMap.put(gl, tex_id_tmp[0]);
        ...
        {
            gl.glBindTexture(textureType, t_id);
        }
...
// Doesn't seem to be helping anymore?  Someone else holding a reference?
