 ...
 * <ul>
 * <li>noMultiTextureMsg: Somehow we found a video card that doesn't support
    ...
    implements TextureRenderable
{
    ...
    public void activateTexture(GL gl, Object stageId)
    {
        ...
        if(hasMultiTextureAPI)
        {
            if(((Integer)stageId) >= 0)
                gl.glActiveTexture((int) stageId);
            else
                gl.glActiveTexture(GL.GL_TEXTURE0);
        }
        else if(((Integer)stageId) > 0)
            return;
    ...
    public void postRender(GL2 gl, Object stageId)
    {
        ...
        {
            if(((Integer)stageId) >= 0)
                gl.glActiveTexture(((Integer)stageId));
            else
                gl.glActiveTexture(GL.GL_TEXTURE0);
        }
        else if(((Integer)stageId) > 0)
    ...
    /**
     * Get the current local texture transformation matrix. If no matrix is
