    ...
    implements GeometryRenderable, DeletableRenderable
{
     ...
     */
    protected IntHashMap<ShaderAttribValue> attributes;
    ...
    protected Map<GL, Integer> vboIdMap;
        ...
        else
        {
            ...
            for(int i = 0; i < numSets; i++)
            {
                if((texCoords[i] == null) || (texCoords[i].length == 0))
                {
                    ...
                    if (!intl_mgr.getResourceNames().contains("config.i18n.av3dResources")) {
                        intl_mgr.setApplication("Aviatrix3D", "config.i18n.av3dResources");
                    }
        ...
        throws IllegalArgumentException, InvalidWriteTimingException
    {
        ...
        ShaderAttribValue val = attributes.get(index);
        FloatBuffer buf;
    ...
    protected int computeBufferSize()
    {
        ...
        if((vertexFormat & ATTRIBS) != 0)
        {
            ...
            {
                int id = attribIds[i];
                ShaderAttribValue val = attributes.get(id);
    ...
    protected void setVertexStateVBO(GL2 gl)
    {
        ...
        if(dataChanged.getState(gl))
        {
            ...
            gl.glBufferData(GL.GL_ARRAY_BUFFER, buf_size, null, vboHint);
    ...
    /**
     * Convenience method to check if this code has detected the presence of
        ...
        throws IllegalArgumentException
    {
        if((attribs != null) && (Array.getLength(attribs) < numRequiredCoords * size))
        {
            ...
            Object[] msg_args =
            {
                Array.getLength(attribs),
                numRequiredCoords * size
            };
