...
public class FrustumCullStage extends BaseCullStage
{
    ...
    private int findAllNodes(CustomCullable root, int cullEndIndex)
    {
        ...
        Cullable[] kids  = cullInstructions.children.clone();
        ...
        for(int i = 0; i < size; i++)
        {
            ...
            switch(cullable.getCullableType())
            {
                case LeafCullable.LIGHT_CULLABLE:
                    ...
                    if(effect.isGlobalOnly())
                    {
                        ...
                        if(bounds == null)
                        {
                            ...
                            globalLightTxList[lastGlobalLight][0] = mat.m00;
                            globalLightTxList[lastGlobalLight][1] = mat.m10;
                            globalLightTxList[lastGlobalLight][2] = mat.m20;
                            globalLightTxList[lastGlobalLight][3] = mat.m30;

                            globalLightTxList[lastGlobalLight][4] = mat.m01;
                            globalLightTxList[lastGlobalLight][5] = mat.m11;
                            globalLightTxList[lastGlobalLight][6] = mat.m21;
                            globalLightTxList[lastGlobalLight][7] = mat.m31;

                            globalLightTxList[lastGlobalLight][8] = mat.m02;
                            globalLightTxList[lastGlobalLight][9] = mat.m12;
                            globalLightTxList[lastGlobalLight][10] = mat.m22;
                            globalLightTxList[lastGlobalLight][11] = mat.m32;

                            globalLightTxList[lastGlobalLight][12] = mat.m03;
                            globalLightTxList[lastGlobalLight][13] = mat.m13;
                            globalLightTxList[lastGlobalLight][14] = mat.m23;
                            globalLightTxList[lastGlobalLight][15] = mat.m33;
                        ...
                        else
                        {
                            ...
                            // Transpose the matrix in place as it is being copied
                            globalBoundedLightTxList[lastGlobalBoundedLight][0] = mat.m00;
                            globalBoundedLightTxList[lastGlobalBoundedLight][1] = mat.m10;
                            globalBoundedLightTxList[lastGlobalBoundedLight][2] = mat.m20;
                            globalBoundedLightTxList[lastGlobalBoundedLight][3] = mat.m30;

                            globalBoundedLightTxList[lastGlobalBoundedLight][4] = mat.m01;
                            globalBoundedLightTxList[lastGlobalBoundedLight][5] = mat.m11;
                            globalBoundedLightTxList[lastGlobalBoundedLight][6] = mat.m21;
                            globalBoundedLightTxList[lastGlobalBoundedLight][7] = mat.m31;

                            globalBoundedLightTxList[lastGlobalBoundedLight][8] = mat.m02;
                            globalBoundedLightTxList[lastGlobalBoundedLight][9] = mat.m12;
                            globalBoundedLightTxList[lastGlobalBoundedLight][10] = mat.m22;
                            globalBoundedLightTxList[lastGlobalBoundedLight][11] = mat.m32;

                            globalBoundedLightTxList[lastGlobalBoundedLight][12] = mat.m03;
                            globalBoundedLightTxList[lastGlobalBoundedLight][13] = mat.m13;
                            globalBoundedLightTxList[lastGlobalBoundedLight][14] = mat.m23;
                            globalBoundedLightTxList[lastGlobalBoundedLight][15] = mat.m33;
                    ...
                    else
                    {
                        ...
                        // Transpose the matrix in place as it is being copied
                        lightTxList[lastLight][0] = mat.m00;
                        lightTxList[lastLight][1] = mat.m10;
                        lightTxList[lastLight][2] = mat.m20;
                        lightTxList[lastLight][3] = mat.m30;

                        lightTxList[lastLight][4] = mat.m01;
                        lightTxList[lastLight][5] = mat.m11;
                        lightTxList[lastLight][6] = mat.m21;
                        lightTxList[lastLight][7] = mat.m31;

                        lightTxList[lastLight][8] = mat.m02;
                        lightTxList[lastLight][9] = mat.m12;
                        lightTxList[lastLight][10] = mat.m22;
                        lightTxList[lastLight][11] = mat.m32;

                        lightTxList[lastLight][12] = mat.m03;
                        lightTxList[lastLight][13] = mat.m13;
                        lightTxList[lastLight][14] = mat.m23;
                        lightTxList[lastLight][15] = mat.m33;
                ...
                case LeafCullable.CLIP_CULLABLE:
                    ...
                    // Transpose the matrix in place as it is being copied
                    clipTxList[lastClip][0] = mat.m00;
                    clipTxList[lastClip][1] = mat.m10;
                    clipTxList[lastClip][2] = mat.m20;
                    clipTxList[lastClip][3] = mat.m30;

                    clipTxList[lastClip][4] = mat.m01;
                    clipTxList[lastClip][5] = mat.m11;
                    clipTxList[lastClip][6] = mat.m21;
                    clipTxList[lastClip][7] = mat.m31;

                    clipTxList[lastClip][8] = mat.m02;
                    clipTxList[lastClip][9] = mat.m12;
                    clipTxList[lastClip][10] = mat.m22;
                    clipTxList[lastClip][11] = mat.m32;

                    clipTxList[lastClip][12] = mat.m03;
                    clipTxList[lastClip][13] = mat.m13;
                    clipTxList[lastClip][14] = mat.m23;
                    clipTxList[lastClip][15] = mat.m33;
                ...
                if(cullable.getCullableType() == LeafCullable.GEOMETRY_CULLABLE)
                {
                    ...
                    if(r instanceof ShapeRenderable)
                    {
                        ...
                        if(sr.is2D())
                        {
                            ...
                            workCullList[ret_val].renderable = (Renderable)kids[i];
                            workCullList[ret_val].numLights = 0;
                            workCullList[ret_val].numClipPlanes = 0;
     ...
     */
    private void resizeGlobalLightList()
    {
     ...
     * compiler to inline the code for faster execution
     */
    private void resizeGlobalBoundedLightList()
    {
