 ...
 * <p>
 *
 * A sorter will have a receiver for its output. If no receiver is registered
 * the sorter should still operate because an implementation could choose to
...
public interface GraphicsSortStage
{
     ...
     */
//    Node[] getSortedOutput(int[] numValid);
