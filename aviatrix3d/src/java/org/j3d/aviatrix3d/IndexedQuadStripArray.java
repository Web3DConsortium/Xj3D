 ...
 *     strip with less than 4 vertices listed.</li>
 * </ul>
 *
 * @author Justin Couch
 * @version $Revision: 1.29 $
 */
public class IndexedQuadStripArray extends IndexedVertexGeometry
{
    /** Message when the strip count is < 4 */
    private static final String MIN_COUNT_PROP =
        "org.j3d.aviatrix3d.IndexedQuadStripArray.minStripSizeMsg";
     ...
     */
    public IndexedQuadStripArray(boolean useVbo, int vboHint)
    {
