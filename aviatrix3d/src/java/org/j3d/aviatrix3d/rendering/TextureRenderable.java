 ...
 * <p>
 *
 * Textures can come in several different forms and this interface provides a
 * way to map between the holding {@link org.j3d.aviatrix3d.TextureUnit} class
 * and the rendering/culling stage with additional information about the form
            ...
            TransparentRenderable
{
     ...
     */
    void activateTexture(GL gl, Object externalData);
     ...
     *   aid in the rendering
     */
    void deactivateTexture(GL gl, Object externalData);
     ...
     */
    OffscreenBufferDescriptor getBuffer(GLContext context);
}
