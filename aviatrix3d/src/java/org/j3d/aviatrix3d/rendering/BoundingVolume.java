 ...
 * we only need to perform 2 matrix-vector multiplications. Since view frustum
...
public abstract class BoundingVolume
{
    ...
    /**
     * Check for the given point lying inside this bounds.
     *
     ...
     * @return int FRUSTUM_ALLOUT, FRUSTUM_ALLIN, FRUSTUM_PARTIAL.
     */
    public abstract int checkIntersectionFrustum(Vector4f[] planes,
                                                 Matrix4f mat);

    /**
     * Transform the current position by the given transformation matrix.
     *
