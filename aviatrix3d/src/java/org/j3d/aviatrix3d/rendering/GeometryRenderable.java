...
public interface GeometryRenderable extends Renderable
{
    ...
    /**
     * This method is called to render this node. All OpenGL commands needed to
     * render the node should be executed. Any transformations needed should be
     * added to the transformation stack premultiplied. This method must be
     * re-entrant as it can be called from multiple places at once.
     *
