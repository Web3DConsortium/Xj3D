 ...
 * <p>
 *
 * By default a light is not enabled and the colour is set to black. Lights also
 * have a secondary specular value that can be provided. By default it is black
 * (ie has no effect). An ambient component can also be provided with this light
 * source in addition to it's derived effects.
 * <p>
 *
 * <b>Rendering Implementation Tips</b>
 * <p>
 * The external data passed to the ComponentRenderable calls shall be an
 * <code>Integer</code> instance that represents the GL identifier of the Light
 * (GL_LIGHT0 + i) this instance is working with.
 * <p>
 *
 * See the {@link EffectRenderable} interface for definition of the scoping and
 * effects bounds.
 * <p>
 *
...
public abstract class Light extends Leaf
    ...
    /**
     * Set the enabled state of the light. Can use this to turn it on and off in
     * a general fashion.
     *
    ...
    /**
     * Set the global scope state of the light. We can use this to turn define
     * whether this light should effect everything or just those scoped to the
     * same group as the parent of this light.
     *
     * @param state The new state of the light
     * @throws InvalidWriteTimingException An attempt was made to write outside
     * of the NodeUpdateListener data changed callback method
    ...
    /**
     * Set the ambient colour to the new value. Colour must be in the range [0,
     * 1] otherwise an exception is generated.
     *
    ...
    /**
     * Set the colour to the new value. Colour must be in the range [0, 1]
