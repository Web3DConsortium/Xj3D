    ...
    implements ShaderSourceRenderable
{
    ...
    private Map<GL, Integer> objectIdMap;
    ...
    private Map<GL, Boolean> compiled;
    ...
    protected void setUpdateHandler(NodeUpdateHandler handler)
    {
        ...
        if((compiled.isEmpty()) && (updateHandler != null))
    ...
    public void initialize(GL2 gl)
    {
        ...
        if((comp != null && comp) || sourceStrings == null)
            return;
        ...
        if(o_id == null)
        {
            ...
            object_id = (int) gl.glCreateShaderObjectARB(type);
