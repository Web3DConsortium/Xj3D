 ...
 * subset is available. This code automatically checks for it's existence and
 * will disable calling itself if it detects the lack of existence.
 * <p>
 *
    ...
    implements AppearanceAttributeRenderable, DeletableRenderable
{
    ...
    private Map<GL, Integer> displayListMap;
    ...
    public void render(GL2 gl)
    {
        ...
        if(listName == null)
        {
            ...
            if(needBlendColor && hasImaging) {
                ...
                // Some systems do not support blendEQNs, so, if GL_ARB_imaging
                // is not supported, don't call for blendEQNs
