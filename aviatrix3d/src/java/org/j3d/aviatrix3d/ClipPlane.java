 ...
 * <p>
 *
 * ClipPlane objects may be placed at any point in the scene graph hierarchy
 ...
 * locations in the hierarchy and have them apply to the local coordinate
 * system.
 * <p>
 *
               ...
               EffectRenderable
{
    ...
    {
        gl.glClipPlane((Integer) planeId, planeEquation, 0);
        gl.glEnable((Integer) planeId);
    }
