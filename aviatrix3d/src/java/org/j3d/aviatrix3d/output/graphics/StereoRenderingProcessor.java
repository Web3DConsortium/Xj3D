...
public interface StereoRenderingProcessor extends RenderingProcessor
{
    ...
    /**
     * Set the angular aperture of the camera. Measurement is in degrees
     * and is in the horizontal plane relative to the camera. By default,
     * this angle is 45 degrees.
     *
     * @param angle The angle in degrees
     */
    void setCameraAperatureAngle(float angle);

    /**
     * Get the current camera aperture angle.
     *
     * @return The aperture angle, in degrees
     */
    float getCameraAperatureAngle();
     ...
     */
    void setCameraFocalLength(float length);
