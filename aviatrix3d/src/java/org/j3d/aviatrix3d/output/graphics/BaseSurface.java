    ...
    implements GraphicsOutputDevice, GLEventListener
{
    ...
    /** Maps from a offscreen texture instance to the rendererProcessor for it */
    ...
    public void swap()
    {
        if(!terminate)
        {
            ...
            try
            {
                // http://forum.jogamp.org/Understanding-issue-with-automatic-buffer-swapping-td4037728.html
                // On some Win10 machines, manual buffer swapping is causing JOGL exception or JVM crash
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        if (!terminate && canvasRenderer != null)
