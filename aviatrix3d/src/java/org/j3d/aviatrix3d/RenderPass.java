    ...
    implements RenderPassCullable
{
    ...
    protected void setLive(boolean state)
    {
        ...
        if(renderableObjects != null)
            if (renderableObjects instanceof MultiParentNode)
                ((MultiParentNode)renderableObjects).setLive(renderableObjects, alive);
            else
        ...
        throws InvalidWriteTimingException
    {
        ...
        if(renderableObjects != null)
        {
            ...
            if (renderableObjects instanceof MultiParentNode)
                ((MultiParentNode)renderableObjects).setLive(geom, alive);
            else
                renderableObjects.setLive(alive);
        }
    }
