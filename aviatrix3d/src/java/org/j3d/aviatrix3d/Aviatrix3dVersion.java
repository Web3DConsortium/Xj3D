...
public class Aviatrix3dVersion extends JogampVersion {
    ...
    public static Aviatrix3dVersion getInstance() {
        Aviatrix3dVersion info = Aviatrix3dVersion.aviatrix3dVersionInfo;
        if(null == info) { // volatile: ok
            synchronized(Aviatrix3dVersion.class) {
                info = Aviatrix3dVersion.aviatrix3dVersionInfo;
                if( null == info ) {
                    ...
                    Aviatrix3dVersion.aviatrix3dVersionInfo = info = new Aviatrix3dVersion(packageName, mf);
                }
            }
        }
        return info;
