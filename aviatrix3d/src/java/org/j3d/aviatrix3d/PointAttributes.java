    ...
    implements AppearanceAttributeRenderable, DeletableRenderable
{
    ...
    /** Attenuation parameters, if provided. null otherwise */
    ...
    private Map<GL2, Integer> displayListMap;
        ...
        throws InvalidWriteTimingException
    {
        ...
        if(size > maxPointSize)
        {
            ...
            Object[] msg_args = { size, maxPointSize};
            Format[] fmts = { n_fmt };
            MessageFormat msg_fmt =
                new MessageFormat(msg_pattern, lcl);
            msg_fmt.setFormats(fmts);
        ...
        throws InvalidWriteTimingException
    {
        ...
        if(size < minPointSize)
        {
            ...
            Object[] msg_args = { minPointSize, size};
            Format[] fmts = { n_fmt };
            MessageFormat msg_fmt =
                new MessageFormat(msg_pattern, lcl);
            msg_fmt.setFormats(fmts);
