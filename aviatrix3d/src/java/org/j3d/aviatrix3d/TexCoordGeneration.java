    ...
    implements ObjectRenderable, DeletableRenderable
{
    ...
    /** The texture coordinate effected */
    ...
    /** The texture generation parameters */
    ...
    private Map<GL, Integer> deletedDisplayListMap;
    ...
    public TexCoordGeneration()
    {
        ...
        deletedDisplayListMap = new HashMap<>();
    }
    ...
    public void render(GL2 gl)
    {
        ...
        if(!deletedDisplayListMap.isEmpty())
        {
