...
/**
 * Raster object that represents a coloured image defined by a raw byte
 * array.
 * <p>
 *
 ...
 */
public class ByteRaster extends Raster
{
    ...
    {
        if(!(o instanceof ByteRaster))
            return false;
        else
            return equals((ByteRaster)o);
    }
