...
public abstract class IndexedVertexGeometry extends VertexGeometry
{
    ...
    /** Map of VBO IDs */
    protected Map<GL, Integer> vboElementIdMap;
...
// Don't do anything with the 4th coord for now.
    ...
    protected void setVertexStateVBO(GL2 gl)
    {
        ...
        if(vbo_id == null)
        {
            ...
            vboElementIdMap.put(gl, vbo_id_tmp[0]);
    ...
    @Override
     protected int fillBufferData(GL2 gl)
     {
        ...
        gl.glBufferData(GL.GL_ELEMENT_ARRAY_BUFFER, numIndices * 4, null, vboHint);
    ...
    /**
     * Get the sizes of the valid indices. The passed array must be big enough
     * to contain all the indices.
     *
