 ...
 * a 1-dimensional texture. For settings for additional dimensions (T and R)
               ...
               TransparentObjectRenderable
{
    ...
    /** Set the magnification filter to the fastest option */
    public static final int MAGFILTER_FASTEST = 0;

    /** Set the magnification filter to the highest quality option */
    ...
    /** Set the magnification filter to linear filtering */
    public static final int MAGFILTER_BASE_LEVEL_LINEAR = 3;

    /** Set the magnification filter to use the detail texture option */
    public static final int MAGFILTER_LINEAR_DETAIL = 4;

    /** Set the magnification filter to use the detail texture's RGB values */
    public static final int MAGFILTER_LINEAR_DETAIL_RGB = 5;

    /** Set the magnification filter to use the detail texture's alpha values */
    ...
    /** Set the minification filter to the highest quality  option */
    public static final int MINFILTER_NICEST = 1;

    /** Set the minification filter to filtering using GL_NEAREST */
    public static final int MINFILTER_BASE_LEVEL_POINT = 2;

    /** Set the minification filter to linear filtering */
    public static final int MINFILTER_BASE_LEVEL_LINEAR = 3;

    /** Set the minification filter to base point-base filtering */
    ...
    /** The texture comparison function is less than or equal */
    public static final int COMPARE_FUNCTION_LEQUAL = GL.GL_LEQUAL;

    /** The texture comparison function is greater than or equal */
    ...
    /**
     * Each update should discard any previous updates received. Best used
    ...
    protected Map<GL, Integer> textureIdMap;
    ...
    /**
     * Get the current anisotropic filtering mode.
     *
    ...
    {
        return generateMipMap == GL.GL_TRUE;
    }
