...
public class TriangleStripArray extends VertexGeometry
{
     ...
     */
    public TriangleStripArray(boolean useVbo, int vboHint)
    {
    ...
    {
        TriangleStripArray geom = (TriangleStripArray)o;
    ...
    public boolean equals(Object o)
    {
        if(!(o instanceof TriangleStripArray))
            ...
            return equals((TriangleStripArray)o);
    }
     ...
     * @return -1, 0 or 1 depending on order
     */
    public int compareTo(TriangleStripArray ta)
    {
        if(ta == null)
            return 1;
     ...
     */
    public boolean equals(TriangleStripArray ta)
    {
        return (ta == this);
    }
}
