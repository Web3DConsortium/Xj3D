               ...
               OffscreenBufferRenderable
{
    ...
    private Map<Object, OffscreenBufferDescriptor> displayListMap;
     ...
     */
    private void copyCapabilities(GLCapabilities caps,
                                  boolean unclampColorRange)
    {
        bufferData.setNumRenderTargets(1);
        bufferData.enableUnclampedColorBuffer(unclampColorRange);
        bufferData.enableFloatingPointColorBuffer(caps.isPBuffer());
        bufferData.setDepthBits(caps.getDepthBits());
        bufferData.setStencilBits(caps.getStencilBits());
