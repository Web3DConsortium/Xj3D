 ...
 * components(SRT-transform).  This class will not check this constraint, so 
 * expect odd results if you break this rule, up to and including a possible 
 * core reactor meltdown in a foreign country.
 *
 * @author Alan Hudson
    ...
    implements TransformPickTarget, TransformCullable
{
        ...
        throws InvalidWriteTimingException
    {
        ...
        MATRIX_UTILS.inverse(localTransform, inverseTransform);
    }
