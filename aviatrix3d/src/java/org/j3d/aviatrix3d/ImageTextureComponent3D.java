    ...
    private ByteBuffer convertImage(RenderedImage[] srcImages)
    {
        ...
        if(need_int_buf)
        {
            ...
            for (RenderedImage srcImage : srcImages) {
                convertImage(i_buf, (BufferedImage) srcImage);
            }
        }
        else
        {
            for (RenderedImage srcImage : srcImages) {
                convertImage(ret_val, (BufferedImage) srcImage);
            }
        }
                        ...
                        if(invertY)
                        {
                            ...
                            for(int i = 0; i < height; i++)
                            {
                                ...
                                for(int j = 0; j < width; j++)
                                {
                                    ...
                                    buffer.put((byte)(tmp & 0x0000_00FF));
                                }
                        ...
                        if(invertY)
                        {
                            ...
                            for(int i = 0; i < height; i++)
                            {
                                ...
                                for(int j = 0; j < width; j++)
                                {
                                    ...
                                    copyBuffer[pos++] = (byte)(tmp & 0x0000_00FF);
                                }
