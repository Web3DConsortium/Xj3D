    ...
    implements PickingManager
{
    ...
    private static final String NO_PICK_TYPE_PROP =
        "org.j3d.aviatrix3d.management.DebugPickingHandler.unknownPickTypeMsg";
    ...
    /**
     * Internal flag for passing between methods that debug output should
     * be written now
     */
        ...
        throws NotPickableException
    {
        ...
        if(dumpNow)
            System.out.println("Starting pickBatch");
        ...
        if(dumpNow)
            System.out.println("Exiting pickBatch");
    }
        ...
        throws NotPickableException
    {
        ...
        switch(req.pickGeometryType)
        {
            ...
            default:
                ...
                errorReporter.warningReport(msg, (Throwable) null);
        }
        ...
        if(dumpNow)
            System.out.println("Exiting pickSingle");
    }
