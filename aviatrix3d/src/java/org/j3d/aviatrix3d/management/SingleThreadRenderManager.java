...
/**
 * Implementation of the {@link RenderManager} that uses a single thread for all
...
public class SingleThreadRenderManager
    ...
    /**
     * Message when the data change listener callback attempts to add another
     * shader log request during processing.
     */
     ...
     */
    private List<DisplayCollection> addedDisplays;

    /**
     * Displays that are pending for removal at the start of the next loop
     */
    private List<DisplayCollection> removedDisplays;

    /**
     * Displays that have failed to draw and are now considered "broken"
     */
    private List<DisplayCollection> usableDisplays;
    ...
    public SingleThreadRenderManager() {
        ...
        addedDisplays = new ArrayList<>();
        removedDisplays = new ArrayList<>();
        usableDisplays = new ArrayList<>();
...
} // end class file SingleThreadRenderManager.java
