...
class DefaultBatchPickingHandler
{
     ...
     * is the pick depth down the transform hierarchy. This will correspond to
        ...
        for(int i = 0; i < numRequests; i++)
        {
            ...
            switch(req[i].pickGeometryType)
            {
                ...
                default:
                    ...
                    Object[] msg_args = { req[i].pickGeometryType};
                    Format[] fmts = { n_fmt };
                                   ...
                                   int numRequests)
    {
        ...
        {
            case PickTarget.GROUP_PICK_TYPE:
                descendTree(child, req, numRequests);
                break;
                ...
                switch(req[i].pickSortType)
                {
                    ...
                    case PickRequest.SORT_ORDERED:
                        ...
                        List<SceneGraphPath> paths =
                        	(List<SceneGraphPath>)req[i].foundPaths;
