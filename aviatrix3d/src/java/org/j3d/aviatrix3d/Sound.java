...
/**
 * A Sound class represents all sound emitting nodes in the system.
 * <p>
 *
 * @author Alan Hudson
   ...
   implements LeafCullable, AudioRenderable, AudioUpdateListener
{
    ...
    /** Source position */
    protected Point3f sourcePosition;

    /** Source velocity */
    protected Point3f sourceVelocity;
    ...
    public Sound()
    {
        ...
        sourcePosition = new Point3f();
        sourceVelocity = new Point3f();
    }
     ...
     * <p>
     * Default implementation returns true. Derived classes should override as
     * needed.
     *
     * @return true always unless overridden
     */
    @Override
    ...
    {
        return (enabled == snd.enabled) && (playing == snd.playing) && (paused == snd.paused) && (loop == snd.loop) && (freq == snd.freq) && (pitch == snd.pitch);
    }
