...
public class OpenALAudioDeviceTest
{
    ...
    public void setupTests() throws Exception
    {
        ...
        intl_mgr.setApplication("OpenALAudioDeviceTest", "config.i18n.av3dResources");
    ...
    public void testDrawingInitialisation() throws Exception
    {
        ...
        AudioRenderable mock_renderable = mock(Sound.class);
        ...
        verify(mockALC, times(1)).alcOpenDevice(null);
        verify(mockALC, times(1)).alcCreateContext(null, null);
...
//        verify(mockALC, times(1)).alcCloseDevice(null);
//        verify(mockALC, times(1)).alcDestroyContext(null);
...
//        verify(mockALC, times(2)).alcMakeContextCurrent(mockContext);
        verify(mockALC, times(4)).alcMakeContextCurrent(null);

        verify(mock_renderable, times(1)).render(eq(mockAL), any(Matrix4f.class));
