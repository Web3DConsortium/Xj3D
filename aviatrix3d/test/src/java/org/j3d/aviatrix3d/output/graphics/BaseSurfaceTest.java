...
public class BaseSurfaceTest
{
    ...
    public void testBasicConstruction() throws Exception
    {
        ...
        assertEquals(classUnderTest.getAlphaTestCutoff(), 1.0f, 0.1f, "Alpha cutoff default is set");
        assertEquals(classUnderTest.getStereoEyeSeparation(), 0.0f, 0.1f, "Eye separation is set");
