...
public class BoundingBoxTest
{
    ...
    public void testBasicConstruction() throws Exception
    {
        ...
        assertEquals(center[0], 0.0f, 0.1f, "Center X coordinate incorrect");
        assertEquals(center[1], 0.0f, 0.1f, "Center Y coordinate incorrect");
        assertEquals(center[2], 0.0f, 0.1f, "Center Z coordinate incorrect");

        class_under_test.getExtents(min, max);

        assertEquals(min[0], 0.0f, 0.1f, "Min extents X coordinate incorrect");
        assertEquals(min[1], 0.0f, 0.1f, "Min extents Y coordinate incorrect");
        assertEquals(min[2], 0.0f, 0.1f, "Min extents Z coordinate incorrect");

        assertEquals(max[0], 0.0f, 0.1f, "Max extents X coordinate incorrect");
        assertEquals(max[1], 0.0f, 0.1f, "Max extents Y coordinate incorrect");
        assertEquals(max[2], 0.0f, 0.1f, "Max extents Z coordinate incorrect");

        class_under_test.getMinimum(min);

        assertEquals(min[0], 0.0f, 0.1f, "Min X coordinate incorrect");
        assertEquals(min[1], 0.0f, 0.1f, "Min Y coordinate incorrect");
        assertEquals(min[2], 0.0f, 0.1f, "Min Z coordinate incorrect");

        class_under_test.getMaximum(max);

        assertEquals(max[0], 0.0f, 0.1f, "Max X coordinate incorrect");
        assertEquals(max[1], 0.0f, 0.1f, "Max Y coordinate incorrect");
        assertEquals(max[2], 0.0f, 0.1f, "Max Z coordinate incorrect");

        Assert.assertNotNull(class_under_test.toString(), "No string representation available");
    }
    ...
    public void testMinimums() throws Exception
    {
        ...
        assertArrayEquals(result, TEST_MINIMUM, 0.1f);
    ...
    public void testMaximums() throws Exception
    {
        ...
        assertArrayEquals(result, TEST_MAXIMUM, 0.1f);
    ...
    public void testTransform() throws Exception
    {
        ...
        assertEquals(result[0], TEST_MINIMUM[2], 0.1f, "Min didn't rotate x around Y axis");
        assertEquals(result[1], TEST_MINIMUM[1], 0.1f, "Min didn't rotate y around Y axis");
        assertEquals(result[2], TEST_MINIMUM[0], 0.1f, "Min didn't rotate z around Y axis");

        class_under_test.getMaximum(result);

        assertEquals(result[0], TEST_MAXIMUM[2], 0.1f, "Max didn't rotate x around Y axis");
        assertEquals(result[1], TEST_MAXIMUM[1], 0.1f, "Max didn't rotate y around Y axis");
        assertEquals(result[2], TEST_MAXIMUM[0], 0.1f, "Max didn't rotate z around Y axis");
    }
