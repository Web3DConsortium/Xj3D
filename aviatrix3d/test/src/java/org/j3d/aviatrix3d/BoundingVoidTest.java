...
public class BoundingVoidTest
{
    ...
    public void testBasicConstruction() throws Exception
    {
        ...
        assertEquals(result[0], 0.0f, 0.1f, "Incorrect X center");
        assertEquals(result[1], 0.0f, 0.1f, "Incorrect Y center");
        assertEquals(result[2], 0.0f, 0.1f, "Incorrect Z center");
