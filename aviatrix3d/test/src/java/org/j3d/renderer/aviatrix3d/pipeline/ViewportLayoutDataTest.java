...
public class ViewportLayoutDataTest
{
    ...
    public void setupClass() throws Exception
    {
        ...
        intl_mgr.setApplication(getClass().getName(), "config.i18n.av3dResources");
    }
    ...
    public void testBasicConstruction() throws Exception
    {
        ...
        assertEquals(class_under_test.startX, TEST_X, 0.1f, "Incorrect X saved");
        assertEquals(class_under_test.startY, TEST_Y, 0.1f, "Incorrect Y saved");
        assertEquals(class_under_test.width, TEST_WIDTH, 0.1f, "Incorrect width saved");
        assertEquals(class_under_test.height, TEST_HEIGHT, 0.1f, "Incorrect height saved");
